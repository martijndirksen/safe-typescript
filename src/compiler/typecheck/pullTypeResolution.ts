...
import { EOL } from "os";
  ...
  class MemberWithBaseOrigin {
    constructor(
      public memberSymbol: PullSymbol,
      public baseOrigin: PullTypeSymbol
    ) {}
  }

  class SignatureWithBaseOrigin {
    constructor(
      public signature: PullSignatureSymbol,
      public baseOrigin: PullTypeSymbol
    ) {}
  }
  ...
  export class PullTypeResolver {
    ...
    private assignableCache: IBitMatrix = BitMatrix.getBitMatrix(
      /*allowUndefinedValues:*/ true
    );
    private subtypeCache: IBitMatrix = BitMatrix.getBitMatrix(
      /*allowUndefinedValues:*/ true
    );
    private identicalCache: IBitMatrix = BitMatrix.getBitMatrix(
      /*allowUndefinedValues:*/ true
    );
    ...
    private cachedArrayInterfaceType() {
      if (!this._cachedArrayInterfaceType) {
        this._cachedArrayInterfaceType = <PullTypeSymbol>(
          this.getSymbolFromDeclPath('Array', [], PullElementKind.Interface)
        );
      }
      ...
      if (!this._cachedArrayInterfaceType.isResolved) {
        this.resolveDeclaredSymbol(
          ...
          new PullTypeResolutionContext(this)
        );
      }
    ...
    private cachedNumberInterfaceType() {
      if (!this._cachedNumberInterfaceType) {
        this._cachedNumberInterfaceType = <PullTypeSymbol>(
          this.getSymbolFromDeclPath('Number', [], PullElementKind.Interface)
        );
      }
    ...
    private cachedStringInterfaceType() {
      if (!this._cachedStringInterfaceType) {
        this._cachedStringInterfaceType = <PullTypeSymbol>(
          this.getSymbolFromDeclPath('String', [], PullElementKind.Interface)
        );
      }
    ...
    private cachedBooleanInterfaceType() {
      if (!this._cachedBooleanInterfaceType) {
        this._cachedBooleanInterfaceType = <PullTypeSymbol>(
          this.getSymbolFromDeclPath('Boolean', [], PullElementKind.Interface)
        );
      }
    ...
    private cachedObjectInterfaceType() {
      if (!this._cachedObjectInterfaceType) {
        this._cachedObjectInterfaceType = <PullTypeSymbol>(
          this.getSymbolFromDeclPath('Object', [], PullElementKind.Interface)
        );
      }
    ...
    private cachedFunctionInterfaceType() {
      if (!this._cachedFunctionInterfaceType) {
        this._cachedFunctionInterfaceType = <PullTypeSymbol>(
          this.getSymbolFromDeclPath('Function', [], PullElementKind.Interface)
        );
      }
    ...
    private cachedIArgumentsInterfaceType() {
      if (!this._cachedIArgumentsInterfaceType) {
        this._cachedIArgumentsInterfaceType = <PullTypeSymbol>(
          this.getSymbolFromDeclPath(
            'IArguments',
            [],
            PullElementKind.Interface
          )
        );
      }
    ...
    private cachedRegExpInterfaceType() {
      if (!this._cachedRegExpInterfaceType) {
        this._cachedRegExpInterfaceType = <PullTypeSymbol>(
          this.getSymbolFromDeclPath('RegExp', [], PullElementKind.Interface)
        );
      }
    ...
    private cachedFunctionArgumentsSymbol(): PullSymbol {
      if (!this._cachedFunctionArgumentsSymbol) {
        this._cachedFunctionArgumentsSymbol = new PullSymbol(
          'arguments',
        ...
        var functionArgumentsDecl = new PullSynthesizedDecl(
          'arguments',
          'arguments',
          PullElementKind.Parameter,
          PullElementFlags.None,
          /*parentDecl*/ null,
          new TextSpan(0, 0),
          this.semanticInfoChain
        );
        functionArgumentsDecl.setSymbol(this._cachedFunctionArgumentsSymbol);
        this._cachedFunctionArgumentsSymbol.addDeclaration(
    ...
    public getNewErrorTypeSymbol(name: string = null): PullErrorTypeSymbol {
      return new PullErrorTypeSymbol(
        this.semanticInfoChain.anyTypeSymbol,
        name
      );
    }
    ...
    private getExportedMemberSymbol(
      symbol: PullSymbol,
      parent: PullTypeSymbol
    ): PullSymbol {
      if (
        !(symbol.kind & (PullElementKind.Method | PullElementKind.Property))
      ) {
        var isContainer =
          (parent.kind &
            (PullElementKind.Container | PullElementKind.DynamicModule)) !=
          0;
        var containerType = !isContainer
          ? parent.getAssociatedContainerType()
          : parent;
    ...
    private getMemberSymbol(
      symbolName: string,
      declSearchKind: PullElementKind,
      parent: PullTypeSymbol
    ): PullSymbol {
      ...
      if (parent.kind & PullElementKind.SomeContainer) {
        ...
        for (var j = 0; j < typeDeclarations.length; j++) {
          childDecls = typeDeclarations[j].searchChildDecls(
            symbolName,
            declSearchKind
          );
          ...
          if (
            (declSearchKind & PullElementKind.SomeType) != 0 ||
            (declSearchKind & PullElementKind.SomeValue) != 0
          ) {
            childDecls = typeDeclarations[j].searchChildDecls(
              symbolName,
              PullElementKind.TypeAlias
            );
            if (
              childDecls.length &&
              childDecls[0].kind == PullElementKind.TypeAlias
            ) {
              // this can return container or dynamic module
              var aliasSymbol = <PullTypeAliasSymbol>(
                this.getExportedMemberSymbol(childDecls[0].getSymbol(), parent)
              );
              if (aliasSymbol) {
      ...
      for (var i = declPath.length - 1; i >= 0; i--) {
        ...
        if (
          ...
          if (declSearchKind & PullElementKind.SomeValue) {
            ...
            instanceSymbol = (<PullContainerSymbol>(
              decl.getSymbol()
            )).getInstanceSymbol();

            // Maybe there's an import statement aliasing an initalized value?
            childDecls = decl.searchChildDecls(
              symbolName,
              PullElementKind.TypeAlias
            );
            ...
            if (instanceSymbol) {
              ...
              childSymbol = this.getMemberSymbol(
                symbolName,
                declSearchKind,
                instanceType
              );
              ...
              if (
                childSymbol &&
                childSymbol.kind & declSearchKind &&
                !childSymbol.anyDeclHasFlag(PullElementFlags.Static)
              ) {
                return childSymbol;
              }
            }
          ...
          var childSymbol = this.getMemberSymbol(
            symbolName,
            declSearchKind,
            declSymbol
          );
          ...
          declSearchKind &
            (PullElementKind.SomeType | PullElementKind.SomeContainer) ||
          !(pathDeclKind & PullElementKind.Class)
        ) {
          ...
          // of its parameters
          if (
            pathDeclKind === PullElementKind.FunctionExpression &&
            symbolName ===
              (<PullFunctionExpressionDecl>decl).getFunctionExpressionName()
          ) {
    ...
    private getVisibleDeclsFromDeclPath(
      declPath: PullDecl[],
      declSearchKind: PullElementKind
    ): PullDecl[] {
      var result: PullDecl[] = [];
      ...
      for (var i = declPath.length - 1; i >= 0; i--) {
        ...
        if (
          ...
          declKind !== PullElementKind.Interface
        ) {
        ...
        switch (declKind) {
          ...
          case PullElementKind.DynamicModule:
            ...
            var otherDecls = this.semanticInfoChain.findDeclsFromPath(
              declPath.slice(0, i + 1),
              PullElementKind.SomeContainer
            );
            for (var j = 0, m = otherDecls.length; j < m; j++) {
              ...
              for (var k = 0, s = otherDeclChildren.length; k < s; k++) {
                ...
                if (
                  otherDeclChild.flags & PullElementFlags.Exported &&
                  otherDeclChild.kind & declSearchKind
                ) {
          ...
          case PullElementKind.FunctionExpression:
            var functionExpressionName = (<PullFunctionExpressionDecl>(
              decl
            )).getFunctionExpressionName();
      ...
      for (var i = 0, n = topLevelDecls.length; i < n; i++) {
        ...
        if (
          declPath.length > 0 &&
          topLevelDecl.fileName() === declPath[0].fileName()
        ) {
    ...
    public getVisibleDecls(enclosingDecl: PullDecl): PullDecl[] {
      ...
      var declSearchKind: PullElementKind =
        PullElementKind.SomeType |
        PullElementKind.SomeContainer |
        PullElementKind.SomeValue;

      return this.getVisibleDeclsFromDeclPath(declPath, declSearchKind);
    }

    public getVisibleContextSymbols(
      enclosingDecl: PullDecl,
      context: PullTypeResolutionContext
    ): PullSymbol[] {
      var contextualTypeSymbol = context.getContextualType();
      if (
        !contextualTypeSymbol ||
        this.isAnyOrEquivalent(contextualTypeSymbol)
      ) {
        return null;
      }
      ...
      var declSearchKind: PullElementKind =
        ...
        PullElementKind.SomeContainer |
        PullElementKind.SomeValue;
      var members: PullSymbol[] = contextualTypeSymbol.getAllMembers(
        declSearchKind,
        GetAllMembersVisiblity.externallyVisible
      );
    ...
    public getVisibleMembersFromExpression(
      expression: AST,
      enclosingDecl: PullDecl,
      context: PullTypeResolutionContext
    ): PullSymbol[] {
      ...
      if (
        isTypesOnlyLocation(expression) &&
        (lhs.kind === PullElementKind.Class ||
          lhs.kind === PullElementKind.Interface)
      ) {
      ...
      if (containerSymbol.kind === PullElementKind.ConstructorType) {
        containerSymbol =
          containerSymbol.getConstructSignatures()[0].returnType;
      }
      ...
      if (lhsType.isContainer()) {
        var exportedAssignedContainerSymbol = (<PullContainerSymbol>(
          lhsType
        )).getExportAssignedContainerSymbol();
      ...
      if (lhsType.isTypeParameter()) {
        ...
        // could be a string
          ...
          lhsType === this.semanticInfoChain.stringTypeSymbol &&
        ...
        // could be a boolean
          ...
          lhsType === this.semanticInfoChain.booleanTypeSymbol &&
        ...
        if (!lhsType.isResolved) {
          var potentiallySpecializedType = <PullTypeSymbol>(
            this.resolveDeclaredSymbol(lhsType, context)
          );
        ...
        if (lhsType.isContainer()) {
          ...
          var exportedContainer = (<PullContainerSymbol>(
            lhsType
          )).getExportAssignedContainerSymbol();
          if (exportedContainer) {
            var exportedContainerMembers = exportedContainer.getAllMembers(
              declSearchKind,
              memberVisibilty
            );
          ...
          if (associatedContainerSymbol) {
            ...
            var containerMembers = containerType.getAllMembers(
              declSearchKind,
              memberVisibilty
            );
      ...
      if (
        (lhsType.getCallSignatures().length ||
          lhsType.getConstructSignatures().length) &&
        this.cachedFunctionInterfaceType()
      ) {
        members = members.concat(
          this.cachedFunctionInterfaceType().getAllMembers(
            declSearchKind,
            GetAllMembersVisiblity.externallyVisible
          )
        );
    ...
    private resolveExternalModuleReference(
      idText: string,
      ...
      if (isRelative(originalIdText)) {
        ...
        symbol =
          this.semanticInfoChain.findAmbientExternalModuleInGlobalContext(
            quoteStr(originalIdText)
          );
    ...
    private resolveDeclaredSymbolWorker(
      symbol: PullSymbol,
      context: PullTypeResolutionContext
    ): PullSymbol {
      ...
      for (var i = 0; i < decls.length; i++) {
        ...
        if (
          ...
          (ast.kind() === SyntaxKind.GetAccessor &&
            ast.parent.parent.kind() === SyntaxKind.ObjectLiteralExpression) ||
        ...
        if (
          ...
          ast.parent &&
          ast.parent.kind() === SyntaxKind.CatchClause
        ) {
          return symbol;
        }
        ...
        if (isAnyNameOfModule(enclosingModule, ast)) {
          resolvedSymbol = this.resolveSingleModuleDeclaration(
            enclosingModule,
            ast,
            context
          );
          ...
          decl.kind === PullElementKind.DynamicModule
        ) {
          // Otherwise, if we have a decl for the top level external module, then just resolve that
          // specific module.
          resolvedSymbol = this.resolveModuleSymbol(
            <PullContainerSymbol>decl.getSymbol(),
            context,
            /*moduleDeclAST:*/ null,
            /*moduleNameAST:*/ null,
            <SourceUnit>ast
          ...
          Debug.assert(
            ast.kind() != SyntaxKind.IdentifierName &&
              ast.kind() != SyntaxKind.MemberAccessExpression
          );
          var resolvedSymbol: PullSymbol = this.resolveAST(
            ast,
            /*isContextuallyTyped*/ false,
            context
          );
        }
        ...
        if (
          decl.kind == PullElementKind.Parameter &&
          !symbol.isResolved &&
          !symbol.type &&
          resolvedSymbol &&
          symbol.anyDeclHasFlag(
            PullElementFlags.PropertyParameter |
              PullElementFlags.ConstructorParameter
          )
        ) {
    ...
    private resolveOtherDeclarations(
      astName: AST,
      context: PullTypeResolutionContext
    ) {
      ...
      for (var i = 0; i < allDecls.length; i++) {
        ...
        if (astForCurrentDecl != astName) {
          ...
          if (isAnyNameOfModule(moduleDecl, astForCurrentDecl)) {
            this.resolveSingleModuleDeclaration(
              moduleDecl,
              astForCurrentDecl,
              context
            );
    ...
    private resolveSourceUnit(
      ...
      this.resolveFirstExportAssignmentStatement(
        sourceUnit.moduleElements,
        context
      );
      this.resolveAST(
        sourceUnit.moduleElements,
    ...
    private resolveEnumDeclaration(
      ast: EnumDeclaration,
      context: PullTypeResolutionContext
    ): PullTypeSymbol {
    ...
    private typeCheckEnumDeclaration(
      ast: EnumDeclaration,
      context: PullTypeResolutionContext
    ) {
    ...
    private postTypeCheckEnumDeclaration(
      ast: EnumDeclaration,
      context: PullTypeResolutionContext
    ) {
      this.checkThisCaptureVariableCollides(
        ast,
        /*isDeclaration*/ true,
        context
      );
    ...
    private resolveModuleDeclaration(
      ...
      if (ast.stringLiteral) {
        result = this.resolveSingleModuleDeclaration(
          ast,
          ast.stringLiteral,
          context
        );
    ...
    private resolveModuleSymbol(
      containerSymbol: PullContainerSymbol,
      context: PullTypeResolutionContext,
      moduleDeclAST: ModuleDeclaration,
      moduleDeclNameAST: AST,
      sourceUnitAST: SourceUnit
    ): PullTypeSymbol {
      if (containerSymbol.isResolved || containerSymbol.inResolution) {
        return containerSymbol;
      }
      ...
      if (isLastName) {
        this.resolveFirstExportAssignmentStatement(
          moduleDeclAST.moduleElements,
          context
        );
      } else if (sourceUnitAST) {
        this.resolveFirstExportAssignmentStatement(
          sourceUnitAST.moduleElements,
          context
        );
      }
    ...
    private resolveFirstExportAssignmentStatement(
      ...
      for (var i = 0, n = moduleElements.childCount(); i < n; i++) {
        ...
        if (moduleElement.kind() == SyntaxKind.ExportAssignment) {
          this.resolveExportAssignmentStatement(
            <ExportAssignment>moduleElement,
            context
          );
          return;
        }
    ...
    private resolveSingleModuleDeclaration(
      ast: ModuleDeclaration,
      astName: AST,
      context: PullTypeResolutionContext
    ): PullTypeSymbol {
      ...
      return this.resolveModuleSymbol(
        containerSymbol,
        context,
        ast,
        astName,
    ...
    private typeCheckModuleDeclaration(
      ast: ModuleDeclaration,
      context: PullTypeResolutionContext
    ): void {
      if (ast.stringLiteral) {
    ...
    private typeCheckSingleModuleDeclaration(
      ast: ModuleDeclaration,
      astName: AST,
      context: PullTypeResolutionContext
    ) {
      ...
      if (ast.stringLiteral) {
        if (isRelative(ast.stringLiteral.valueText())) {
          this.semanticInfoChain.addDiagnosticFromAST(
            ast.stringLiteral,
            DiagnosticCode.Ambient_external_module_declaration_cannot_specify_relative_module_name
          );
        }
      }
    ...
    private postTypeCheckModuleDeclaration(
      ast: ModuleDeclaration,
      context: PullTypeResolutionContext
    ) {
      this.checkThisCaptureVariableCollides(
    ...
    public createInstantiatedType(
      ...
      for (var i = 0; i < typeParameters.length; i++) {
        typeParameterArgumentMap[typeParameters[i].pullSymbolID] =
          typeArguments[i] ||
          new PullErrorTypeSymbol(
            this.semanticInfoChain.anyTypeSymbol,
            typeParameters[i].name
          );
      }

      return PullInstantiatedTypeReferenceSymbol.create(
        this,
        type,
    ...
    private resolveReferenceTypeDeclaration(
      ...
      var typeDeclIsClass =
        classOrInterface.kind() === SyntaxKind.ClassDeclaration;
      var hasVisited = this.getSymbolForAST(classOrInterface, context) != null;

      if (
        (typeDeclSymbol.isResolved && hasVisited) ||
        (typeDeclSymbol.inResolution && !context.isInBaseTypeResolution())
      ) {
      ...
      if (extendsClause) {
        for (
          var i = typeDeclSymbol.getKnownBaseTypeCount();
          i < extendsClause.typeNames.nonSeparatorCount();
          i = typeDeclSymbol.getKnownBaseTypeCount()
        ) {
          typeDeclSymbol.incrementKnownBaseCount();
          var parentType = this.resolveTypeReference(
            extendsClause.typeNames.nonSeparatorAt(i),
            context
          );
          ...
          if (typeDeclSymbol.isValidBaseKind(parentType, true)) {
            this.setSymbolForAST(
              extendsClause.typeNames.nonSeparatorAt(i),
              parentType,
              null /* setting it without context so that we record the baseType associated with the members */
            );
            ...
            if (
              !typeDeclSymbol.hasBase(parentType) &&
              !parentType.hasBase(typeDeclSymbol)
            ) {
      ...
      if (implementsClause && typeDeclIsClass) {
        var extendsCount = extendsClause
          ? extendsClause.typeNames.nonSeparatorCount()
          : 0;
        for (
          var i = typeDeclSymbol.getKnownBaseTypeCount();
          i - extendsCount >= 0 &&
          i - extendsCount < implementsClause.typeNames.nonSeparatorCount();
          i = typeDeclSymbol.getKnownBaseTypeCount()
        ) {
          typeDeclSymbol.incrementKnownBaseCount();
          var implementedTypeAST = implementsClause.typeNames.nonSeparatorAt(
            i - extendsCount
          );
          var implementedType = this.resolveTypeReference(
            implementedTypeAST,
            context
          );
          ...
          if (typeDeclSymbol.isValidBaseKind(implementedType, false)) {
            this.setSymbolForAST(
              implementsClause.typeNames.nonSeparatorAt(i - extendsCount),
              implementedType,
              null /* setting it without context so that we record the baseType associated with the members */
            );
            ...
            // Do not add parentType as a base if it already added, or if it will cause a cycle as it already inherits from typeDeclSymbol
            if (
              !typeDeclSymbol.hasBase(implementedType) &&
              !implementedType.hasBase(typeDeclSymbol)
            ) {
      ...
      if (wasInBaseTypeResolution) {
        ...
        this.typeCheckCallBacks.push((context) => {
          if (classOrInterface.kind() == SyntaxKind.ClassDeclaration) {
            ...
            this.resolveInterfaceDeclaration(
              <InterfaceDeclaration>classOrInterface,
              context
            );
          }
        });
    ...
    private resolveClassDeclaration(
      ...
      var classDecl: PullDecl =
        this.semanticInfoChain.getDeclForAST(classDeclAST);
      var classDeclSymbol = <PullTypeSymbol>classDecl.getSymbol();
      if (!classDeclSymbol.isResolved) {
        this.resolveReferenceTypeDeclaration(
          classDeclAST,
          classDeclAST.identifier,
          classDeclAST.heritageClauses,
          context
        );
        ...
        if (constructorMethod) {
          ...
          var constructSignatures =
            constructorTypeSymbol.getConstructSignatures();

          if (!constructSignatures.length) {
            var constructorSignature: PullSignatureSymbol;

            var parentConstructor = parentType
              ? parentType.getConstructorMethod()
              : null;
            ...
            if (parentConstructor) {
              ...
              var parentConstructSignatures =
                parentConstructorType.getConstructSignatures();
              ...
              if (!parentConstructSignatures.length) {
                ...
                parentConstructSignature = new PullSignatureSymbol(
                  PullElementKind.ConstructSignature
                );
                parentConstructSignature.returnType = parentType;
                parentConstructorType.addConstructSignature(
                  parentConstructSignature
                );
                parentConstructSignature.addDeclaration(
                  parentType.getDeclarations()[0]
                );

                var parentTypeParameters =
                  parentConstructorType.getTypeParameters();

                for (var i = 0; i < parentTypeParameters.length; i++) {
                  parentConstructSignature.addTypeParameter(
                    <PullTypeParameterSymbol>parentTypeParameters[i]
                  );
                }
              ...
              for (var i = 0; i < parentConstructSignatures.length; i++) {
                ...
                constructorSignature = parentConstructSignature.isDefinition()
                  ? new PullDefinitionSignatureSymbol(
                      PullElementKind.ConstructSignature
                    )
                  : new PullSignatureSymbol(PullElementKind.ConstructSignature);
                constructorSignature.returnType = classDeclSymbol;

                for (var j = 0; j < parentParameters.length; j++) {
                  constructorSignature.addParameter(
                    parentParameters[j],
                    parentParameters[j].isOptional
                  );
                }
                ...
                for (var j = 0; j < typeParameters.length; j++) {
                  constructorSignature.addTypeParameter(
                    <PullTypeParameterSymbol>typeParameters[j]
                  );
                }

                constructorTypeSymbol.addConstructSignature(
                  constructorSignature
                );
                constructorSignature.addDeclaration(classDecl);
              }
            } else {
              // PULLREVIEW: This likely won't execute, unless there's some serious out-of-order resolution issues
              constructorSignature = new PullSignatureSymbol(
                PullElementKind.ConstructSignature
              );
              constructorSignature.returnType = classDeclSymbol;
              ...
              for (var i = 0; i < typeParameters.length; i++) {
                constructorSignature.addTypeParameter(
                  <PullTypeParameterSymbol>typeParameters[i]
                );
              }
            }
          }
          ...
          if (parentType) {
            ...
            if (parentConstructorSymbol) {
              ...
              if (!constructorTypeSymbol.hasBase(parentConstructorTypeSymbol)) {
                constructorTypeSymbol.addExtendedType(
                  parentConstructorTypeSymbol
                );
              }
            }
          }
    ...
    private typeCheckTypeParametersOfTypeDeclaration(
      classOrInterface: AST,
      context: PullTypeResolutionContext
    ) {
      var typeDecl: PullDecl =
        this.semanticInfoChain.getDeclForAST(classOrInterface);
      var typeDeclSymbol = <PullTypeSymbol>typeDecl.getSymbol();
      var typeDeclTypeParameters = typeDeclSymbol.getTypeParameters();
      for (var i = 0; i < typeDeclTypeParameters.length; i++) {
        this.checkSymbolPrivacy(
          typeDeclSymbol,
          typeDeclTypeParameters[i],
          (symbol: PullSymbol) =>
            this.typeParameterOfTypeDeclarationPrivacyErrorReporter(
              classOrInterface,
              i,
              <PullTypeParameterSymbol>typeDeclTypeParameters[i],
              symbol,
              context
            )
        );
    ...
    private typeCheckClassDeclaration(
      classDeclAST: ClassDeclaration,
      context: PullTypeResolutionContext
    ) {
      ...
      this.typeCheckBases(
        ...
        classDeclAST.heritageClauses,
        classDeclSymbol,
        this.getEnclosingDecl(classDecl),
        context
      );
    ...
    private postTypeCheckClassDeclaration(
      classDeclAST: ClassDeclaration,
      context: PullTypeResolutionContext
    ) {
      this.checkThisCaptureVariableCollides(
    ...
    private resolveTypeSymbolSignatures(
    ...
    private resolveInterfaceDeclaration(
      interfaceDeclAST: InterfaceDeclaration,
      context: PullTypeResolutionContext
    ): PullTypeSymbol {
      this.resolveReferenceTypeDeclaration(
        interfaceDeclAST,
        interfaceDeclAST.identifier,
        interfaceDeclAST.heritageClauses,
        context
      );

      var interfaceDecl =
        this.semanticInfoChain.getDeclForAST(interfaceDeclAST);
    ...
    private typeCheckInterfaceDeclaration(
      interfaceDeclAST: InterfaceDeclaration,
      context: PullTypeResolutionContext
    ) {
      ...
      this.typeCheckBases(
        ...
        interfaceDeclAST.heritageClauses,
        interfaceDeclSymbol,
        this.getEnclosingDecl(interfaceDecl),
        context
      );
    ...
    private getMemberSymbolOfKind(
      ...
      return {
        ...
        aliasSymbol:
          memberSymbol && memberSymbol.isAlias()
            ? <PullTypeAliasSymbol>memberSymbol
            : null,
      };
    }

    private resolveIdentifierOfInternalModuleReference(
      importDecl: PullDecl,
      identifier: Identifier,
      moduleSymbol: PullSymbol,
      enclosingDecl: PullDecl,
      context: PullTypeResolutionContext
    ): {
      valueSymbol: PullSymbol;
      typeSymbol: PullTypeSymbol;
      containerSymbol: PullContainerSymbol;
      ...
      var memberSymbol = this.getMemberSymbolOfKind(
        rhsName,
        PullElementKind.SomeContainer,
        moduleTypeSymbol,
        enclosingDecl,
      ...
      if (containerSymbol) {
        acceptableAlias =
          (containerSymbol.kind & PullElementKind.AcceptableAlias) != 0;
      ...
      if (
        !acceptableAlias &&
        containerSymbol &&
        containerSymbol.kind == PullElementKind.TypeAlias
      ) {
        this.resolveDeclaredSymbol(containerSymbol, context);
        var aliasedAssignedValue = (<PullTypeAliasSymbol>(
          containerSymbol
        )).getExportAssignedValueSymbol();
        var aliasedAssignedType = (<PullTypeAliasSymbol>(
          containerSymbol
        )).getExportAssignedTypeSymbol();
        var aliasedAssignedContainer = (<PullTypeAliasSymbol>(
          containerSymbol
        )).getExportAssignedContainerSymbol();

        if (
          aliasedAssignedValue ||
          aliasedAssignedType ||
          aliasedAssignedContainer
        ) {
      ...
      if (!acceptableAlias) {
        this.semanticInfoChain.addDiagnosticFromAST(
          identifier,
          DiagnosticCode.Import_declaration_referencing_identifier_from_internal_module_can_only_be_made_with_variables_functions_classes_interfaces_enums_and_internal_modules
        );
        return null;
      }
      ...
      if (!valueSymbol) {
        if (moduleTypeSymbol.getInstanceSymbol()) {
          memberSymbol = this.getMemberSymbolOfKind(
            rhsName,
            PullElementKind.SomeValue,
            moduleTypeSymbol.getInstanceSymbol().type,
            enclosingDecl,
            context
          );
      ...
      if (!valueSymbol && !typeSymbol && !containerSymbol) {
        this.semanticInfoChain.addDiagnosticFromAST(
          identifier,
          DiagnosticCode.Could_not_find_symbol_0_in_module_1,
          [rhsName, moduleSymbol.toString()]
        );
        return null;
      }
    ...
    private resolveModuleReference(
      ...
      Debug.assert(
        moduleNameExpr.kind() == SyntaxKind.QualifiedName ||
          moduleNameExpr.kind() == SyntaxKind.IdentifierName ||
          moduleNameExpr.kind() === SyntaxKind.StringLiteral,
      ...
      if (moduleNameExpr.kind() == SyntaxKind.QualifiedName) {
        ...
        var moduleContainer = this.resolveModuleReference(
          importDecl,
          dottedNameAST.left,
          enclosingDecl,
          context,
        ...
        if (moduleContainer) {
          ...
          moduleSymbol = this.getMemberSymbolOfKind(
            moduleName,
            PullElementKind.Container,
          ...
          if (!moduleSymbol) {
            this.semanticInfoChain.addDiagnosticFromAST(
              dottedNameAST.right,
              DiagnosticCode.Could_not_find_module_0_in_module_1,
              [moduleName, moduleContainer.toString()]
            );
          }
        }
      } else {
        var valueText =
          moduleNameExpr.kind() === SyntaxKind.IdentifierName
            ? (<Identifier>moduleNameExpr).valueText()
            : (<StringLiteral>moduleNameExpr).valueText();
        var text =
          moduleNameExpr.kind() === SyntaxKind.IdentifierName
            ? (<Identifier>moduleNameExpr).text()
            : (<StringLiteral>moduleNameExpr).text();

        if (text.length > 0) {
          var resolvedModuleNameSymbol = this.getSymbolFromDeclPath(
            valueText,
            declPath,
            PullElementKind.Container
          );
          moduleSymbol = this.filterSymbol(
            resolvedModuleNameSymbol,
            PullElementKind.Container,
            enclosingDecl,
            context
          );
          if (moduleSymbol) {
            ...
            if (resolvedModuleNameSymbol.isAlias()) {
              this.semanticInfoChain.setAliasSymbolForAST(
                moduleNameExpr,
                <PullTypeAliasSymbol>resolvedModuleNameSymbol
              );
            }
          } else {
            this.semanticInfoChain.addDiagnosticFromAST(
              moduleNameExpr,
              DiagnosticCode.Unable_to_resolve_module_reference_0,
              [valueText]
            );
          }
        }
    ...
    private resolveInternalModuleReference(
      importStatementAST: ImportDeclaration,
      context: PullTypeResolutionContext
    ) {
      ...
      if (
        aliasExpr.kind() === SyntaxKind.IdentifierName ||
        aliasExpr.kind() === SyntaxKind.StringLiteral
      ) {
        var moduleSymbol = this.resolveModuleReference(
          importDecl,
          aliasExpr,
          enclosingDecl,
          context,
        ...
        if (moduleSymbol) {
          ...
          this.semanticInfoChain.setAliasSymbolForAST(
            moduleReference,
            this.semanticInfoChain.getAliasSymbolForAST(aliasExpr)
          );
          if (aliasedType.anyDeclHasFlag(PullElementFlags.InitializedModule)) {
            var moduleName =
              aliasExpr.kind() === SyntaxKind.IdentifierName
                ? (<Identifier>aliasExpr).valueText()
                : (<StringLiteral>aliasExpr).valueText();
            var valueSymbol = this.getSymbolFromDeclPath(
              moduleName,
              declPath,
              PullElementKind.SomeValue
            );
            var instanceSymbol = (<PullContainerSymbol>(
              aliasedType
            )).getInstanceSymbol();
            // If there is module and it is instantiated, value symbol needs to refer to the module instance symbol
            if (
              valueSymbol &&
              (instanceSymbol != valueSymbol || valueSymbol.type == aliasedType)
            ) {
              var text =
                aliasExpr.kind() === SyntaxKind.IdentifierName
                  ? (<Identifier>aliasExpr).text()
                  : (<StringLiteral>aliasExpr).text();
              context.postDiagnostic(
                this.semanticInfoChain.diagnosticFromAST(
                  aliasExpr,
                  DiagnosticCode.Internal_module_reference_0_in_import_declaration_does_not_reference_module_instance_for_1,
                  [
                    text,
                    moduleSymbol.type.toString(
                      enclosingDecl ? enclosingDecl.getSymbol() : null
                    ),
                  ]
                )
              );
              ...
              var importDeclSymbol = <PullTypeAliasSymbol>(
                importDecl.getSymbol()
              );
        ...
        if (moduleSymbol) {
          var identifierResolution =
            this.resolveIdentifierOfInternalModuleReference(
              importDecl,
              dottedNameAST.right,
              moduleSymbol,
              enclosingDecl,
          ...
          if (identifierResolution) {
            importDeclSymbol.setAssignedValueSymbol(
              identifierResolution.valueSymbol
            );
            importDeclSymbol.setAssignedTypeSymbol(
              identifierResolution.typeSymbol
            );
            importDeclSymbol.setAssignedContainerSymbol(
              identifierResolution.containerSymbol
            );
            this.semanticInfoChain.setAliasSymbolForAST(
              moduleReference,
              identifierResolution.aliasSymbol
            );
    ...
    private resolveImportDeclaration(
      ...
      // reference
      if (
        importStatementAST.moduleReference.kind() ===
        SyntaxKind.ExternalModuleReference
      ) {
        // dynamic module name (string literal)
        var modPath = (<ExternalModuleReference>(
          importStatementAST.moduleReference
        )).stringLiteral.valueText();
        var declPath = enclosingDecl.getParentPath();

        aliasedType = this.resolveExternalModuleReference(
          modPath,
          importDecl.fileName()
        );

        if (!aliasedType) {
          var path = (<ExternalModuleReference>(
            importStatementAST.moduleReference
          )).stringLiteral.text();
          this.semanticInfoChain.addDiagnosticFromAST(
            importStatementAST,
            DiagnosticCode.Unable_to_resolve_external_module_0,
            [path]
          );
          aliasedType = this.semanticInfoChain.anyTypeSymbol;
        }
      } else {
        aliasedType = this.resolveInternalModuleReference(
          importStatementAST,
          context
        );
      }
      ...
      if (aliasedType) {
        if (!aliasedType.isContainer()) {
          this.semanticInfoChain.addDiagnosticFromAST(
            importStatementAST,
            DiagnosticCode.Module_cannot_be_aliased_to_a_non_module_type
          );
          aliasedType = this.semanticInfoChain.anyTypeSymbol;
        } else if (
        ...
        if (aliasedType.isContainer()) {
          importDeclSymbol.setAssignedContainerSymbol(
            <PullContainerSymbol>aliasedType
          );
        }
    ...
    private typeCheckImportDeclaration(
      importStatementAST: ImportDeclaration,
      context: PullTypeResolutionContext
    ) {
      ...
      if (
        ...
        if (this.compilationSettings.noResolve()) {
          context.postDiagnostic(
            this.semanticInfoChain.diagnosticFromAST(
              importStatementAST,
              DiagnosticCode.Import_declaration_cannot_refer_to_external_module_reference_when_noResolve_option_is_set,
              null
            )
          );
        }
        ...
        if (enclosingDecl.kind === PullElementKind.DynamicModule) {
          var ast = getEnclosingModuleDeclaration(
            this.getASTForDecl(enclosingDecl)
          );
      ...
      if (
        ...
        var containerSymbol =
          importDeclSymbol.getExportAssignedContainerSymbol();
      ...
      if (checkPrivacy) {
        ...
        this.checkSymbolPrivacy(
          ...
          (symbol: PullSymbol) => {
            var messageCode =
              DiagnosticCode.Exported_import_declaration_0_is_assigned_container_that_is_or_is_using_inaccessible_module_1;
            var messageArguments = [
              importDeclSymbol.getScopedName(
                enclosingDecl ? enclosingDecl.getSymbol() : null
              ),
              symbol.getScopedName(
                enclosingDecl ? enclosingDecl.getSymbol() : null,
                /*skipTypeParametersInName*/ false,
                /*useContraintInName*/ false,
                /*skipInternalAliasName*/ true
              ),
            ];
            context.postDiagnostic(
              this.semanticInfoChain.diagnosticFromAST(
        ...
        if (typeSymbol != containerSymbol) {
          this.checkSymbolPrivacy(
            ...
            (symbol: PullSymbol) => {
              var messageCode =
                symbol.isContainer() && !(<PullTypeSymbol>symbol).isEnum()
    ...
    private postTypeCheckImportDeclaration(
      importStatementAST: ImportDeclaration,
      context: PullTypeResolutionContext
    ) {
      if (
        importDeclarationIsElided(importStatementAST, this.semanticInfoChain)
      ) {
        this.checkNameForCompilerGeneratedDeclarationCollision(
          importStatementAST,
          /*isDeclaration*/ true,
          importStatementAST.identifier,
          context,
          /*immediateThisCheck*/ true
        );
      }
    }

    private resolveExportAssignmentStatement(
      exportAssignmentAST: ExportAssignment,
      context: PullTypeResolutionContext
    ): PullSymbol {
      ...
      if (
        !parentSymbol.isType() &&
        (<PullTypeSymbol>parentSymbol).isContainer()
      ) {
        // Error
        // Export assignments may only be used at the top-level of external modules
        this.semanticInfoChain.addDiagnosticFromAST(
          exportAssignmentAST,
          DiagnosticCode.Export_assignments_may_only_be_used_at_the_top_level_of_external_modules
        );
        return this.semanticInfoChain.anyTypeSymbol;
      }
      ...
      var declPath: PullDecl[] =
        enclosingDecl !== null ? [enclosingDecl] : <PullDecl[]>[];

      containerSymbol = this.getSymbolFromDeclPath(
        id,
        declPath,
        PullElementKind.SomeContainer
      );
      ...
      if (!acceptableAlias) {
        ...
        this.semanticInfoChain.addDiagnosticFromAST(
          exportAssignmentAST,
          DiagnosticCode.Export_assignments_may_only_be_made_with_variables_functions_classes_interfaces_enums_and_internal_modules
        );
      ...
      // if we haven't already gotten a value or type from the alias, look for them now
      if (!valueSymbol) {
        valueSymbol = this.getSymbolFromDeclPath(
          id,
          declPath,
          PullElementKind.SomeValue
        );
      ...
      if (!typeSymbol) {
        typeSymbol = this.getSymbolFromDeclPath(
          id,
          declPath,
          PullElementKind.SomeType
        );
      ...
      if (!valueSymbol && !typeSymbol && !containerSymbol) {
        ...
        context.postDiagnostic(
          this.semanticInfoChain.diagnosticFromAST(
            exportAssignmentAST,
            DiagnosticCode.Could_not_find_symbol_0,
            [id]
          )
        );
        return this.semanticInfoChain.voidTypeSymbol;
      ...
      if (valueSymbol) {
        (<PullContainerSymbol>parentSymbol).setExportAssignedValueSymbol(
          valueSymbol
        );
      }
      if (typeSymbol) {
        (<PullContainerSymbol>parentSymbol).setExportAssignedTypeSymbol(
          <PullTypeSymbol>typeSymbol
        );
      }
      if (containerSymbol) {
        (<PullContainerSymbol>parentSymbol).setExportAssignedContainerSymbol(
          <PullContainerSymbol>containerSymbol
        );
      }
    ...
    private resolveAnyFunctionTypeSignature(
      funcDeclAST: AST,
      ...
      var signature =
        funcDeclSymbol.kind === PullElementKind.ConstructorType
          ? funcDeclSymbol.getConstructSignatures()[0]
          : funcDeclSymbol.getCallSignatures()[0];
      ...
      if (typeParameters) {
        for (
          var i = 0;
          i < typeParameters.typeParameters.nonSeparatorCount();
          i++
        ) {
          this.resolveTypeParameterDeclaration(
            <TypeParameter>typeParameters.typeParameters.nonSeparatorAt(i),
            context
          );
        }
      }
      ...
      if (parameterList) {
        for (var i = 0; i < parameterList.parameters.nonSeparatorCount(); i++) {
          this.resolveFunctionTypeSignatureParameter(
            <Parameter>parameterList.parameters.nonSeparatorAt(i),
            signature,
            functionDecl,
            context
          );
    ...
    private resolveFunctionTypeSignatureParameter(
      argDeclAST: Parameter,
      ...
      if (argDeclAST.typeAnnotation) {
        ...
        if (paramSymbol.isVarArg && !typeRef.isArrayNamedTypeReference()) {
          var diagnostic = context.postDiagnostic(
            this.semanticInfoChain.diagnosticFromAST(
              argDeclAST,
              DiagnosticCode.Rest_parameters_must_be_array_types
            )
          );
        ...
        if (paramSymbol.isVarArg && paramSymbol.type) {
          ...
          if (this.compilationSettings.noImplicitAny()) {
            context.postDiagnostic(
              this.semanticInfoChain.diagnosticFromAST(
                argDeclAST,
                DiagnosticCode.Parameter_0_of_function_type_implicitly_has_an_any_type,
    ...
    private resolveFunctionExpressionParameter(
      argDeclAST: AST,
      id: Identifier,
      typeExpr: AST,
      equalsValueClause: EqualsValueClause,
      contextParam: PullSymbol,
      enclosingDecl: PullDecl,
      context: PullTypeResolutionContext
    ) {
      var paramDecl = this.semanticInfoChain.getDeclForAST(argDeclAST);
      ...
      if (equalsValueClause && (canTypeCheckAST || !contextualType)) {
        if (contextualType) {
          context.pushContextualType(
            contextualType,
            context.inProvisionalResolution(),
            null
          );
        }

        var initExprSymbol = this.resolveAST(
          equalsValueClause,
          contextualType != null,
          context
        );
        ...
        if (!initExprSymbol || !initExprSymbol.type) {
          context.postDiagnostic(
            this.semanticInfoChain.diagnosticFromAST(
              argDeclAST,
              DiagnosticCode.Unable_to_resolve_type_of_0,
              [id.text()]
            )
          );
          ...
          if (!contextualType) {
            context.setTypeInContext(
              paramSymbol,
              this.getNewErrorTypeSymbol(paramSymbol.name)
            );
          }
        } else {
          ...
          if (!contextualType) {
            ...
            context.setTypeInContext(
              paramSymbol,
              this.widenType(initTypeSymbol, equalsValueClause, context)
            );
            isImplicitAny = initTypeSymbol !== paramSymbol.type;
          } else {
            var comparisonInfo = new TypeComparisonInfo();

            var isAssignable = this.sourceIsAssignableToTarget(
              initTypeSymbol,
              contextualType,
              argDeclAST,
              context,
            ...
            if (!isAssignable) {
              ...
              if (comparisonInfo.message) {
                context.postDiagnostic(
                  this.semanticInfoChain.diagnosticFromAST(
                    argDeclAST,
                    DiagnosticCode.Cannot_convert_0_to_1_NL_2,
                    [
                      initTypeSymbol.toString(enclosingSymbol),
                      contextualType.toString(enclosingSymbol),
                ...
                context.postDiagnostic(
                  this.semanticInfoChain.diagnosticFromAST(
                    argDeclAST,
                    DiagnosticCode.Cannot_convert_0_to_1,
                    [
                      initTypeSymbol.toString(enclosingSymbol),
                      contextualType.toString(enclosingSymbol),
                    ]
        ...
        if (functionExpressionName) {
          context.postDiagnostic(
            this.semanticInfoChain.diagnosticFromAST(
              ...
              [id.text(), functionExpressionName]
            )
          );
        } else {
          context.postDiagnostic(
    ...
    private checkNameForCompilerGeneratedDeclarationCollision(
      astWithName: AST,
      isDeclaration: boolean,
      name: IASTToken,
      context: PullTypeResolutionContext,
      immediateThisCheck?: boolean
    ) {
      ...
      if (compilerReservedName) {
        switch (compilerReservedName) {
          ...
          case CompilerReservedNames._super: // _super
            this.checkSuperCaptureVariableCollides(
              astWithName,
              isDeclaration,
              context
            );
          ...
          case CompilerReservedNames._i: // _i
            if (isDeclaration) {
              this.checkIndexOfRestArgumentInitializationCollides(
                astWithName,
                context
              );
            }
          ...
          case CompilerReservedNames.exports: // require
            if (isDeclaration) {
              this.checkExternalModuleRequireExportsCollides(
                astWithName,
                name,
                context
              );
    ...
    private hasRestParameterCodeGen(someFunctionDecl: PullDecl) {
      ...
      if (nodeType == SyntaxKind.FunctionDeclaration) {
        ...
        return (
          !hasFlag(
            someFunctionDecl.kind == PullElementKind.Method
              ? someFunctionDecl.getParentDecl().flags
              : someFunctionDecl.flags,
            PullElementFlags.Ambient
          ) &&
        ...
        var arrowFunctionExpression = <ParenthesizedArrowFunctionExpression>(
          enclosingAST
        );
        return lastParameterIsRest(
          arrowFunctionExpression.callSignature.parameterList
        );
      } else if (nodeType === SyntaxKind.FunctionExpression) {
        var functionExpression = <FunctionExpression>enclosingAST;
        return lastParameterIsRest(
          functionExpression.callSignature.parameterList
        );
      }
    ...
    private checkArgumentsCollides(
      ast: AST,
      context: PullTypeResolutionContext
    ) {
        ...
        if (hasFlag(enclosingDecl.kind, PullElementKind.SomeFunction)) {
          if (this.hasRestParameterCodeGen(enclosingDecl)) {
            ...
            context.postDiagnostic(
              this.semanticInfoChain.diagnosticFromAST(
                ast,
                DiagnosticCode.Duplicate_identifier_arguments_Compiler_uses_arguments_to_initialize_rest_parameters
              )
            );
          }
        }
    ...
    private checkIndexOfRestArgumentInitializationCollides(
      ast: AST,
      context: PullTypeResolutionContext
    ) {
      if (ast.kind() == SyntaxKind.Parameter) {
    ...
    private checkExternalModuleRequireExportsCollides(
      ast: AST,
      name: IASTToken,
      context: PullTypeResolutionContext
    ) {
      ...
      if (
        enclosingDecl &&
        enclosingDecl.kind == PullElementKind.DynamicModule
      ) {
        ...
        if (!hasFlag(decl.flags, PullElementFlags.Ambient)) {
          ...
          context.postDiagnostic(
            this.semanticInfoChain.diagnosticFromAST(
              ast,
              DiagnosticCode.Duplicate_identifier_0_Compiler_reserves_name_1_in_top_level_scope_of_an_external_module,
              [nameText, nameText]
            )
          );
        }
    ...
    private resolveObjectTypeTypeReference(
      ...
      if (objectType.typeMembers) {
        ...
        for (var i = 0; i < typeMembers.nonSeparatorCount(); i++) {
          memberDecl = this.semanticInfoChain.getDeclForAST(
            typeMembers.nonSeparatorAt(i)
          );
          memberSymbol =
            memberDecl.kind & PullElementKind.SomeSignature
              ? memberDecl.getSignatureSymbol()
              : memberDecl.getSymbol();
          ...
          if (
            (memberType && memberType.isGeneric()) ||
            (memberSymbol.isSignature() &&
              (<PullSignatureSymbol>memberSymbol).isGeneric())
          ) {
    ...
    private typeCheckObjectTypeTypeReference(
      objectType: ObjectType,
      context: PullTypeResolutionContext
    ) {
    ...
    public resolveTypeReference(
      ...
      if (type.kind == PullElementKind.Container) {
        ...
        if (
          instanceSymbol &&
          (instanceSymbol.anyDeclHasFlag(
            PullElementFlags.ClassConstructorVariable
          ) ||
            instanceSymbol.kind == PullElementKind.ConstructorMethod)
        ) {
        ...
        if ((type.kind & PullElementKind.SomeType) === 0) {
          ...
          if (type.kind & PullElementKind.SomeContainer) {
            context.postDiagnostic(
              this.semanticInfoChain.diagnosticFromAST(
                typeRef,
                DiagnosticCode.Type_reference_cannot_refer_to_container_0,
                [aliasType ? aliasType.toString() : type.toString()]
              )
            );
          } else {
            context.postDiagnostic(
    ...
    private computeTypeReferenceSymbol(
      term: AST,
      context: PullTypeResolutionContext
    ): PullTypeSymbol {
      ...
      // a name
      if (term.kind() === SyntaxKind.IdentifierName) {
        typeDeclSymbol = this.resolveTypeNameExpression(
          <Identifier>term,
          context
        );
      }
      // a function
        ...
        typeDeclSymbol = this.resolveAnyFunctionTypeSignature(
          functionType,
          functionType.typeParameterList,
        ...
        typeDeclSymbol = this.resolveAnyFunctionTypeSignature(
          constructorType,
          constructorType.typeParameterList,
          constructorType.parameterList,
          constructorType.type,
          context
        );
      } else if (term.kind() === SyntaxKind.ObjectType) {
        typeDeclSymbol = this.resolveObjectTypeTypeReference(
          <ObjectType>term,
          context
        );
      } else if (term.kind() === SyntaxKind.GenericType) {
        typeDeclSymbol = this.resolveGenericTypeReference(
          <GenericType>term,
          context
        );
      } else if (term.kind() === SyntaxKind.QualifiedName) {
        // find the decl
        typeDeclSymbol = this.resolveQualifiedName(
          <QualifiedName>term,
          context
        );
        ...
        typeDeclSymbol = new PullStringConstantTypeSymbol(
          stringConstantAST.text()
        );
        var decl = new PullSynthesizedDecl(
          stringConstantAST.text(),
          stringConstantAST.text(),
          typeDeclSymbol.kind,
          null,
        ...
        if (valueSymbol && valueSymbol.isAlias()) {
          if ((<PullTypeAliasSymbol>valueSymbol).assignedValue()) {
            ...
            var containerSymbol = (<PullTypeAliasSymbol>(
              valueSymbol
            )).getExportAssignedContainerSymbol();
            valueSymbol =
              containerSymbol &&
              containerSymbol.isContainer() &&
              !containerSymbol.isEnum()
                ? containerSymbol.getInstanceSymbol()
                : null;
          }
        }
        ...
        if (!arraySymbol) {
          ...
          arraySymbol = this.createInstantiatedType(
      ...
      if (!typeDeclSymbol) {
        context.postDiagnostic(
          this.semanticInfoChain.diagnosticFromAST(
            term,
            DiagnosticCode.Unable_to_resolve_type
          )
        );
      ...
      if (
        ...
        context.postDiagnostic(
          this.semanticInfoChain.diagnosticFromAST(
            term,
            DiagnosticCode.Generic_type_references_must_include_all_type_arguments
          )
        );
    ...
    private genericTypeIsUsedWithoutRequiredTypeArguments(
      typeSymbol: PullTypeSymbol,
      term: AST,
      context: PullTypeResolutionContext
    ): boolean {
      return (
        typeSymbol.isNamedTypeSymbol() &&
    ...
    private resolveMemberVariableDeclaration(
      ...
      return this.resolveVariableDeclaratorOrParameterOrEnumElement(
        varDecl,
        varDecl.modifiers,
        varDecl.variableDeclarator.propertyName,
        getType(varDecl.variableDeclarator),
        varDecl.variableDeclarator.equalsValueClause,
        context
      );
    }

    private resolvePropertySignature(
      varDecl: PropertySignature,
      context: PullTypeResolutionContext
    ): PullSymbol {
      return this.resolveVariableDeclaratorOrParameterOrEnumElement(
        varDecl,
        [],
        varDecl.propertyName,
        getType(varDecl),
        null,
        context
      );
    ...
    private resolveVariableDeclarator(
      ...
      return this.resolveVariableDeclaratorOrParameterOrEnumElement(
        varDecl,
        getVariableDeclaratorModifiers(varDecl),
        varDecl.propertyName,
        getType(varDecl),
        varDecl.equalsValueClause,
        context
      );
    }
    ...
    private resolveEnumElement(
      ...
      return this.resolveVariableDeclaratorOrParameterOrEnumElement(
        enumElement,
        [],
        enumElement.propertyName,
        null,
        enumElement.equalsValueClause,
        context
      );
    }

    private typeCheckEnumElement(
      enumElement: EnumElement,
      context: PullTypeResolutionContext
    ): void {
    ...
    private resolveEqualsValueClause(
      clause: EqualsValueClause,
    ...
    private resolveVariableDeclaratorOrParameterOrEnumElement(
      ...
      var hasTypeExpr =
        typeExpr !== null ||
        varDeclOrParameter.kind() === SyntaxKind.EnumElement;
      ...
      var declParameterSymbol: PullSymbol = decl.getValueDecl()
        ? decl.getValueDecl().getSymbol()
        : null;
      ...
      if (declSymbol.isResolved) {
        ...
        if (!declSymbol.type || !declSymbol.type.isError()) {
          ...
          var typeExprSymbol =
            this.resolveAndTypeCheckVariableDeclarationTypeExpr(
              varDeclOrParameter,
              name,
              typeExpr,
              context
          ...
          if (!(hasTypeExpr || init)) {
            var defaultType: PullTypeSymbol =
              this.semanticInfoChain.anyTypeSymbol;

            if (declSymbol.isVarArg) {
              defaultType = this.createInstantiatedType(
                this.cachedArrayInterfaceType(),
                [defaultType]
              );
            }
    ...
    private resolveAndTypeCheckVariableDeclarationTypeExpr(
      ...
      if (varDeclOrParameter.kind() === SyntaxKind.EnumElement) {
        var result = this.getEnumTypeSymbol(
          <EnumElement>varDeclOrParameter,
          context
        );
      ...
      if (!typeExprSymbol) {
        ...
        if (typeExprSymbol.isContainer()) {
          var exportedTypeSymbol = (<PullContainerSymbol>(
            typeExprSymbol
          )).getExportAssignedTypeSymbol();
          ...
          if (exportedTypeSymbol) {
            ...
            if (typeExprSymbol.isAlias()) {
              typeExprSymbol = (<PullTypeAliasSymbol>(
                typeExprSymbol
              )).getExportAssignedTypeSymbol();
            }
            ...
            if (
              typeExprSymbol &&
              typeExprSymbol.isContainer() &&
              !typeExprSymbol.isEnum()
            ) {
              ...
              if (
                !instanceSymbol ||
                !PullHelpers.symbolIsEnum(instanceSymbol)
              ) {
          ...
          declSymbol.isVarArg &&
          !(
            typeExprSymbol.isArrayNamedTypeReference() ||
            typeExprSymbol == this.cachedArrayInterfaceType()
          )
        ) {
          context.postDiagnostic(
            this.semanticInfoChain.diagnosticFromAST(
        ...
        if (
          typeExprSymbol.kind == PullElementKind.FunctionType &&
          !typeExprSymbol.getFunctionSymbol()
        ) {
    ...
    private resolveAndTypeCheckVariableDeclaratorOrParameterInitExpr(
      ...
      if (!initExprSymbol) {
        ...
        widenedInitTypeSymbol = this.widenType(
          initTypeSymbol,
          init.value,
          context
        );
        ...
        if (!hasTypeExpr) {
          ...
          if (this.compilationSettings.noImplicitAny()) {
            ...
            if (
              widenedInitTypeSymbol != initTypeSymbol &&
              widenedInitTypeSymbol == this.semanticInfoChain.anyTypeSymbol
            ) {
              context.postDiagnostic(
                this.semanticInfoChain.diagnosticFromAST(
                  varDeclOrParameter,
                  DiagnosticCode.Variable_0_implicitly_has_an_any_type,
                  [name.text()]
                )
              );
            }
    ...
    private typeCheckPropertySignature(
      varDecl: PropertySignature,
      context: PullTypeResolutionContext
    ) {
      this.typeCheckVariableDeclaratorOrParameterOrEnumElement(
    ...
    private typeCheckVariableDeclaratorOrParameterOrEnumElement(
      ...
      if (hasTypeExpr || init) {
        ...
        if (
          typeExprSymbol &&
          typeExprSymbol.kind === PullElementKind.DynamicModule
        ) {
          var exportedTypeSymbol = (<PullContainerSymbol>(
            typeExprSymbol
          )).getExportAssignedTypeSymbol();
          ...
          if (exportedTypeSymbol) {
            ...
            var instanceTypeSymbol = (<PullContainerSymbol>(
              typeExprSymbol
            )).getInstanceType();
            ...
            if (!instanceTypeSymbol) {
              context.postDiagnostic(
                this.semanticInfoChain.diagnosticFromAST(
                  varDeclOrParameter,
                  DiagnosticCode.Tried_to_set_variable_type_to_uninitialized_module_type_0,
        ...
        if (initTypeSymbol && typeExprSymbol) {
          ...
          if (!isAssignable) {
            var enclosingSymbol =
              this.getEnclosingSymbolForAST(varDeclOrParameter);
            if (comparisonInfo.message) {
              context.postDiagnostic(
                this.semanticInfoChain.diagnosticFromAST(
                  varDeclOrParameter,
                  ...
                  [
                    initTypeSymbol.toString(enclosingSymbol),
                    typeExprSymbol.toString(enclosingSymbol),
                    comparisonInfo.message,
                  ]
                )
              );
        ...
        !this.isForInVariableDeclarator(varDeclOrParameter)
      ) {
        // if we're lacking both a type annotation and an initialization expression, the type is 'any'
        // if the noImplicitAny flag is set to be true, report an error
        ...
        // varDecl is a property in object type
          ...
          context.postDiagnostic(
            this.semanticInfoChain.diagnosticFromAST(
              varDeclOrParameter,
              DiagnosticCode.Member_0_of_object_type_implicitly_has_an_any_type,
              [name.text()]
            )
          );
        }
      ...
      if (init && varDeclOrParameter.kind() === SyntaxKind.Parameter) {
        ...
        if (containerSignature && !containerSignature.isDefinition()) {
          context.postDiagnostic(
            this.semanticInfoChain.diagnosticFromAST(
              varDeclOrParameter,
              DiagnosticCode.Default_arguments_are_not_allowed_in_an_overload_parameter
            )
          );
        }
      }
      if (
        declSymbol.kind != PullElementKind.Parameter &&
        (declSymbol.kind != PullElementKind.Property ||
          declSymbol.getContainer().isNamedTypeSymbol())
      ) {
        this.checkSymbolPrivacy(
          declSymbol,
          declSymbol.type,
          (symbol: PullSymbol) =>
            this.variablePrivacyErrorReporter(
              varDeclOrParameter,
              declSymbol,
              symbol,
              context
      ...
      if (
        (declSymbol.kind != PullElementKind.Property &&
          declSymbol.kind != PullElementKind.EnumMember) ||
        declSymbol.anyDeclHasFlag(PullElementFlags.PropertyParameter)
      ) {
    ...
    private isForInVariableDeclarator(ast: AST): boolean {
      return (
        ...
        (<ForInStatement>ast.parent.parent.parent).variableDeclaration ===
          ast.parent.parent
      );
    }

    private checkSuperCaptureVariableCollides(
      superAST: AST,
      isDeclaration: boolean,
      context: PullTypeResolutionContext
    ) {
      ...
      var classSymbol = this.getContextualClassSymbolForEnclosingDecl(
        superAST,
        enclosingDecl
      );
      ...
      if (
        classSymbol &&
        !classSymbol.anyDeclHasFlag(PullElementFlags.Ambient)
      ) {
        if (superAST.kind() == SyntaxKind.Parameter) {
          var enclosingAST = this.getASTForDecl(enclosingDecl);
          if (
            enclosingAST.kind() !==
              SyntaxKind.ParenthesizedArrowFunctionExpression &&
            enclosingAST.kind() !== SyntaxKind.SimpleArrowFunctionExpression
          ) {
            var block =
              enclosingDecl.kind == PullElementKind.Method
                ? (<FunctionDeclaration>enclosingAST).block
                : (<ConstructorDeclaration>enclosingAST).block;
            if (!block) {
    ...
    private checkThisCaptureVariableCollides(
      _thisAST: AST,
      isDeclaration: boolean,
      context: PullTypeResolutionContext
    ) {
      if (isDeclaration) {
        ...
        if (hasFlag(decl.flags, PullElementFlags.Ambient)) {
          // ambient declarations do not generate the code
          return;
        }
      }
      ...
      for (var i = declPath.length - 1; i >= 0; i--) {
        ...
        if (
          ...
          hasFlag(decl.flags, PullElementFlags.ArrowFunction)
        ) {
          continue;
        }

        if (
          declKind === PullElementKind.Function ||
    ...
    private postTypeCheckVariableDeclaratorOrParameter(
      varDeclOrParameter: AST,
      context: PullTypeResolutionContext
    ) {
      this.checkThisCaptureVariableCollides(
    ...
    private resolveTypeParameterDeclaration(
      typeParameterAST: TypeParameter,
      context: PullTypeResolutionContext
    ): PullTypeSymbol {
      var typeParameterDecl =
        this.semanticInfoChain.getDeclForAST(typeParameterAST);
      var typeParameterSymbol = <PullTypeParameterSymbol>(
        typeParameterDecl.getSymbol()
      );

      // REVIEW: We shouldn't bail if we're specializing
      if (typeParameterSymbol.isResolved || typeParameterSymbol.inResolution) {
        if (
          typeParameterSymbol.isResolved &&
          this.canTypeCheckAST(typeParameterAST, context)
        ) {
      ...
      if (typeParameterAST.constraint) {
        var constraintTypeSymbol = this.resolveTypeReference(
          typeParameterAST.constraint.type,
          context
        );
    ...
    private typeCheckTypeParameterDeclaration(
      typeParameterAST: TypeParameter,
      context: PullTypeResolutionContext
    ) {
      this.setTypeChecked(typeParameterAST, context);
    ...
    private resolveFunctionBodyReturnTypes(
      ...
      var preFindReturnExpressionTypes = (ast: AST, walker: IAstWalker) => {
        ...
        switch (ast.kind()) {
          ...
          case SyntaxKind.ReturnStatement:
            ...
            returnStatementsExpressions.push({
          ...
          case SyntaxKind.WithStatement:
            enclosingDeclStack[enclosingDeclStack.length] =
              this.semanticInfoChain.getDeclForAST(ast);
            break;
      ...
      var postFindReturnExpressionEnclosingDecls = function (
        ast: AST,
        walker: IAstWalker
      ) {
        switch (ast.kind()) {
      ...
      if (block) {
        getAstWalkerFactory().walk(
          block,
          (ast, walker) => {
            preFindReturnExpressionTypes(ast, walker);
          },
          (ast, walker) => {
            postFindReturnExpressionEnclosingDecls(ast, walker);
          }
        );
      } else {
        returnStatementsExpressions.push({
      ...
      if (!returnStatementsExpressions.length) {
        ...
        for (var i = 0; i < returnStatementsExpressions.length; i++) {
          ...
          if (returnExpression) {
            var returnType = this.resolveAST(
              returnExpression,
              useContextualType,
              context
            ).type;
            ...
            if (returnType.isError()) {
              ...
              if (
                returnExpression.parent.kind() === SyntaxKind.ReturnStatement
              ) {
                this.setSymbolForAST(
                  returnExpression.parent,
                  returnType,
                  context
                );
              }
        ...
        if (!returnExpressionSymbols.length) {
          ...
          var bestCommonReturnType = this.findBestCommonType(
            collection,
            context,
          ...
          if (returnType) {
            ...
            var newReturnType = this.widenType(
              returnType,
              returnExpression,
              context
            );
            ...
            if (
              !ArrayUtilities.contains(
                returnExpressionSymbols,
            ...
            if (this.compilationSettings.noImplicitAny()) {
              ...
              if (
                ...
                newReturnType === this.semanticInfoChain.anyTypeSymbol
              ) {
                var functionName = enclosingDecl.name;
                if (functionName == '') {
                  functionName = (<PullFunctionExpressionDecl>(
                    enclosingDecl
                  )).getFunctionExpressionName();
                }
                ...
                if (functionName != '') {
                  context.postDiagnostic(
                    this.semanticInfoChain.diagnosticFromAST(
                      funcDeclAST,
                      DiagnosticCode._0_which_lacks_return_type_annotation_implicitly_has_an_any_return_type,
                      [functionName]
                    )
                  );
                } else {
    ...
    private typeCheckConstructorDeclaration(
      funcDeclAST: ConstructorDeclaration,
      context: PullTypeResolutionContext
    ) {
      this.setTypeChecked(funcDeclAST, context);
      ...
      if (funcDeclAST.parameterList) {
        for (
          var i = 0;
          i < funcDeclAST.parameterList.parameters.nonSeparatorCount();
          i++
        ) {
          this.resolveAST(
            funcDeclAST.parameterList.parameters.nonSeparatorAt(i),
            /*isContextuallyTyped:*/ false,
            context
          );
        }
      ...
      if (
        funcDecl.getSignatureSymbol() &&
        funcDecl.getSignatureSymbol().isDefinition() &&
        this.enclosingClassIsDerived(funcDecl.getParentDecl())
      ) {
        ...
        if (!this.constructorHasSuperCall(funcDeclAST)) {
          context.postDiagnostic(
            new Diagnostic(
              funcDeclAST.fileName(),
              this.semanticInfoChain.lineMap(funcDeclAST.fileName()),
              funcDeclAST.start(),
              11 /* "constructor" */,
        ...
        //  - The constructor declares parameter properties or the containing class declares instance member variables with initializers.
          ...
          var firstStatement = this.getFirstStatementOfBlockOrNull(
            funcDeclAST.block
          );
          if (
            !firstStatement ||
            !this.isSuperInvocationExpressionStatement(firstStatement)
          ) {
            context.postDiagnostic(
              new Diagnostic(
                funcDeclAST.fileName(),
      ...
      this.checkFunctionTypePrivacy(
        ...
        /*isStatic:*/ false,
        null,
        Parameters.fromParameterList(funcDeclAST.parameterList),
        null,
        funcDeclAST.block,
        context
      );
    ...
    private constructorHasSuperCall(
    ...
    private typeCheckFunctionExpression(
      funcDecl: FunctionExpression,
      context: PullTypeResolutionContext
    ): void {
      this.typeCheckAnyFunctionExpression(
        funcDecl,
        funcDecl.callSignature.typeParameterList,
        getType(funcDecl),
        funcDecl.block,
        /*bodyExpression:*/ null,
        context
    ...
    private typeCheckCallSignature(
      funcDecl: CallSignature,
      context: PullTypeResolutionContext
    ): void {
    ...
    private typeCheckConstructSignature(
      funcDecl: ConstructSignature,
      context: PullTypeResolutionContext
    ): void {
      this.typeCheckFunctionDeclaration(
        funcDecl,
        ...
        null,
        funcDecl.callSignature.typeParameterList,
        funcDecl.callSignature.parameterList,
        getType(funcDecl),
        null,
        context
      );
    ...
    private typeCheckFunctionDeclaration(
      ...
      this.checkFunctionTypePrivacy(
        ...
        isStatic,
        typeParameters,
        Parameters.fromParameterList(parameters),
        returnTypeAnnotation,
        block,
        context
      );
      ...
      var hasReturn =
        (funcDecl.flags &
          (PullElementFlags.Signature | PullElementFlags.HasReturnStatement)) !=
        0;

      // If this is a function and it has returnType annotation, check if block contains non void return expression
      if (
        funcDeclAST.kind() !== SyntaxKind.ConstructSignature &&
        block &&
        returnTypeAnnotation != null &&
        !hasReturn
      ) {
        var isVoidOrAny =
          this.isAnyOrEquivalent(signature.returnType) ||
          signature.returnType === this.semanticInfoChain.voidTypeSymbol;

        if (
          !isVoidOrAny &&
          !(
            block.statements.childCount() > 0 &&
            block.statements.childAt(0).kind() === SyntaxKind.ThrowStatement
          )
        ) {
          ...
          context.postDiagnostic(
            this.semanticInfoChain.diagnosticFromAST(
              returnTypeAnnotation,
              DiagnosticCode.Function_0_declared_a_non_void_return_type_but_has_no_return_expression,
              [funcName]
            )
          );
        }
    ...
    private typeCheckIndexSignature(
      funcDeclAST: IndexSignature,
      context: PullTypeResolutionContext
    ): void {
      this.setTypeChecked(funcDeclAST, context);
      ...
      this.checkFunctionTypePrivacy(
        ...
        /*isStatic:*/ false,
        null,
        Parameters.fromParameter(funcDeclAST.parameter),
        getType(funcDeclAST),
        null,
        context
      );
      ...
      this.typeCheckCallBacks.push((context) => {
        ...
        var allIndexSignatures = this.getBothKindsOfIndexSignatures(
          parentSymbol,
          context
        );
        ...
        if (
          ...
          (isNumericIndexer ||
            stringIndexSignature.getDeclarations()[0].getParentDecl() !==
              numberIndexSignature.getDeclarations()[0].getParentDecl())
        ) {
          var comparisonInfo = new TypeComparisonInfo();

          if (
            !this.sourceIsSubtypeOfTarget(
              numberIndexSignature.returnType,
              stringIndexSignature.returnType,
              funcDeclAST,
              context,
              comparisonInfo
            )
            ...
            if (comparisonInfo.message) {
              context.postDiagnostic(
                this.semanticInfoChain.diagnosticFromAST(
                  funcDeclAST,
                  DiagnosticCode.Numeric_indexer_type_0_must_be_a_subtype_of_string_indexer_type_1_NL_2,
                  [
                    numberIndexSignature.returnType.toString(enclosingSymbol),
                    stringIndexSignature.returnType.toString(enclosingSymbol),
                    comparisonInfo.message,
                  ]
                )
              );
              ...
              context.postDiagnostic(
                this.semanticInfoChain.diagnosticFromAST(
                  funcDeclAST,
                  DiagnosticCode.Numeric_indexer_type_0_must_be_a_subtype_of_string_indexer_type_1,
                  [
                    numberIndexSignature.returnType.toString(enclosingSymbol),
                    stringIndexSignature.returnType.toString(enclosingSymbol),
                  ]
        ...
        var allMembers = parentSymbol.type.getAllMembers(
          PullElementKind.All,
          GetAllMembersVisiblity.all
        );
        for (var i = 0; i < allMembers.length; i++) {
          ...
          if (
            name ||
            (member.kind === PullElementKind.Property && name === '')
          ) {
            ...
            if (parentSymbol !== allMembers[i].getContainer()) {
              ...
              var indexerKindMatchesMemberNameKind =
                isNumericIndexer === isMemberNumeric;
              var onlyStringIndexerIsPresent = !numberIndexSignature;

              if (
                indexerKindMatchesMemberNameKind ||
                onlyStringIndexerIsPresent
              ) {
                var comparisonInfo = new TypeComparisonInfo();
                if (
                  !this.sourceIsSubtypeOfTarget(
                    ...
                    context,
                    comparisonInfo,
                    /*isComparingInstantiatedSignatures*/ false
                  )
                ) {
    ...
    private postTypeCheckFunctionDeclaration(
      ...
      if (returnTypeAnnotation) {
        ...
        if (!returnTypeSymbol) {
          context.postDiagnostic(
            this.semanticInfoChain.diagnosticFromAST(
              returnTypeAnnotation,
              DiagnosticCode.Cannot_resolve_return_type_reference
            )
          );
        } else {
          var isConstructor =
            funcDeclAST.kind() === SyntaxKind.ConstructorDeclaration ||
            funcDeclAST.kind() === SyntaxKind.ConstructSignature;
          if (
            isConstructor &&
            returnTypeSymbol === this.semanticInfoChain.voidTypeSymbol
          ) {
            context.postDiagnostic(
              this.semanticInfoChain.diagnosticFromAST(
                funcDeclAST,
                DiagnosticCode.Constructors_cannot_have_a_return_type_of_void
              )
            );
          }
        }
    ...
    private resolveMemberFunctionDeclaration(
      ...
      return this.resolveFunctionDeclaration(
        funcDecl,
        hasModifier(funcDecl.modifiers, PullElementFlags.Static),
    ...
    private resolveConstructSignature(
      funcDecl: ConstructSignature,
      context: PullTypeResolutionContext
    ): PullSymbol {
      return this.resolveFunctionDeclaration(
    ...
    private resolveSimpleArrowFunctionExpression(
      funcDecl: SimpleArrowFunctionExpression,
      isContextuallyTyped: boolean,
      context: PullTypeResolutionContext
    ): PullSymbol {
      return this.resolveAnyFunctionExpression(
        funcDecl,
        null,
        Parameters.fromIdentifier(funcDecl.identifier),
        null,
        funcDecl.block,
        funcDecl.expression,
        isContextuallyTyped,
    ...
    private resolveParenthesizedArrowFunctionExpression(
      funcDecl: ParenthesizedArrowFunctionExpression,
      isContextuallyTyped: boolean,
      context: PullTypeResolutionContext
    ): PullSymbol {
      return this.resolveAnyFunctionExpression(
        ...
        if (funcDeclAST.parameterList) {
          ...
          for (
            ...
            this.resolveParameter(
              <Parameter>funcDeclAST.parameterList.parameters.nonSeparatorAt(i),
              context
            );
          }
    ...
    private resolveIndexMemberDeclaration(
      ast: IndexMemberDeclaration,
      context: PullTypeResolutionContext
    ): PullSymbol {
      if (this.canTypeCheckAST(ast, context)) {
        this.setTypeChecked(ast, context);
    ...
    private resolveFunctionDeclaration(
      ...
      if (signature) {
        ...
        if (parameterList) {
          ...
          for (
            var i = 0;
            i < parameterList.parameters.nonSeparatorCount();
            i++
          ) {
        ...
        //     - if it's a constructor, we set the return type link during binding
          ...
          if (this.compilationSettings.noImplicitAny()) {
            context.postDiagnostic(
              this.semanticInfoChain.diagnosticFromAST(
                funcDeclAST,
                DiagnosticCode.Constructor_signature_which_lacks_return_type_annotation_implicitly_has_an_any_return_type
              )
            );
          }
        }
    ...
    private resolveSetterArgumentTypeAnnotation(
      ...
      if (
        ...
        setterFunctionDeclarationAst.parameterList.parameters.nonSeparatorCount() >
          0
      ) {
        var parameter = <Parameter>(
          setterFunctionDeclarationAst.parameterList.parameters.nonSeparatorAt(
            0
          )
        );
    ...
    private resolveAccessorDeclaration(
      funcDeclAst: AST,
      context: PullTypeResolutionContext
    ): PullSymbol {
      var functionDeclaration =
        this.semanticInfoChain.getDeclForAST(funcDeclAst);
      ...
      if (accessorSymbol.isResolved) {
        ...
        var getterFunctionDeclarationAst = getterSymbol
          ? <GetAccessor>getterSymbol.getDeclarations()[0].ast()
          : null;
        var hasGetter = getterSymbol !== null;

        var setterSymbol = accessorSymbol.getSetter();
        var setterFunctionDeclarationAst = setterSymbol
          ? <SetAccessor>setterSymbol.getDeclarations()[0].ast()
          : null;
        ...
        if (hasGetter) {
          getterSymbol = this.resolveGetAccessorDeclaration(
            getterFunctionDeclarationAst,
        ...
        if (hasSetter) {
          setterSymbol = this.resolveSetAccessorDeclaration(
            setterFunctionDeclarationAst,
            setterFunctionDeclarationAst.parameterList,
            context
          );
        ...
        if (hasGetter && hasSetter) {
          ...
          var setterSuppliedTypeSymbol: PullTypeSymbol = setterHasParameters
          ...
          accessorSymbol.type = setterHasParameters
            ? setterParameters[0].type
            : this.semanticInfoChain.anyTypeSymbol;
        } else {
          // only has getter
    ...
    private typeCheckAccessorDeclaration(
      funcDeclAst: AST,
      context: PullTypeResolutionContext
    ) {
      this.setTypeChecked(funcDeclAst, context);
    ...
    private resolveGetAccessorDeclaration(
      ...
      var signature: PullSignatureSymbol =
        getterTypeSymbol.getCallSignatures()[0];
    ...
    private checkIfGetterAndSetterTypeMatch(
      funcDeclAST: AST,
      context: PullTypeResolutionContext
    ) {
      var funcDecl = this.semanticInfoChain.getDeclForAST(funcDeclAST);
      ...
      if (getter && setter) {
        ...
        if (
          getterAST.typeAnnotation &&
          PullTypeResolver.hasSetAccessorParameterTypeAnnotation(setterAST)
        ) {
          ...
          var setterSuppliedTypeSymbol: PullTypeSymbol =
            setterParameters[0].type;
          var getterSuppliedTypeSymbol: PullTypeSymbol = getterSig.returnType;
          ...
          if (
            ...
            context.postDiagnostic(
              this.semanticInfoChain.diagnosticFromAST(
                funcDeclAST,
                DiagnosticCode.get_and_set_accessor_must_have_the_same_type
              )
            );
          }
        }
    ...
    private typeCheckGetAccessorDeclaration(
      ...
      if (
        !hasReturn &&
        !(
          funcDeclAST.block.statements.childCount() > 0 &&
          funcDeclAST.block.statements.childAt(0).kind() ===
        ...
        context.postDiagnostic(
          this.semanticInfoChain.diagnosticFromAST(
            funcNameAST,
            DiagnosticCode.Getters_must_return_a_value
          )
        );
      }
      ...
      if (setter) {
        ...
        var setterIsPrivate = hasFlag(
          setterDecl.flags,
          PullElementFlags.Private
        );
        var getterIsPrivate = hasModifier(
          funcDeclAST.modifiers,
          PullElementFlags.Private
        );
      ...
      this.checkFunctionTypePrivacy(
        funcDeclAST,
        hasModifier(funcDeclAST.modifiers, PullElementFlags.Static),
        /*typeParameters:*/ null,
        Parameters.fromParameterList(funcDeclAST.parameterList),
        getType(funcDeclAST),
        funcDeclAST.block,
    ...
    static hasSetAccessorParameterTypeAnnotation(setAccessor: SetAccessor) {
      return (
        setAccessor.parameterList &&
        setAccessor.parameterList.parameters.nonSeparatorCount() > 0 &&
        (<Parameter>setAccessor.parameterList.parameters.nonSeparatorAt(0))
          .typeAnnotation != null
      );
    }

    private resolveSetAccessorDeclaration(
      funcDeclAST: AST,
      parameterList: ParameterList,
      context: PullTypeResolutionContext
    ): PullSymbol {
    ...
    private typeCheckSetAccessorDeclaration(
      funcDeclAST: SetAccessor,
      context: PullTypeResolutionContext
    ) {
      // Accessors are handled only by resolve/typeCheckAccessorDeclaration,
      ...
      if (getter) {
        ...
        var getterIsPrivate = hasFlag(
          getterDecl.flags,
          PullElementFlags.Private
        );
        var setterIsPrivate = hasModifier(
          funcDeclAST.modifiers,
          PullElementFlags.Private
        );
        ...
        if (this.compilationSettings.noImplicitAny()) {
          ...
          var setterFunctionDeclarationAst = <SetAccessor>funcDeclAST;
          if (
            !PullTypeResolver.hasSetAccessorParameterTypeAnnotation(
              setterFunctionDeclarationAst
            ) &&
            accessorSymbol.type == this.semanticInfoChain.anyTypeSymbol
          ) {
            context.postDiagnostic(
              this.semanticInfoChain.diagnosticFromAST(
                funcDeclAST,
                DiagnosticCode._0_which_lacks_get_accessor_and_parameter_type_annotation_on_set_accessor_implicitly_has_an_any_type,
                [setterFunctionDeclarationAst.propertyName.text()]
              )
            );
          }
        }
    ...
    private resolveLogicalOperation(
    ...
    private typeCheckLogicalOperation(
      binex: BinaryExpression,
      context: PullTypeResolutionContext
    ) {
      this.setTypeChecked(binex, context);

      var leftType = this.resolveAST(
        binex.left,
        /*isContextuallyTyped:*/ false,
        context
      ).type;
      var rightType = this.resolveAST(
        binex.right,
        /*isContextuallyTyped:*/ false,
        context
      ).type;
      ...
      if (
        ...
        context.postDiagnostic(
          this.semanticInfoChain.diagnosticFromAST(
            ...
            [
              SyntaxFacts.getText(
                SyntaxFacts.getOperatorTokenFromBinaryExpression(binex.kind())
              ),
              leftType.toString(enclosingSymbol),
              rightType.toString(enclosingSymbol),
            ]
          )
        );
      }
    ...
    private resolveLogicalNotExpression(
    ...
    private resolveUnaryArithmeticOperation(
      ast: PrefixUnaryExpression,
      context: PullTypeResolutionContext
    ): PullSymbol {
      if (this.canTypeCheckAST(ast, context)) {
    ...
    private resolvePostfixUnaryExpression(
    ...
    private isAnyOrNumberOrEnum(type: PullTypeSymbol): boolean {
      return (
        this.isAnyOrEquivalent(type) ||
        type === this.semanticInfoChain.numberTypeSymbol ||
        PullHelpers.symbolIsEnum(type)
      );
    }

    private typeCheckUnaryArithmeticOperation(
      ...
      var expression = this.resolveAST(
      ...
      if (
        nodeType == SyntaxKind.PlusExpression ||
        nodeType == SyntaxKind.NegateExpression ||
        nodeType == SyntaxKind.BitwiseNotExpression
      ) {
        return;
      }
      ...
      if (!this.isAnyOrNumberOrEnum(operandType)) {
        context.postDiagnostic(
          this.semanticInfoChain.diagnosticFromAST(
            unaryExpression.operand,
            DiagnosticCode.The_type_of_a_unary_arithmetic_operation_operand_must_be_of_type_any_number_or_an_enum_type
          )
        );
      }
      ...
      if (!this.isReference(unaryExpression.operand, expression)) {
        context.postDiagnostic(
          this.semanticInfoChain.diagnosticFromAST(
            unaryExpression.operand,
            DiagnosticCode.The_operand_of_an_increment_or_decrement_operator_must_be_a_variable_property_or_indexer
          )
        );
      }
    }

    private typeCheckPostfixUnaryExpression(
      unaryExpression: PostfixUnaryExpression,
      context: PullTypeResolutionContext
    ): void {
      this.setTypeChecked(unaryExpression, context);
    ...
    private resolveBinaryArithmeticExpression(
    ...
    private typeCheckBinaryArithmeticExpression(
      binaryExpression: BinaryExpression,
      context: PullTypeResolutionContext
    ) {
      this.setTypeChecked(binaryExpression, context);

      var lhsSymbol = this.resolveAST(
      ...
      if (
        lhsType === this.semanticInfoChain.nullTypeSymbol ||
        lhsType === this.semanticInfoChain.undefinedTypeSymbol
      ) {
        lhsType = rhsType;
      }

      if (
        rhsType === this.semanticInfoChain.nullTypeSymbol ||
        rhsType === this.semanticInfoChain.undefinedTypeSymbol
      ) {
        rhsType = lhsType;
      }
      ...
      if (!rhsIsFit) {
        context.postDiagnostic(
          this.semanticInfoChain.diagnosticFromAST(
            binaryExpression.right,
            DiagnosticCode.The_right_hand_side_of_an_arithmetic_operation_must_be_of_type_any_number_or_an_enum_type
          )
        );
      }
      ...
      if (!lhsIsFit) {
        context.postDiagnostic(
          this.semanticInfoChain.diagnosticFromAST(
            binaryExpression.left,
            DiagnosticCode.The_left_hand_side_of_an_arithmetic_operation_must_be_of_type_any_number_or_an_enum_type
          )
        );
      }
          ...
          case SyntaxKind.ExclusiveOrAssignmentExpression:
            ...
            if (!this.isReference(binaryExpression.left, lhsSymbol)) {
              context.postDiagnostic(
                this.semanticInfoChain.diagnosticFromAST(
                  binaryExpression.left,
                  DiagnosticCode.Invalid_left_hand_side_of_assignment_expression
                )
              );
            }

            this.checkAssignability(
              binaryExpression.left,
              rhsType,
              lhsType,
              context
    ...
    private resolveTypeOfExpression(
    ...
    private resolveDeleteExpression(
    ...
    private typeCheckInstanceOfExpression(
      binaryExpression: BinaryExpression,
      context: PullTypeResolutionContext
    ) {
      this.setTypeChecked(binaryExpression, context);
      ...
      var isValidLHS =
        this.isAnyOrEquivalent(lhsType) ||
        lhsType.isObject() ||
        lhsType.isTypeParameter();
      var isValidRHS =
        this.isAnyOrEquivalent(rhsType) ||
        this.typeIsSubtypeOfFunction(rhsType, binaryExpression, context);

      if (!isValidLHS) {
        context.postDiagnostic(
          this.semanticInfoChain.diagnosticFromAST(
            binaryExpression.left,
            DiagnosticCode.The_left_hand_side_of_an_instanceof_expression_must_be_of_type_any_an_object_type_or_a_type_parameter
          )
        );
      }
      ...
      if (!isValidRHS) {
        context.postDiagnostic(
          this.semanticInfoChain.diagnosticFromAST(
            binaryExpression.right,
            DiagnosticCode.The_right_hand_side_of_an_instanceof_expression_must_be_of_type_any_or_a_subtype_of_the_Function_interface_type
          )
        );
      }
    }
    ...
    private typeCheckInExpression(
      ...
      var isValidRHS =
        this.isAnyOrEquivalent(rhsType) ||
        rhsType.isObject() ||
        rhsType.isTypeParameter();

      if (!isValidLHS) {
        context.postDiagnostic(
          this.semanticInfoChain.diagnosticFromAST(
            binaryExpression.left,
            DiagnosticCode.The_left_hand_side_of_an_in_expression_must_be_of_types_any_string_or_number
          )
        );
      }
      ...
      if (!isValidRHS) {
        context.postDiagnostic(
          this.semanticInfoChain.diagnosticFromAST(
            binaryExpression.left,
            DiagnosticCode.The_right_hand_side_of_an_in_expression_must_be_of_type_any_an_object_type_or_a_type_parameter
          )
        );
      }
    }

    private resolveForStatement(
      ast: ForStatement,
      context: PullTypeResolutionContext
    ): PullSymbol {
      if (this.canTypeCheckAST(ast, context)) {
    ...
    private typeCheckForInStatement(
      forInStatement: ForInStatement,
      context: PullTypeResolutionContext
    ) {
      ...
      if (forInStatement.variableDeclaration) {
        ...
        var varDecl = <VariableDeclarator>(
          declaration.declarators.nonSeparatorAt(0)
        );
        ...
        if (varDecl.typeAnnotation) {
          context.postDiagnostic(
            this.semanticInfoChain.diagnosticFromAST(
              lval,
              DiagnosticCode.Variable_declarations_of_a_for_statement_cannot_use_a_type_annotation
            )
          );
        }
      ...
      var isStringOrNumber =
        varSym.type === this.semanticInfoChain.stringTypeSymbol ||
        this.isAnyOrEquivalent(varSym.type);

      var isValidRHS =
        rhsType && (this.isAnyOrEquivalent(rhsType) || !rhsType.isPrimitive());

      if (!isStringOrNumber) {
        context.postDiagnostic(
          this.semanticInfoChain.diagnosticFromAST(
            lval,
            DiagnosticCode.Variable_declarations_of_a_for_statement_must_be_of_types_string_or_any
          )
        );
      }
      ...
      if (!isValidRHS) {
        context.postDiagnostic(
          this.semanticInfoChain.diagnosticFromAST(
            forInStatement.expression,
            DiagnosticCode.The_right_hand_side_of_a_for_in_statement_must_be_of_type_any_an_object_type_or_a_type_parameter
          )
        );
      }
    ...
    private typeCheckWhileStatement(
      ast: WhileStatement,
      context: PullTypeResolutionContext
    ) {
      this.setTypeChecked(ast, context);
    ...
    private resolveVariableStatement(
    ...
    private resolveVariableDeclarationList(
      ast: VariableDeclaration,
      context: PullTypeResolutionContext
    ): PullSymbol {
      if (this.canTypeCheckAST(ast, context)) {
    ...
    private typeCheckWithStatement(
      ast: WithStatement,
      context: PullTypeResolutionContext
    ) {
      this.setTypeChecked(ast, context);
      ...
      context.postDiagnostic(
        this.semanticInfoChain.diagnosticFromAST(
          withStatement.condition,
          DiagnosticCode.All_symbols_within_a_with_block_will_be_resolved_to_any
        )
      );
    }

    private resolveTryStatement(
      ast: AST,
      context: PullTypeResolutionContext
    ): PullSymbol {
      if (this.canTypeCheckAST(ast, context)) {
    ...
    private typeCheckFinallyClause(
      ast: FinallyClause,
      context: PullTypeResolutionContext
    ) {
      this.setTypeChecked(ast, context);
    ...
    private resolveReturnExpression(
      ...
      if (enclosingFunction) {
        ...
        if (typeAnnotation) {
          ...
          var returnTypeAnnotationSymbol = this.resolveTypeReference(
            typeAnnotation,
            context
          );
          ...
          if (currentContextualType && currentContextualType.isFunction()) {
            var currentContextTypeDecls =
              currentContextualType.getDeclarations();
            ...
            if (currentContextualTypeReturnTypeSymbol) {
              isContextuallyTyped = true;
              context.pushContextualType(
                currentContextualTypeReturnTypeSymbol,
                context.inProvisionalResolution(),
                null
              );
            }
    ...
    private typeCheckReturnExpression(
      expression: AST,
      ...
      if (
        enclosingFunction &&
        enclosingFunction.kind === PullElementKind.ConstructorMethod
      ) {
        ...
        if (classDecl) {
          ...
          if (!isAssignable) {
            context.postDiagnostic(
              this.semanticInfoChain.diagnosticFromAST(
                expression,
                DiagnosticCode.Return_type_of_constructor_signature_must_be_assignable_to_the_instance_type_of_the_class
              )
            );
          }
        }
      ...
      if (
        enclosingFunction &&
        enclosingFunction.kind === PullElementKind.SetAccessor
      ) {
        context.postDiagnostic(
          this.semanticInfoChain.diagnosticFromAST(
            expression,
            DiagnosticCode.Setters_cannot_return_a_value
          )
        );
      }
      ...
      if (enclosingFunction) {
        ...
        if (
          typeAnnotation ||
          enclosingFunction.kind === PullElementKind.GetAccessor
        ) {
          ...
          if (expressionType && sigReturnType) {
            ...
            if (expressionType.isTypeParameter()) {
              upperBound = (<PullTypeParameterSymbol>(
                expressionType
              )).getConstraint();
              ...
              if (comparisonInfo.message) {
                context.postDiagnostic(
                  this.semanticInfoChain.diagnosticFromAST(
                    ...
                    DiagnosticCode.Cannot_convert_0_to_1_NL_2,
                    [
                      expressionType.toString(enclosingSymbol),
                      sigReturnType.toString(enclosingSymbol),
                      comparisonInfo.message,
                    ]
                  )
                );
    ...
    private resolveSwitchStatement(
      ast: SwitchStatement,
      context: PullTypeResolutionContext
    ): PullSymbol {
      if (this.canTypeCheckAST(ast, context)) {
    ...
    private typeCheckSwitchStatement(
      ast: SwitchStatement,
      context: PullTypeResolutionContext
    ) {
      this.setTypeChecked(ast, context);
      ...
      for (var i = 0, n = ast.switchClauses.childCount(); i < n; i++) {
        ...
        if (switchClause.kind() === SyntaxKind.CaseSwitchClause) {
          ...
          var caseClauseExpressionType = this.resolveAST(
            caseSwitchClause.expression,
            /*isContextuallyTyped:*/ false,
            context
          ).type;
          this.resolveAST(
            caseSwitchClause.statements,
            /*isContextuallyTyped:*/ false,
            context
          );
          ...
          if (
            ...
            var enclosingSymbol = this.getEnclosingSymbolForAST(
              caseSwitchClause.expression
            );
            if (comparisonInfo.message) {
              context.postDiagnostic(
                this.semanticInfoChain.diagnosticFromAST(
                  ...
                  DiagnosticCode.Cannot_convert_0_to_1_NL_2,
                  [
                    caseClauseExpressionType.toString(enclosingSymbol),
                    expressionType.toString(enclosingSymbol),
                    comparisonInfo.message,
                  ]
                )
    ...
    private resolveLabeledStatement(
    ...
    private typeCheckLabeledStatement(
      ast: LabeledStatement,
      context: PullTypeResolutionContext
    ): void {
      this.setTypeChecked(ast, context);
      ...
      var breakableLabels = this.getEnclosingLabels(
        ast,
        /*breakable:*/ true,
    ...
    private labelIsOnContinuableConstruct(statement: AST): boolean {
      switch (statement.kind()) {
        case SyntaxKind.LabeledStatement:
          ...
          // continuable.
          return this.labelIsOnContinuableConstruct(
    ...
    private resolveContinueStatement(
    ...
    private getEnclosingLabels(
      ast: AST,
      breakable: boolean,
      crossFunctions: boolean
    ): string[] {
      var result: string[] = [];
      ...
      while (ast) {
        if (ast.kind() === SyntaxKind.LabeledStatement) {
          ...
          if (breakable) {
            ...
            // a loop construct.
            if (
              this.labelIsOnContinuableConstruct(labeledStatement.statement)
            ) {
              result.push(labeledStatement.identifier.valueText());
            }
          }
    ...
    private typeCheckContinueStatement(
      ast: ContinueStatement,
      context: PullTypeResolutionContext
    ): void {
      this.setTypeChecked(ast, context);
      ...
      if (!this.inIterationStatement(ast)) {
        ...
        var continuableLabels = this.getEnclosingLabels(
          ast,
          /*breakable:*/ false,
          /*crossFunctions:*/ false
        );
    ...
    private typeCheckBreakStatement(
      ast: BreakStatement,
      context: PullTypeResolutionContext
    ): void {
      this.setTypeChecked(ast, context);
      ...
      if (ast.identifier) {
        ...
        if (
          !ArrayUtilities.contains(breakableLabels, ast.identifier.valueText())
        ) {
          // The target of the continue statement wasn't to a reachable label.
          //
          // Let hte user know, with a specialized message if the target was to an
        ...
        !this.inIterationStatement(ast) &&
        !this.inSwitchStatement(ast)
      ) {
        context.postDiagnostic(
          this.semanticInfoChain.diagnosticFromAST(
            ast,
    ...
    private auxResolveAST(
      ...
      switch (nodeType) {
        ...
        case SyntaxKind.VariableDeclaration:
          return this.resolveVariableDeclarationList(
            <VariableDeclaration>ast,
            context
          );

        case SyntaxKind.MemberVariableDeclaration:
          return this.resolveMemberVariableDeclaration(
            <MemberVariableDeclaration>ast,
            context
          );

        case SyntaxKind.VariableDeclarator:
          return this.resolveVariableDeclarator(
        ...
        case SyntaxKind.EqualsValueClause:
          return this.resolveEqualsValueClause(
            <EqualsValueClause>ast,
            isContextuallyTyped,
            context
          );

        case SyntaxKind.TypeParameter:
          return this.resolveTypeParameterDeclaration(
            <TypeParameter>ast,
            context
          );
        ...
        case SyntaxKind.ObjectLiteralExpression:
          return this.resolveObjectLiteralExpression(
        ...
        case SyntaxKind.SimplePropertyAssignment:
          return this.resolveSimplePropertyAssignment(
            <SimplePropertyAssignment>ast,
            isContextuallyTyped,
            context
          );

        case SyntaxKind.FunctionPropertyAssignment:
          return this.resolveFunctionPropertyAssignment(
            <FunctionPropertyAssignment>ast,
            isContextuallyTyped,
            context
          );
        ...
        case SyntaxKind.MemberAccessExpression:
          return this.resolveMemberAccessExpression(
            <MemberAccessExpression>ast,
            context
          );
        ...
        case SyntaxKind.ConstructorDeclaration:
          return this.resolveConstructorDeclaration(
        ...
        case SyntaxKind.IndexMemberDeclaration:
          return this.resolveIndexMemberDeclaration(
            <IndexMemberDeclaration>ast,
            context
          );
        ...
        case SyntaxKind.MemberFunctionDeclaration:
          return this.resolveMemberFunctionDeclaration(
            <MemberFunctionDeclaration>ast,
            context
          );
        ...
        case SyntaxKind.ConstructSignature:
          return this.resolveConstructSignature(
            <ConstructSignature>ast,
            context
          );
        ...
        case SyntaxKind.FunctionDeclaration:
          return this.resolveAnyFunctionDeclaration(
        ...
        case SyntaxKind.SimpleArrowFunctionExpression:
          return this.resolveSimpleArrowFunctionExpression(
            <SimpleArrowFunctionExpression>ast,
            isContextuallyTyped,
            context
          );
        ...
        case SyntaxKind.ParenthesizedArrowFunctionExpression:
          return this.resolveParenthesizedArrowFunctionExpression(
            <ParenthesizedArrowFunctionExpression>ast,
            isContextuallyTyped,
            context
          );

        case SyntaxKind.ArrayLiteralExpression:
          return this.resolveArrayLiteralExpression(
            <ArrayLiteralExpression>ast,
            isContextuallyTyped,
            context
          );
        ...
        case SyntaxKind.InvocationExpression:
          return this.resolveInvocationExpression(
            <InvocationExpression>ast,
            context
          );

        case SyntaxKind.ObjectCreationExpression:
          return this.resolveObjectCreationExpression(
        ...
        case SyntaxKind.ExportAssignment:
          return this.resolveExportAssignmentStatement(
            <ExportAssignment>ast,
            context
          );
        ...
        case SyntaxKind.AssignmentExpression:
          return this.resolveAssignmentExpression(
        ...
        case SyntaxKind.LogicalNotExpression:
          return this.resolveLogicalNotExpression(
            <PrefixUnaryExpression>ast,
            context
          );
        ...
        case SyntaxKind.AddAssignmentExpression:
          return this.resolveBinaryAdditionOperation(
            <BinaryExpression>ast,
            context
          );
        ...
        case SyntaxKind.PreDecrementExpression:
          return this.resolveUnaryArithmeticOperation(
            <PrefixUnaryExpression>ast,
            context
          );
        ...
        case SyntaxKind.PostDecrementExpression:
          return this.resolvePostfixUnaryExpression(
            <PostfixUnaryExpression>ast,
            context
          );
        ...
        case SyntaxKind.OrAssignmentExpression:
        case SyntaxKind.AndAssignmentExpression:
          return this.resolveBinaryArithmeticExpression(
            <BinaryExpression>ast,
            context
          );
        ...
        case SyntaxKind.LogicalAndExpression:
          return this.resolveLogicalAndExpression(
            <BinaryExpression>ast,
            context
          );
        ...
        case SyntaxKind.ConditionalExpression:
          return this.resolveConditionalExpression(
        ...
        case SyntaxKind.ParenthesizedExpression:
          return this.resolveParenthesizedExpression(
            <ParenthesizedExpression>ast,
            context
          );

        case SyntaxKind.ExpressionStatement:
          return this.resolveExpressionStatement(
    ...
    private typeCheckAST(
      ...
      switch (nodeType) {
        ...
        case SyntaxKind.InterfaceDeclaration:
          this.typeCheckInterfaceDeclaration(
            <InterfaceDeclaration>ast,
            context
          );
          return;
        ...
        case SyntaxKind.ObjectLiteralExpression:
          this.resolveObjectLiteralExpression(
            <ObjectLiteralExpression>ast,
            isContextuallyTyped,
            context
          );
        ...
        case SyntaxKind.MemberAccessExpression:
          this.resolveMemberAccessExpression(
            <MemberAccessExpression>ast,
            context
          );
          return;
        ...
        case SyntaxKind.SimpleArrowFunctionExpression:
          this.typeCheckSimpleArrowFunctionExpression(
            <SimpleArrowFunctionExpression>ast,
            context
          );
          return;
        ...
        case SyntaxKind.ArrayLiteralExpression:
          this.resolveArrayLiteralExpression(
            <ArrayLiteralExpression>ast,
            isContextuallyTyped,
            context
          );
        ...
        case SyntaxKind.InvocationExpression:
          this.typeCheckInvocationExpression(
            <InvocationExpression>ast,
            context
          );
          return;
        ...
        case SyntaxKind.ObjectCreationExpression:
          this.typeCheckObjectCreationExpression(
            <ObjectCreationExpression>ast,
            context
          );
          return;
    ...
    private postTypeCheck(ast: AST, context: PullTypeResolutionContext) {
      ...
      switch (nodeType) {
        ...
        case SyntaxKind.FunctionDeclaration:
          this.postTypeCheckFunctionDeclaration(
            <FunctionDeclaration>ast,
            context
          );
          return;
    ...
    private postTypeCheckNameExpression(
      nameAST: Identifier,
      context: PullTypeResolutionContext
    ) {
      this.checkThisCaptureVariableCollides(
    ...
    private typeCheckNameExpression(
      nameAST: Identifier,
      context: PullTypeResolutionContext
    ) {
    ...
    private resolveNameExpression(
      ...
      if (!foundCached || this.canTypeCheckAST(nameAST, context)) {
        ...
        nameSymbol = this.computeNameExpression(
          nameAST,
          context,
      ...
      if (
        ...
        (nameSymbol.type != this.semanticInfoChain.anyTypeSymbol ||
          nameSymbol.anyDeclHasFlag(
            PullElementFlags.IsAnnotatedWithAny | PullElementFlags.Exported
          )) /*&& !nameSymbol.inResolution*/
      ) {
    ...
    private computeNameExpression(
      ...
      if (isDeclarationASTOrDeclarationNameAST(nameAST)) {
        nameSymbol = this.semanticInfoChain
          .getDeclForAST(nameAST.parent)
          .getSymbol();
      }
      ...
      if (!nameSymbol) {
        var nameSymbol = this.getSymbolFromDeclPath(
          id,
          declPath,
          PullElementKind.SomeValue
        );
      ...
      if (
        !nameSymbol &&
        id === 'arguments' &&
        this.isSomeFunctionScope(declPath)
      ) {
      ...
      if (!nameSymbol) {
        nameSymbol = this.getSymbolFromDeclPath(
          id,
          declPath,
          PullElementKind.TypeAlias
        );
      ...
      if (
        ...
        var enclosingFunctionAST =
          this.semanticInfoChain.getASTForDecl(nameParentDecl);
        var currentParameterIndex = this.getCurrentParameterIndexForFunction(
          nameAST,
          enclosingFunctionAST
        );
        ...
        if (currentParameterIndex >= 0) {
          ...
          if (parameterList) {
            for (var i = 0; i <= currentParameterIndex; i++) {
              var candidateParameter = <Parameter>(
                parameterList.parameters.nonSeparatorAt(i)
              );
              if (
                candidateParameter &&
                candidateParameter.identifier.valueText() === id
              ) {
          ...
          if (!foundMatchingParameter) {
            ...
            context.postDiagnostic(
              this.semanticInfoChain.diagnosticFromAST(
                ...
                [
                  (<Parameter>(
                    parameterList.parameters.nonSeparatorAt(
      ...
      if (nameSymbol.isType() && nameSymbol.isAlias()) {
        ...
        var exportAssignmentSymbol = (<PullTypeAliasSymbol>(
          nameSymbol
        )).getExportAssignedValueSymbol();
    ...
    private getCurrentParameterIndexForFunction(
      parameter: AST,
      funcDecl: AST
    ): number {
    ...
    private resolveMemberAccessExpression(
      dottedNameAST: MemberAccessExpression,
      context: PullTypeResolutionContext
    ): PullSymbol {
      return this.resolveDottedNameExpression(
        dottedNameAST,
        dottedNameAST.expression,
        dottedNameAST.name,
        context
      );
    }
    ...
    private resolveDottedNameExpression(
      ...
      if (!foundCached || this.canTypeCheckAST(dottedNameAST, context)) {
        var canTypeCheckDottedNameAST = this.canTypeCheckAST(
          dottedNameAST,
          context
        );
    ...
    private computeDottedNameExpression(
      expression: AST,
      name: Identifier,
      context: PullTypeResolutionContext,
      checkSuperPrivateAndStaticAccess: boolean
    ): PullSymbol {
      ...
      if (!lhsType) {
        context.postDiagnostic(
          this.semanticInfoChain.diagnosticFromAST(
            name,
            DiagnosticCode.Could_not_find_enclosing_symbol_for_dotted_name_0,
            [name.text()]
          )
        );
        return this.getNewErrorTypeSymbol();
      ...
      // now for the name...
      var nameSymbol = this.getMemberSymbol(
        rhsName,
        PullElementKind.SomeValue,
        lhsType
      );
      ...
      if (!nameSymbol) {
        ...
        if (
          ...
          nameSymbol = this.getMemberSymbol(
            rhsName,
            PullElementKind.SomeValue,
            this.cachedFunctionInterfaceType()
          );
        ...
        if (!nameSymbol) {
          ...
          context.postDiagnostic(
            this.semanticInfoChain.diagnosticFromAST(
              name,
              DiagnosticCode.The_property_0_does_not_exist_on_value_of_type_1,
              [
                name.text(),
                lhsType.toString(
                  enclosingDecl ? enclosingDecl.getSymbol() : null
    ...
    private resolveTypeNameExpression(
      nameAST: Identifier,
      context: PullTypeResolutionContext
    ): PullTypeSymbol {
      var typeNameSymbol = <PullTypeSymbol>(
        this.getSymbolForAST(nameAST, context)
      );
      ...
      if (
        !typeNameSymbol ||
        !typeNameSymbol.isType() ||
        this.canTypeCheckAST(nameAST, context)
      ) {
        if (this.canTypeCheckAST(nameAST, context)) {
          this.setTypeChecked(nameAST, context);
        }
    ...
    private computeTypeNameExpression(
      nameAST: Identifier,
      context: PullTypeResolutionContext
    ): PullTypeSymbol {
      var id = nameAST.valueText();
      ...
      var kindToCheckFirst = onLeftOfDot
        ? PullElementKind.SomeContainer
        : PullElementKind.SomeType;
      var kindToCheckSecond = onLeftOfDot
        ? PullElementKind.SomeType
        : PullElementKind.SomeContainer;

      var typeNameSymbol = <PullTypeSymbol>(
        this.getSymbolFromDeclPath(id, declPath, kindToCheckFirst)
      );

      if (!typeNameSymbol) {
        typeNameSymbol = <PullTypeSymbol>(
          this.getSymbolFromDeclPath(id, declPath, kindToCheckSecond)
        );
      }
      ...
      if (typeNameSymbol.isTypeParameter()) {
        if (
          ...
          enclosingDecl.flags & PullElementFlags.Static
        ) {
          ...
          if (parentDecl.kind == PullElementKind.Class) {
            context.postDiagnostic(
              this.semanticInfoChain.diagnosticFromAST(
                nameAST,
                DiagnosticCode.Static_methods_cannot_reference_class_type_parameters
              )
            );
            return this.getNewErrorTypeSymbol();
          }
      ...
      if (
        !typeNameSymbol.isGeneric() &&
        (typeNameSymbol.isClass() || typeNameSymbol.isInterface())
      ) {
        typeNameSymbol =
          PullTypeReferenceSymbol.createTypeReference(typeNameSymbol);
      }
    ...
    private isLeftSideOfQualifiedName(ast: AST): boolean {
      return (
        ...
        (<QualifiedName>ast.parent).left === ast
      );
    }

    private resolveGenericTypeReference(
      genericTypeAST: GenericType,
      context: PullTypeResolutionContext
    ): PullTypeSymbol {
      var genericTypeSymbol = this.resolveAST(
        genericTypeAST.name,
        false,
        context
      ).type;
      ...
      if (genericTypeSymbol.isAlias()) {
        genericTypeSymbol = (<PullTypeAliasSymbol>(
          genericTypeSymbol
        )).getExportAssignedTypeSymbol();
      }
      ...
      if (
        genericTypeAST.typeArgumentList &&
        genericTypeAST.typeArgumentList.typeArguments.nonSeparatorCount()
      ) {
        for (
          var i = 0;
          i < genericTypeAST.typeArgumentList.typeArguments.nonSeparatorCount();
          i++
        ) {
          typeArgs[i] = this.resolveTypeReference(
            genericTypeAST.typeArgumentList.typeArguments.nonSeparatorAt(i),
            context
          );
        ...
        context.postDiagnostic(
          this.semanticInfoChain.diagnosticFromAST(
            ...
            [
              ...
              genericTypeSymbol.getTypeParameters().length.toString(),
            ]
          )
        );
        return this.getNewErrorTypeSymbol();
      ...
      var specializedSymbol = this.createInstantiatedType(
        genericTypeSymbol,
        typeArgs
      );
      ...
      var instantiatedSubstitutionMap =
        specializedSymbol.getTypeParameterArgumentMap();
      ...
      for (var i = 0; i < typeParameters.length; i++) {
        typeConstraintSubstitutionMap[typeParameters[i].pullSymbolID] =
          typeParameters[i];
      }
      ...
      for (
        var iArg = 0;
        iArg < typeArgs.length && iArg < typeParameters.length;
        iArg++
      ) {
        typeArg = typeArgs[iArg];
        typeConstraint = (<PullTypeParameterSymbol>(
          typeParameters[iArg]
        )).getConstraint();

        typeConstraintSubstitutionMap[typeParameters[iArg].pullSymbolID] =
          typeArg;
        ...
        if (typeConstraint) {
          if (typeConstraint.isTypeParameter()) {
            for (
              var j = 0;
              j < typeParameters.length && j < typeArgs.length;
              j++
            ) {
            ...
            typeConstraint = this.instantiateType(
              typeConstraint,
              typeConstraintSubstitutionMap
            );
          }
          ...
          if (
            typeArg.inResolution ||
            (typeArg.isTypeReference() &&
              (<PullTypeReferenceSymbol>typeArg).referencedTypeSymbol
                .inResolution)
          ) {
          ...
          if (
            ...
            context.postDiagnostic(
              this.semanticInfoChain.diagnosticFromAST(
                genericTypeAST,
                DiagnosticCode.Type_0_does_not_satisfy_the_constraint_1_for_type_parameter_2,
                [
                  typeArg.toString(
                    enclosingSymbol,
    ...
    private computeQualifiedName(
      ...
      var lhsType = lhs.isAlias()
        ? (<PullTypeAliasSymbol>lhs).getExportAssignedContainerSymbol()
        : lhs.type;

      if (
        this.inClassExtendsHeritageClause(dottedNameAST) &&
      ...
      var isNameOfModule =
        dottedNameAST.parent.kind() === SyntaxKind.ModuleDeclaration &&
        (<ModuleDeclaration>dottedNameAST.parent).name === dottedNameAST;
      var memberKind =
        onLeftOfDot || isNameOfModule
          ? PullElementKind.SomeContainer
          : PullElementKind.SomeType;

      var childTypeSymbol = <PullTypeSymbol>(
        this.getMemberSymbol(rhsName, memberKind, lhsType)
      );
      ...
      if (!childTypeSymbol && lhsType.isContainer()) {
        ...
        if (exportedContainer) {
          childTypeSymbol = <PullTypeSymbol>(
            this.getMemberSymbol(rhsName, memberKind, exportedContainer)
          );
        }
      }
      ...
      if (!childTypeSymbol && enclosingDecl) {
        ...
        if (parentDecl) {
          ...
          if (enclosingSymbolType === lhsType) {
            childTypeSymbol = <PullTypeSymbol>(
              this.getMemberSymbol(rhsName, memberKind, lhsType)
            ); //lhsType.findContainedMember(rhsName);
          }
        }
      }
    ...
    private shouldContextuallyTypeAnyFunctionExpression(
      ...
      if (
        typeParameters &&
        typeParameters.typeParameters.nonSeparatorCount() > 0
      ) {
        return false;
      }
      ...
      if (contextualFunctionTypeSymbol) {
        ...
        var exactlyOneCallSignature =
          callSignatures && callSignatures.length == 1;
        if (!exactlyOneCallSignature) {
          return false;
        }

        var callSignatureIsGeneric =
          callSignatures[0].typeParameters &&
          callSignatures[0].typeParameters.length > 0;
    ...
    private resolveAnyFunctionExpression(
      ...
      if (
        isContextuallyTyped &&
        this.shouldContextuallyTypeAnyFunctionExpression(
          funcDeclAST,
          typeParameters,
          parameters,
          returnTypeAnnotation,
        ...
        assigningFunctionSignature = context
          .getContextualType()
          .getCallSignatures()[0];
      }
      ...
      if (parameters) {
        ...
        for (var i = 0, n = parameters.length; i < n; i++) {
          ...
          var actualParameterIsVarArgParameter =
          ...
          if (i < contextualParametersCount) {
            ...
            contextualParametersCount &&
            contextParams[contextualParametersCount - 1].isVarArg
          ) {
            correspondingContextualParameter =
              contextParams[contextualParametersCount - 1];
          }

          // Find the contextual type from the paramter
          if (correspondingContextualParameter) {
            if (
              correspondingContextualParameter.isVarArg ===
              actualParameterIsVarArgParameter
            ) {
              ...
              contextualParameterType =
                correspondingContextualParameter.type.getElementType();
            }
          }
          ...
          this.resolveFunctionExpressionParameter(
            parameters.astAt(i),
            parameters.identifierAt(i),
            parameters.typeAt(i),
            parameters.initializerAt(i),
            contextualParameterType,
            functionDecl,
            context
          );
    ...
    private typeCheckSimpleArrowFunctionExpression(
      arrowFunction: SimpleArrowFunctionExpression,
      context: PullTypeResolutionContext
    ): void {
    ...
    private typeCheckParenthesizedArrowFunctionExpression(
      arrowFunction: ParenthesizedArrowFunctionExpression,
      context: PullTypeResolutionContext
    ): void {
      return this.typeCheckAnyFunctionExpression(
        arrowFunction,
        arrowFunction.callSignature.typeParameterList,
        getType(arrowFunction),
        arrowFunction.block,
        arrowFunction.expression,
        context
      );
    ...
    private typeCheckAnyFunctionExpression(
      ...
      if (block) {
        ...
        var bodyExpressionType = this.resolveReturnExpression(
          bodyExpression,
          functionDecl,
          context
        );
      ...
      if (block && returnTypeAnnotation != null && !hasReturn) {
        var isVoidOrAny =
          this.isAnyOrEquivalent(returnTypeSymbol) ||
          returnTypeSymbol === this.semanticInfoChain.voidTypeSymbol;
    ...
    private resolveThisExpression(
      ...
      var thisTypeSymbol =
        this.getContextualClassSymbolForEnclosingDecl(
          thisExpression,
          enclosingDecl
        ) || this.semanticInfoChain.anyTypeSymbol;
      ...
      while (ast) {
        switch (ast.kind()) {
          case SyntaxKind.ExtendsHeritageClause:
            ...
            return (
              heritageClause.parent.parent.kind() ===
      ...
      while (current) {
        switch (current.kind()) {
          case SyntaxKind.InvocationExpression:
            ...
            if (
              previous === invocationExpression.argumentList &&
    ...
    private isFunctionOrNonArrowFunctionExpression(decl: PullDecl): boolean {
      if (decl.kind === PullElementKind.Function) {
        ...
        decl.kind === PullElementKind.FunctionExpression &&
        !hasFlag(decl.flags, PullElementFlags.ArrowFunction)
      ) {
        return true;
      }
    ...
    private typeCheckThisExpression(
      thisExpression: ThisExpression,
      context: PullTypeResolutionContext,
      enclosingDecl: PullDecl
    ): void {
      ...
      if (this.inConstructorParameterList(thisExpression)) {
        ...
        context.postDiagnostic(
          this.semanticInfoChain.diagnosticFromAST(
            thisExpression,
            DiagnosticCode.this_cannot_be_referenced_in_constructor_arguments
          )
        );
        return;
      }
      ...
      for (
        var currentDecl = enclosingDecl;
        currentDecl !== null;
        currentDecl = currentDecl.getParentDecl()
      ) {
        if (this.isFunctionOrNonArrowFunctionExpression(currentDecl)) {
          // 'this' is always ok in a function.  It just has the 'any' type.
          return;
        } else if (
          currentDecl.kind === PullElementKind.Container ||
          currentDecl.kind === PullElementKind.DynamicModule
        ) {
          if (currentDecl.getParentDecl() === null) {
            ...
            context.postDiagnostic(
              this.semanticInfoChain.diagnosticFromAST(
                thisExpression,
                DiagnosticCode.this_cannot_be_referenced_within_module_bodies
              )
            );
            return;
          }
          ...
          if (
            this.inArgumentListOfSuperInvocation(thisExpression) &&
            this.superCallMustBeFirstStatementInConstructor(currentDecl)
          ) {
            context.postDiagnostic(
              this.semanticInfoChain.diagnosticFromAST(
                thisExpression,
                DiagnosticCode.this_cannot_be_referenced_in_current_location
              )
            );
          }
          ...
          if (this.inStaticMemberVariableDeclaration(thisExpression)) {
            context.postDiagnostic(
              this.semanticInfoChain.diagnosticFromAST(
                thisExpression,
                DiagnosticCode.this_cannot_be_referenced_in_static_initializers_in_a_class_body
              )
            );
          }
    ...
    private getContextualClassSymbolForEnclosingDecl(
      ast: AST,
      enclosingDecl: PullDecl
    ): PullTypeSymbol {
      var declPath = enclosingDecl.getParentPath();
    ...
    private inStaticMemberVariableDeclaration(ast: AST): boolean {
      while (ast) {
        if (
          ast.kind() === SyntaxKind.MemberVariableDeclaration &&
          hasModifier(
            (<MemberVariableDeclaration>ast).modifiers,
            PullElementFlags.Static
          )
        ) {
          return true;
        }
    ...
    private typeCheckSuperExpression(
      ast: AST,
      context: PullTypeResolutionContext,
      enclosingDecl: PullDecl
    ) {
      ...
      if (isSuperPropertyAccess) {
          ...
          if (this.isFunctionOrNonArrowFunctionExpression(currentDecl)) {
            ...
            if (!this.enclosingClassIsDerived(currentDecl)) {
              context.postDiagnostic(
                this.semanticInfoChain.diagnosticFromAST(
                  ast,
                  DiagnosticCode.super_cannot_be_referenced_in_non_derived_classes
                )
              );
              return;
              ...
              context.postDiagnostic(
                this.semanticInfoChain.diagnosticFromAST(
                  ast,
                  DiagnosticCode.super_cannot_be_referenced_in_constructor_arguments
                )
              );
              return;
        ...
        context.postDiagnostic(
          this.semanticInfoChain.diagnosticFromAST(
            ast,
            DiagnosticCode.super_property_access_is_permitted_only_in_a_constructor_member_function_or_member_accessor_of_a_derived_class
          )
        );
        return;
      } else {
        ...
        context.postDiagnostic(
          this.semanticInfoChain.diagnosticFromAST(
            ast,
            DiagnosticCode.Super_calls_are_not_permitted_outside_constructors_or_in_local_functions_inside_constructors
          )
        );
      }
    }

    private resolveSimplePropertyAssignment(
      propertyAssignment: SimplePropertyAssignment,
      isContextuallyTyped: boolean,
      context: PullTypeResolutionContext
    ): PullSymbol {
      return this.resolveAST(
        propertyAssignment.expression,
        isContextuallyTyped,
        context
      );
    }

    private resolveFunctionPropertyAssignment(
      funcProp: FunctionPropertyAssignment,
      isContextuallyTyped: boolean,
      context: PullTypeResolutionContext
    ): PullSymbol {
      return this.resolveAnyFunctionExpression(
        funcProp,
        funcProp.callSignature.typeParameterList,
    ...
    private typeCheckFunctionPropertyAssignment(
      funcProp: FunctionPropertyAssignment,
      isContextuallyTyped: boolean,
      context: PullTypeResolutionContext
    ) {
    ...
    public resolveObjectLiteralExpression(
    ...
    private bindObjectLiteralMembers(
      ...
      for (
        var i = 0, len = objectLiteralMembers.nonSeparatorCount();
        i < len;
        i++
      ) {
        ...
        var isAccessor =
          propertyAssignment.kind() === SyntaxKind.GetAccessor ||
          propertyAssignment.kind() === SyntaxKind.SetAccessor;
        ...
        if (propertyAssignment.kind() == SyntaxKind.SimplePropertyAssignment) {
          if (!isUsingExistingSymbol) {
            memberSymbol = new PullSymbol(
              assignmentText.memberName,
              PullElementKind.Property
            );
          ...
          propertyAssignment.kind() === SyntaxKind.FunctionPropertyAssignment
        ) {
          memberSymbol = decl.getSymbol();
        } else {
        ...
        if (!isUsingExistingSymbol && !isAccessor) {
          ...
          if (
            objectLiteralTypeSymbol.findMember(
              memberSymbol.name,
              /*lookInParent*/ true
            )
          ) {
            pullTypeContext.postDiagnostic(
              this.semanticInfoChain.diagnosticFromAST(
                propertyAssignment,
                DiagnosticCode.Duplicate_identifier_0,
                [assignmentText.actualText]
              )
            );
          }
    ...
    private resolveObjectLiteralMembers(
      ...
      for (
        ...
        if (objectLiteralContextualType) {
          assigningSymbol = this.getMemberSymbol(
            memberSymbol.name,
            PullElementKind.SomeValue,
          ...
          if (!assigningSymbol) {
            if (
              ...
              PullHelpers.isNameNumeric(memberSymbol.name)
            ) {
          ...
          if (assigningSymbol) {
            ...
            contextualMemberType =
              assigningSymbol.kind === PullElementKind.IndexSignature
                ? (<PullSignatureSymbol>assigningSymbol).returnType
                : assigningSymbol.type;
            pullTypeContext.pushContextualType(
              contextualMemberType,
              pullTypeContext.inProvisionalResolution(),
              null
            );
            ...
            if (additionalResults) {
              additionalResults.membersContextTypeSymbols[i] =
                contextualMemberType;
            }
          }
        }

        var propertySymbol = this.resolveAST(
          propertyAssignment,
          contextualMemberType != null,
          pullTypeContext
        );
        var memberExpr = this.widenType(
          propertySymbol.type,
          propertyAssignment,
          pullTypeContext
        );
    ...
    private computeObjectLiteralExpression(
      ...
      var typeSymbol = <PullTypeSymbol>(
        this.getSymbolForAST(objectLitAST, context)
      );
      ...
      if (contextualType) {
        var indexSignatures = this.getBothKindsOfIndexSignatures(
          contextualType,
          context
        );
      ...
      if (propertyAssignments) {
        ...
        if (!isUsingExistingSymbol) {
          this.stampObjectLiteralWithIndexSignature(
            typeSymbol,
            allMemberTypes,
            stringIndexerSignature,
            context
    ...
    private stampObjectLiteralWithIndexSignature(
      objectLiteralSymbol: PullTypeSymbol,
      indexerTypeCandidates: PullTypeSymbol[],
      contextualIndexSignature: PullSignatureSymbol,
      context: PullTypeResolutionContext
    ): void {
      if (contextualIndexSignature) {
        ...
        var indexerReturnType = this.widenType(
          this.findBestCommonType(typeCollection, context)
        );
        if (indexerReturnType == contextualIndexSignature.returnType) {
          ...
          this.semanticInfoChain.addSyntheticIndexSignature(
            decl,
            objectLiteralSymbol,
            this.getASTForDecl(decl),
            contextualIndexSignature.parameters[0].name,
            /*indexParamType*/ contextualIndexSignature.parameters[0].type,
            /*returnType*/ indexerReturnType
          );
        }
      }
    }

    private resolveArrayLiteralExpression(
      ...
      if (!symbol || this.canTypeCheckAST(arrayLit, context)) {
        ...
        symbol = this.computeArrayLiteralExpressionSymbol(
          arrayLit,
          isContextuallyTyped,
          context
        );
    ...
    private computeArrayLiteralExpressionSymbol(
      arrayLit: ArrayLiteralExpression,
      isContextuallyTyped: boolean,
      context: PullTypeResolutionContext
    ): PullSymbol {
      ...
      if (elements) {
        ...
        for (var i = 0, n = elements.nonSeparatorCount(); i < n; i++) {
          elementTypes.push(
            this.resolveAST(
              elements.nonSeparatorAt(i),
              contextualElementType !== null,
              context
            ).type
          );
        }
      ...
      elementType = elementType
        ? this.findBestCommonType(collection, context, comparisonInfo)
        : elementType;
    ...
    private resolveElementAccessExpression(
      callEx: ElementAccessExpression,
      context: PullTypeResolutionContext
    ): PullSymbol {
      var symbolAndDiagnostic =
        this.computeElementAccessExpressionSymbolAndDiagnostic(callEx, context);

      if (this.canTypeCheckAST(callEx, context)) {
        this.typeCheckElementAccessExpression(
          callEx,
          context,
          symbolAndDiagnostic
        );
    ...
    private typeCheckElementAccessExpression(
      callEx: ElementAccessExpression,
      context: PullTypeResolutionContext,
      symbolAndDiagnostic: { symbol: PullSymbol; diagnostic?: Diagnostic }
    ): void {
      this.setTypeChecked(callEx, context);
      context.postDiagnostic(symbolAndDiagnostic.diagnostic);
    }

    private computeElementAccessExpressionSymbolAndDiagnostic(
      callEx: ElementAccessExpression,
      context: PullTypeResolutionContext
    ): { symbol: PullSymbol; diagnostic?: Diagnostic } {
      // resolve the target
      var targetSymbol = this.resolveAST(
        callEx.expression,
        /*isContextuallyTyped:*/ false,
        context
      );
      var indexType = this.resolveAST(
        callEx.argumentExpression,
        /*isContextuallyTyped:*/ false,
        context
      ).type;
      ...
      var isNumberIndex =
        indexType === this.semanticInfoChain.numberTypeSymbol ||
        PullHelpers.symbolIsEnum(indexType);
      ...
      if (
        callEx.argumentExpression.kind() === SyntaxKind.StringLiteral ||
        callEx.argumentExpression.kind() === SyntaxKind.NumericLiteral
      ) {
        var memberName =
          callEx.argumentExpression.kind() === SyntaxKind.StringLiteral
            ? stripStartAndEndQuotes(
                (<StringLiteral>callEx.argumentExpression).text()
              )
            : (<NumericLiteral>callEx.argumentExpression).valueText();

        var member = this.getMemberSymbol(
          memberName,
          PullElementKind.SomeValue,
          targetTypeSymbol
        );
      ...
      if (
        targetTypeSymbol == this.semanticInfoChain.stringTypeSymbol &&
        this.cachedStringInterfaceType()
      ) {
        targetTypeSymbol = this.cachedStringInterfaceType();
      }

      var signatures = this.getBothKindsOfIndexSignatures(
        targetTypeSymbol,
        context
      );
      ...
      if (
        numberSignature &&
        (isNumberIndex || indexType === this.semanticInfoChain.anyTypeSymbol)
      ) {
        return {
          symbol:
            numberSignature.returnType || this.semanticInfoChain.anyTypeSymbol,
        };
      }
      ...
      // that index signature
        ...
        stringSignature &&
        (isNumberIndex ||
          indexType === this.semanticInfoChain.anyTypeSymbol ||
          indexType === this.semanticInfoChain.stringTypeSymbol)
      ) {
        return {
          symbol:
            stringSignature.returnType || this.semanticInfoChain.anyTypeSymbol,
        };
      }
      ...
      // otherwise, the property acess is invalid and a compile-time error occurs
        ...
        return {
          ...
          diagnostic: this.semanticInfoChain.diagnosticFromAST(
            callEx,
            DiagnosticCode.Value_of_type_0_is_not_indexable_by_type_1,
            [targetTypeSymbol.toString(), indexType.toString()]
          ),
        };
      }
    }

    private getBothKindsOfIndexSignatures(
      ...
      for (var i = 0; i < signatures.length; i++) {
        ...
        if (paramSymbols.length) {
          ...
          if (
            !stringSignature &&
            paramType === this.semanticInfoChain.stringTypeSymbol
          ) {
            stringSignature = signature;
            continue;
          } else if (
            !numberSignature &&
            paramType === this.semanticInfoChain.numberTypeSymbol
          ) {
    ...
    private resolveBinaryAdditionOperation(
      binaryExpression: BinaryExpression,
      context: PullTypeResolutionContext
    ): PullSymbol {
      var lhsExpression = this.resolveAST(
        binaryExpression.left,
        /*isContextuallyTyped*/ false,
        context
      );
      ...
      if (
        lhsType === this.semanticInfoChain.stringTypeSymbol ||
        rhsType === this.semanticInfoChain.stringTypeSymbol
      ) {
      ...
      if (this.canTypeCheckAST(binaryExpression, context)) {
        ...
        if (exprType) {
          ...
          context.postDiagnostic(
            this.semanticInfoChain.diagnosticFromAST(
              binaryExpression.left,
              DiagnosticCode.Invalid_expression_types_not_known_to_support_the_addition_operator
            )
          );
        }
      }
    ...
    private bestCommonTypeOfTwoTypes(
    ...
    private bestCommonTypeOfThreeTypes(
      type1: PullTypeSymbol,
      type2: PullTypeSymbol,
      type3: PullTypeSymbol,
      context: PullTypeResolutionContext
    ): PullTypeSymbol {
      return this.findBestCommonType(
        {
    ...
    private resolveLogicalOrExpression(
      binex: BinaryExpression,
      isContextuallyTyped: boolean,
      context: PullTypeResolutionContext
    ): PullSymbol {
      ...
      if (isContextuallyTyped) {
        ...
        return this.bestCommonTypeOfThreeTypes(
          contextualType,
          leftType,
          rightType,
          context
    ...
    private resolveLogicalAndExpression(
      binex: BinaryExpression,
      context: PullTypeResolutionContext
    ): PullSymbol {
      if (this.canTypeCheckAST(binex, context)) {
    ...
    private computeTypeOfConditionalExpression(
      leftType: PullTypeSymbol,
      rightType: PullTypeSymbol,
      isContextuallyTyped: boolean,
      context: PullTypeResolutionContext
    ): PullTypeSymbol {
      if (isContextuallyTyped) {
    ...
    private resolveConditionalExpression(
      ...
      var expressionType = this.computeTypeOfConditionalExpression(
        leftType,
        rightType,
        isContextuallyTyped,
        context
      );
      var conditionalTypesAreValid = this.conditionExpressionTypesAreValid(
        leftType,
        rightType,
        expressionType,
        isContextuallyTyped,
      ...
      if (this.canTypeCheckAST(trinex, context)) {
        ...
        if (
          !this.conditionExpressionTypesAreValid(
            leftType,
            rightType,
            expressionType,
            isContextuallyTyped,
    ...
    private conditionExpressionTypesAreValid(
      leftType: PullTypeSymbol,
      rightType: PullTypeSymbol,
      expressionType: PullTypeSymbol,
      isContextuallyTyped: boolean,
      ...
      if (isContextuallyTyped) {
        var contextualType = context.getContextualType();
        if (
          this.typesAreIdentical(expressionType, leftType) ||
    ...
    private resolveParenthesizedExpression(
    ...
    public resolveInvocationExpression(
      ...
      if (!symbol || !symbol.isResolved) {
        ...
        symbol = this.computeInvocationExpressionSymbol(
          callEx,
          context,
          additionalResults
        );
        ...
        this.semanticInfoChain.setCallResolutionDataForAST(
          callEx,
          additionalResults
        );
      } else {
        ...
        var callResolutionData =
          this.semanticInfoChain.getCallResolutionDataForAST(callEx);
        if (additionalResults && callResolutionData != additionalResults) {
          ...
          additionalResults.candidateSignature =
            callResolutionData.candidateSignature;
          additionalResults.resolvedSignatures =
            callResolutionData.resolvedSignatures;
    ...
    private typeCheckInvocationExpression(
      callEx: InvocationExpression,
      context: PullTypeResolutionContext
    ) {
      this.setTypeChecked(callEx, context);
      ...
      if (callEx.argumentList.args) {
        ...
        for (var i = 0; i < len; i++) {
          ...
          var contextualType =
            callResolutionData.actualParametersContextTypeSymbols
              ? callResolutionData.actualParametersContextTypeSymbols[i]
              : null;
          if (contextualType) {
            context.pushContextualType(
              contextualType,
          ...
          this.resolveAST(
            callEx.argumentList.args.nonSeparatorAt(i),
            contextualType != null,
            context
          );
      ...
      for (
        var i = 0;
        i < callResolutionData.diagnosticsFromOverloadResolution.length;
        i++
      ) {
        context.postDiagnostic(
          callResolutionData.diagnosticsFromOverloadResolution[i]
        );
      }
    }

    private computeInvocationExpressionSymbol(
      callEx: InvocationExpression,
      context: PullTypeResolutionContext,
      additionalResults: PullAdditionalCallResolutionData
    ): PullSymbol {
      ...
      if (
        targetTypeSymbol &&
        targetTypeSymbol.kind === PullElementKind.Interface &&
        targetTypeSymbol.name === 'Just'
      ) {
        targetTypeSymbol =
          targetTypeSymbol.getTypeArgumentsOrTypeParameters()[0];
      }
      if (this.isAnyOrEquivalent(targetTypeSymbol)) {
        ...
        this.resolveAST(
          callEx.argumentList.args,
          /*isContextuallyTyped:*/ false,
          context
        );

        if (
          callEx.argumentList.typeArgumentList &&
          callEx.argumentList.typeArgumentList.typeArguments.nonSeparatorCount()
        ) {
          ...
          if (targetTypeSymbol === this.semanticInfoChain.anyTypeSymbol) {
            this.postOverloadResolutionDiagnostics(
              this.semanticInfoChain.diagnosticFromAST(
                targetAST,
                DiagnosticCode.Untyped_function_calls_may_not_accept_type_arguments
              ),
              additionalResults,
              context
            );
      ...
      if (callEx.expression.kind() === SyntaxKind.SuperKeyword) {
        ...
        if (targetTypeSymbol.isClass()) {
          ...
          this.postOverloadResolutionDiagnostics(
            this.semanticInfoChain.diagnosticFromAST(
              targetAST,
              DiagnosticCode.Calls_to_super_are_only_valid_inside_a_class
            ),
            additionalResults,
            context
          );
      ...
      var signatures = isSuperCall
        ? targetTypeSymbol.getConstructSignatures()
        : targetTypeSymbol.getCallSignatures();

      if (
        !signatures.length &&
        targetTypeSymbol.kind == PullElementKind.ConstructorType
      ) {
        this.postOverloadResolutionDiagnostics(
          this.semanticInfoChain.diagnosticFromAST(
            targetAST,
            DiagnosticCode.Value_of_type_0_is_not_callable_Did_you_mean_to_include_new,
            [targetTypeSymbol.toString()]
          ),
          additionalResults,
          context
        );
      ...
      if (callEx.argumentList.typeArgumentList) {
        ...
        if (
          ...
          for (
            ...
            typeArgs[i] = this.resolveTypeReference(
              callEx.argumentList.typeArgumentList.typeArguments.nonSeparatorAt(
                i
              ),
              context
            );
      ...
      var resolvedSigMap: {
        sig: any;
        index: number;
        inferredTypeArgs: PullTypeSymbol[];
      }[] = [];
      ...
      var targetTypeReplacementMap =
        targetTypeSymbol.getTypeParameterArgumentMap();
      for (var i = 0; i < signatures.length; i++) {
        ...
        if (signatures[i].isGeneric() && typeParameters.length) {
          if (typeArgs) {
            ...
            if (typeArgs.length == typeParameters.length) {
              ...
              typeArgumentCountDiagnostic =
                typeArgumentCountDiagnostic ||
                this.semanticInfoChain.diagnosticFromAST(
                  targetAST,
                  DiagnosticCode.Signature_expected_0_type_arguments_got_1_instead,
            ...
            !typeArgs &&
            callEx.argumentList.args &&
            callEx.argumentList.args.nonSeparatorCount()
          ) {
            inferredTypeArgs = this.inferArgumentTypesForSignature(
              signatures[i],
              new ArgumentInferenceContext(this, callEx.argumentList.args),
              new TypeComparisonInfo(),
              context
            );
          ...
          if (inferredTypeArgs) {
            ...
            if (inferredTypeArgs.length) {
              ...
              if (targetTypeReplacementMap) {
                for (
                  var _ix = 0;
                  _ix < targetTypeReplacementMap.length;
                  _ix++
                ) {
              ...
              for (var j = 0; j < typeParameters.length; j++) {
                typeReplacementMap[typeParameters[j].pullSymbolID] =
                  inferredTypeArgs[j];
              }
              for (var j = 0; j < typeParameters.length; j++) {
                typeConstraint = (<PullTypeParameterSymbol>(
                ...
                if (typeConstraint) {
                  if (typeConstraint.isTypeParameter()) {
                    for (
                      var k = 0;
                      k < typeParameters.length && k < inferredTypeArgs.length;
                      k++
                    ) {
                  ...
                  if (
                    !this.sourceIsAssignableToTarget(
                      ...
                      context,
                      /*comparisonInfo:*/ null,
                      /*isComparingInstantiatedSignatures:*/ true
                    )
                  ) {
                    var enclosingSymbol =
                      this.getEnclosingSymbolForAST(targetAST);
                    constraintDiagnostic =
                      this.semanticInfoChain.diagnosticFromAST(
                        targetAST,
                        DiagnosticCode.Type_0_does_not_satisfy_the_constraint_1_for_type_parameter_2,
                        [
                          inferredTypeArgs[j].toString(
                            enclosingSymbol,
                            /*useConstraintInName*/ true
                          ),
                          typeConstraint.toString(
            ...
            specializedSignature = this.instantiateSignature(
              signatures[i],
              typeReplacementMap,
              true
            );
            ...
            if (specializedSignature) {
              resolvedSignatures[resolvedSignatures.length] =
                specializedSignature;
              resolvedSigMap.push({
                sig: <any>specializedSignature,
                index: i,
                inferredTypeArgs: inferredTypeArgs,
              }); //AR: any would shallowTag
            }
          }
        } else {
          if (
            ...
            resolvedSigMap.push({
              sig: <any>signatures[i],
              index: i,
              inferredTypeArgs: signatures[i].isGeneric()
                ? inferredTypeArgs
                : [],
            }); //AR: shallowTag
          }
      ...
      if (!signatures.length) {
        ...
        additionalResults.candidateSignature =
          beforeResolutionSignatures && beforeResolutionSignatures.length
            ? beforeResolutionSignatures[0]
            : null;

        additionalResults.actualParametersContextTypeSymbols =
          actualParametersContextTypeSymbols; //NS:Fishy
        ...
        if (!couldNotFindGenericOverload) {
          ...
          this.postOverloadResolutionDiagnostics(
            this.semanticInfoChain.diagnosticFromAST(
              callEx,
              DiagnosticCode.Cannot_invoke_an_expression_whose_type_lacks_a_call_signature
            ),
            additionalResults,
            context
          );
          ...
          this.postOverloadResolutionDiagnostics(
            this.semanticInfoChain.diagnosticFromAST(
              callEx,
              DiagnosticCode.Could_not_select_overload_for_call_expression
            ),
            additionalResults,
            context
          );
      ...
      var signature = this.resolveOverloads(
        callEx,
        signatures,
        callEx.argumentList.typeArgumentList != null,
        context,
        diagnostics
      );
      ...
      if (!signature.isGeneric() && callEx.argumentList.typeArgumentList) {
        ...
        callEx.argumentList.typeArgumentList.typeArguments.nonSeparatorCount() !=
          signature.getTypeParameters().length
      ) {
        this.postOverloadResolutionDiagnostics(
          this.semanticInfoChain.diagnosticFromAST(
            targetAST,
            DiagnosticCode.Signature_expected_0_type_arguments_got_1_instead,
            [
              signature.getTypeParameters().length.toString(),
              callEx.argumentList.typeArgumentList.typeArguments
                .nonSeparatorCount()
                .toString(),
            ]
          ),
      ...
      if (callEx.argumentList.args) {
        ...
        for (var i = 0; i < len; i++) {
          ...
          if (params.length) {
            if (
              i < params.length - 1 ||
              (i < params.length && !signature.hasVarArgs)
            ) {
    ...
    public resolveObjectCreationExpression(
    ...
    private typeCheckObjectCreationExpression(
      callEx: ObjectCreationExpression,
      context: PullTypeResolutionContext
    ) {
      this.setTypeChecked(callEx, context);
    ...
    private postOverloadResolutionDiagnostics(
    ...
    private computeObjectCreationExpressionSymbol(
      callEx: ObjectCreationExpression,
      context: PullTypeResolutionContext,
      additionalResults: PullAdditionalCallResolutionData
    ): PullSymbol {
      ...
      var targetTypeSymbol = targetSymbol.isType()
        ? <PullTypeSymbol>targetSymbol
        : targetSymbol.type;
      ...
      if (constructSignatures.length) {
            ...
            if (constructSignatures[i].isGeneric()) {
                ...
                if (typeArgs.length == typeParameters.length) {
                  ...
                  typeArgumentCountDiagnostic =
                    ...
                    this.semanticInfoChain.diagnosticFromAST(
                      ...
                      DiagnosticCode.Signature_expected_0_type_arguments_got_1_instead,
                      [
                        typeParameters.length.toString(),
                  ...
                  if (targetTypeReplacementMap) {
                    for (var symbolID in targetTypeReplacementMap) {
                      if (targetTypeReplacementMap.hasOwnProperty(symbolID)) {
                        typeReplacementMap[+symbolID] =
                          targetTypeReplacementMap[+symbolID];
                      }
                    }
                  }
                  ...
                  for (var j = 0; j < typeParameters.length; j++) {
                    ...
                    if (typeConstraint) {
                      if (typeConstraint.isTypeParameter()) {
                        for (
                          var k = 0;
                          k < typeParameters.length &&
                          k < inferredTypeArgs.length;
                          k++
                        ) {
                          if (typeParameters[k] == typeConstraint) {
                            typeConstraint = inferredTypeArgs[k];
              ...
              if (
                ...
                resolvedSignatures[resolvedSignatures.length] =
                  constructSignatures[i];
                resolvedSigMap.push({
                  sig: <any>constructSignatures[i],
                  index: i,
                  inferredTypeArgs: <PullTypeSymbol[]>null,
                }); //AR: shallowTag
              }
            }
          }
        ...
        var signature = this.resolveOverloads(
          callEx,
          constructSignatures,
          callEx.argumentList && callEx.argumentList.typeArgumentList != null,
          context,
          diagnostics
        );
        ...
        if (!signature) {
          ...
          this.postOverloadResolutionDiagnostics(
            this.semanticInfoChain.diagnosticFromAST(
              targetAST,
              DiagnosticCode.Could_not_select_overload_for_new_expression
            ),
            additionalResults,
            context
          );
        ...
        if (usedCallSignaturesInstead) {
          if (returnType != this.semanticInfoChain.voidTypeSymbol) {
            this.postOverloadResolutionDiagnostics(
              this.semanticInfoChain.diagnosticFromAST(
                targetAST,
                DiagnosticCode.Call_signatures_used_in_a_new_expression_must_have_a_void_return_type
              ),
              additionalResults,
              context
            );
      ...
      this.postOverloadResolutionDiagnostics(
        this.semanticInfoChain.diagnosticFromAST(
          targetAST,
          DiagnosticCode.Invalid_new_expression
        ),
        additionalResults,
        context
      );
    ...
    private instantiateSignatureInContext(
      signatureA: PullSignatureSymbol,
      signatureB: PullSignatureSymbol,
      context: PullTypeResolutionContext
    ): PullSignatureSymbol {
      ...
      for (var i = 0; i < signatureB.parameters.length; i++) {
        fixedParameterTypes.push(
          signatureB.parameters[i].isVarArg
            ? signatureB.parameters[i].type.getElementType()
            : signatureB.parameters[i].type
        );
      }

      inferredTypeArgs = this.inferArgumentTypesForSignature(
        signatureA,
        new ArgumentInferenceContext(this, fixedParameterTypes),
        new TypeComparisonInfo(),
        context
      );
      ...
      for (var i = 0; i < typeParameters.length; i++) {
        typeReplacementMap[typeParameters[i].pullSymbolID] =
          inferredTypeArgs[i];
      }
      for (var i = 0; i < typeParameters.length; i++) {
        typeConstraint = (<PullTypeParameterSymbol>(
        ...
        if (typeConstraint) {
          if (typeConstraint.isTypeParameter()) {
            for (
              var j = 0;
              j < typeParameters.length && j < inferredTypeArgs.length;
              j++
            ) {
              if (typeParameters[j] == typeConstraint) {
            ...
            typeConstraint = PullInstantiatedTypeReferenceSymbol.create(
              this,
              typeConstraint,
              typeReplacementMap
            );
    ...
    private resolveCastExpression(
      assertionExpression: CastExpression,
      context: PullTypeResolutionContext
    ): PullTypeSymbol {
      var typeAssertionType = this.resolveTypeReference(
        assertionExpression.type,
        context
      ).type;

      if (this.canTypeCheckAST(assertionExpression, context)) {
        this.typeCheckCastExpression(
          assertionExpression,
          context,
          typeAssertionType
        );
    ...
    private typeCheckCastExpression(
      assertionExpression: CastExpression,
      context: PullTypeResolutionContext,
      typeAssertionType: PullTypeSymbol
    ): void {
      ...
      if (!isAssignable) {
        var enclosingSymbol =
          this.getEnclosingSymbolForAST(assertionExpression);
        if (comparisonInfo.message) {
          context.postDiagnostic(
            this.semanticInfoChain.diagnosticFromAST(
              assertionExpression,
              DiagnosticCode.Cannot_convert_0_to_1_NL_2,
              [
                exprType.toString(enclosingSymbol),
                typeAssertionType.toString(enclosingSymbol),
                comparisonInfo.message,
              ]
            )
          );
    ...
    private resolveAssignmentExpression(
      ...
      rightType = this.getInstanceTypeForAssignment(
        binaryExpression.left,
        rightType,
        context
      );
    ...
    private getInstanceTypeForAssignment(
      lhs: AST,
      type: PullTypeSymbol,
      context: PullTypeResolutionContext
    ): PullTypeSymbol {
      ...
      if (typeToReturn && typeToReturn.isAlias()) {
        typeToReturn = (<PullTypeAliasSymbol>(
          typeToReturn
        )).getExportAssignedTypeSymbol();
      }
    ...
    public widenType(
      ...
      if (type.isArrayNamedTypeReference()) {
        ...
        if (
          this.compilationSettings.noImplicitAny() &&
          ast &&
          ast.kind() === SyntaxKind.ArrayLiteralExpression
        ) {
          // If we widened from non-'any' type to 'any', then report error.
          if (
            elementType === this.semanticInfoChain.anyTypeSymbol &&
            type.getElementType() !== this.semanticInfoChain.anyTypeSymbol
          ) {
            context.postDiagnostic(
              this.semanticInfoChain.diagnosticFromAST(
                ast,
                DiagnosticCode.Array_Literal_implicitly_has_an_any_type_from_widening
              )
            );
          }
        }
    ...
    public findBestCommonType(
      ...
      for (var i = 0; i < len; i++) {
        ...
        if (
          this.typeIsBestCommonTypeCandidate(candidateType, collection, context)
        ) {
    ...
    private typeIsBestCommonTypeCandidate(
      candidateType: PullTypeSymbol,
      collection: IPullTypeCollection,
      context: PullTypeResolutionContext
    ): boolean {
      for (var i = 0; i < collection.getLength(); i++) {
        ...
        if (candidateType.isTypeParameter() && !otherType.isTypeParameter()) {
          ...
          !candidateType.isTypeParameter() &&
          otherType.isTypeParameter()
        ) {
          continue;
        } else if (
          !this.sourceIsSubtypeOfTarget(
    ...
    private typesAreIdenticalInEnclosingTypes(
      t1: PullTypeSymbol,
      t2: PullTypeSymbol,
      t1EnclosingType: PullTypeSymbol,
      t2EnclosingType: PullTypeSymbol,
      val?: AST
    ) {
      ...
      if (t1 && t2) {
        ...
        var t1GenerativeTypeKind = t1EnclosingType
          ? t1.getGenerativeTypeClassification(t1EnclosingType)
          : GenerativeTypeClassification.Unknown;
        var t2GenerativeTypeKind = t2EnclosingType
          ? t2.getGenerativeTypeClassification(t2EnclosingType)
          : GenerativeTypeClassification.Unknown;
        if (
          t1GenerativeTypeKind ==
            GenerativeTypeClassification.InfinitelyExpanding ||
          t2GenerativeTypeKind ==
            GenerativeTypeClassification.InfinitelyExpanding
        ) {
    ...
    public typesAreIdentical(
      ...
      if (
        val &&
        t1.isPrimitive() &&
        (<PullPrimitiveTypeSymbol>t1).isStringConstant() &&
        t2 === this.semanticInfoChain.stringTypeSymbol
      ) {
        return (
          val.kind() === SyntaxKind.StringLiteral &&
          stripStartAndEndQuotes((<StringLiteral>val).text()) ===
            stripStartAndEndQuotes(t1.name)
        );
      }
      ...
      if (
        val &&
        t2.isPrimitive() &&
        (<PullPrimitiveTypeSymbol>t2).isStringConstant() &&
        t2 === this.semanticInfoChain.stringTypeSymbol
      ) {
        return (
          val.kind() === SyntaxKind.StringLiteral &&
          stripStartAndEndQuotes((<StringLiteral>val).text()) ===
            stripStartAndEndQuotes(t2.name)
        );
      }
      ...
      var isIdentical = this.identicalCache.valueAt(
        t1.pullSymbolID,
        t2.pullSymbolID
      );
      ...
      if (t1.kind & PullElementKind.Enum || t2.kind & PullElementKind.Enum) {
        return (
          t1.getAssociatedContainerType() === t2 ||
          t2.getAssociatedContainerType() === t1
        );
      }
      ...
      if (t1.hasMembers() && t2.hasMembers()) {
        var t1Members = t1.getAllMembers(
          PullElementKind.SomeValue,
          GetAllMembersVisiblity.all
        );
        var t2Members = t2.getAllMembers(
          PullElementKind.SomeValue,
          GetAllMembersVisiblity.all
        );
        ...
        for (var iMember = 0; iMember < t1Members.length; iMember++) {
          ...
          t2MemberSymbol = this.getMemberSymbol(
            t1MemberSymbol.name,
            PullElementKind.SomeValue,
            t2
          );
          ...
          if (
            !t2MemberSymbol ||
            t1MemberSymbol.isOptional != t2MemberSymbol.isOptional
          ) {
            this.identicalCache.setValueAt(
              t1.pullSymbolID,
              t2.pullSymbolID,
          ...
          if (
            !this.typesAreIdenticalInEnclosingTypes(
              t1MemberType,
              t2MemberType,
              t1,
              t2
    ...
    private signatureGroupsAreIdentical(
      sg1: PullSignatureSymbol[],
      sg2: PullSignatureSymbol[]
    ) {
    ...
    public signaturesAreIdentical(
      ...
      if (
        !!(s1.typeParameters && s1.typeParameters.length) !=
        !!(s2.typeParameters && s2.typeParameters.length)
      ) {
        return false;
      }
      ...
      if (
        s1.typeParameters &&
        s2.typeParameters &&
        s1.typeParameters.length != s2.typeParameters.length
      ) {
        return false;
      }
      ...
      for (var iParam = 0; iParam < s1Params.length; iParam++) {
        if (
          !this.typesAreIdenticalInEnclosingTypes(
            s1Params[iParam].type,
            s2Params[iParam].type,
            s1.functionType,
            s2.functionType
          )
        ) {
    ...
    private sourceExtendsTarget(
      ...
      if (source.isTypeReference() && target.isTypeReference()) {
        if (
          (<PullTypeReferenceSymbol>source).referencedTypeSymbol.hasBase(
            (<PullTypeReferenceSymbol>target).referencedTypeSymbol
          )
        ) {
          var sourceTypeArguments = (<PullTypeReferenceSymbol>(
            source
          )).getTypeArguments();
          var targetTypeArguments = (<PullTypeReferenceSymbol>(
            target
          )).getTypeArguments();
      ...
      if (
        ...
        for (var i = 0; i < sourceDecls.length; i++) {
          var sourceAST = <ClassDeclaration>(
            this.semanticInfoChain.getASTForDecl(sourceDecls[i])
          );
          var extendsClause = getExtendsHeritageClause(
            sourceAST.heritageClauses
          );

          if (extendsClause) {
            for (
              var j = 0;
              j < extendsClause.typeNames.nonSeparatorCount();
              j++
            ) {
              extendsSymbol = <PullTypeSymbol>(
                this.semanticInfoChain.getSymbolForAST(
                  extendsClause.typeNames.nonSeparatorAt(j)
                )
              );

              if (
                extendsSymbol &&
                (extendsSymbol == target ||
                  this.sourceExtendsTarget(extendsSymbol, target, context))
              ) {
                return true;
              }
            }
    ...
    private sourceIsSubtypeOfTarget(
      source: PullTypeSymbol,
      target: PullTypeSymbol,
      ast: AST,
      context: PullTypeResolutionContext,
    ...
    private sourceMembersAreSubtypeOfTargetMembers(
      source: PullTypeSymbol,
      target: PullTypeSymbol,
      ast: AST,
      context: PullTypeResolutionContext,
      ...
      return this.sourceMembersAreRelatableToTargetMembers(
        source,
        target,
        false,
        this.subtypeCache,
    ...
    private sourcePropertyIsSubtypeOfTargetProperty(
      source: PullTypeSymbol,
      target: PullTypeSymbol,
      ...
      return this.sourcePropertyIsRelatableToTargetProperty(
        source,
        target,
        sourceProp,
        targetProp,
    ...
    private sourceCallSignaturesAreSubtypeOfTargetCallSignatures(
      source: PullTypeSymbol,
      target: PullTypeSymbol,
      ast: AST,
      context: PullTypeResolutionContext,
      ...
      return this.sourceCallSignaturesAreRelatableToTargetCallSignatures(
        source,
        target,
        false,
        this.subtypeCache,
    ...
    private sourceConstructSignaturesAreSubtypeOfTargetConstructSignatures(
      source: PullTypeSymbol,
      target: PullTypeSymbol,
      ast: AST,
      context: PullTypeResolutionContext,
      ...
      return this.sourceConstructSignaturesAreRelatableToTargetConstructSignatures(
        source,
        target,
        false,
        this.subtypeCache,
    ...
    private sourceIndexSignaturesAreSubtypeOfTargetIndexSignatures(
      source: PullTypeSymbol,
      target: PullTypeSymbol,
      ast: AST,
      context: PullTypeResolutionContext,
      ...
      return this.sourceIndexSignaturesAreRelatableToTargetIndexSignatures(
        source,
        target,
        false,
        this.subtypeCache,
    ...
    private typeIsSubtypeOfFunction(
      source: PullTypeSymbol,
      ast: AST,
      context: PullTypeResolutionContext
    ): boolean {
    ...
    private signatureIsSubtypeOfTarget(
      s1: PullSignatureSymbol,
      s2: PullSignatureSymbol,
      ast: AST,
      context: PullTypeResolutionContext,
      ...
      return this.signatureIsRelatableToTarget(
        s1,
        s2,
        false,
        this.subtypeCache,
    ...
    private signatureIsAssignableToTarget(
      s1: PullSignatureSymbol,
      s2: PullSignatureSymbol,
      ast: AST,
      context: PullTypeResolutionContext,
    ...
    private sourceIsRelatableToTargetInEnclosingTypes(
      source: PullTypeSymbol,
      target: PullTypeSymbol,
      sourceEnclosingType: PullTypeSymbol,
      targetEnclosingType: PullTypeSymbol,
      ...
      if (source && target) {
        ...
        var sourceGenerativeTypeKind = sourceEnclosingType
          ? source.getGenerativeTypeClassification(sourceEnclosingType)
          : GenerativeTypeClassification.Unknown;
        var targetGenerativeTypeKind = targetEnclosingType
          ? target.getGenerativeTypeClassification(targetEnclosingType)
          : GenerativeTypeClassification.Unknown;
        if (
          sourceGenerativeTypeKind ==
            GenerativeTypeClassification.InfinitelyExpanding ||
          targetGenerativeTypeKind ==
            GenerativeTypeClassification.InfinitelyExpanding
        ) {
          return this.infinitelyExpandingSourceTypeIsRelatableToTargetType(
            source,
            target,
            assignableTo,
            comparisonCache,
    ...
    private sourceIsRelatableToTarget(
      source: PullTypeSymbol,
      target: PullTypeSymbol,
      assignableTo: boolean,
      comparisonCache: IBitMatrix,
      ...
      if (
        comparisonCache.valueAt(source.pullSymbolID, target.pullSymbolID) !=
        undefined
      ) {
        return true;
      }
      ...
      if (
        source === this.semanticInfoChain.stringTypeSymbol &&
        target.isPrimitive() &&
        (<PullPrimitiveTypeSymbol>target).isStringConstant()
      ) {
        return (
          comparisonInfo &&
          comparisonInfo.stringConstantVal &&
          comparisonInfo.stringConstantVal.kind() ===
            SyntaxKind.StringLiteral &&
          stripStartAndEndQuotes(
            (<StringLiteral>comparisonInfo.stringConstantVal).text()
      ...
      if (assignableTo) {
        ...
        if (
          target === this.semanticInfoChain.stringTypeSymbol &&
          source.isPrimitive() &&
          (<PullPrimitiveTypeSymbol>source).isStringConstant()
        ) {
          return true;
        }
      }
      ...
      if (
        source === this.semanticInfoChain.nullTypeSymbol &&
        target != this.semanticInfoChain.undefinedTypeSymbol &&
        target != this.semanticInfoChain.voidTypeSymbol
      ) {
        return true;
      }
      ...
      if (target == this.semanticInfoChain.voidTypeSymbol) {
        if (
          source == this.semanticInfoChain.undefinedTypeSymbol ||
          source == this.semanticInfoChain.nullTypeSymbol
        ) {
          return true;
        }
      ...
      if (
        target === this.semanticInfoChain.numberTypeSymbol &&
        PullHelpers.symbolIsEnum(source)
      ) {
        return true;
      }
      ...
      if (
        source === this.semanticInfoChain.numberTypeSymbol &&
        PullHelpers.symbolIsEnum(target)
      ) {
        return assignableTo;
      }
      ...
      if (
        source.kind & PullElementKind.Enum ||
        target.kind & PullElementKind.Enum
      ) {
        return false;
      }
      ...
      if (source.getIsSpecialized() && target.getIsSpecialized()) {
        if (
          PullHelpers.getRootType(source) == PullHelpers.getRootType(target)
        ) {
          ...
          if (sourceTypeArguments && targetTypeArguments) {
            ...
            for (var i = 0; i < sourceTypeArguments.length; i++) {
              if (
                !this.sourceIsRelatableToTarget(
                  sourceTypeArguments[i],
                  targetTypeArguments[i],
                  assignableTo,
                  comparisonCache,
      ...
      if (
        source.kind & PullElementKind.SomeInstantiatableType &&
        target.kind & PullElementKind.SomeInstantiatableType &&
        this.sourceExtendsTarget(source, target, context)
      ) {
        return true;
      }
      ...
      if (
        this.cachedFunctionInterfaceType() &&
        (sourceSubstitution.getCallSignatures().length ||
          sourceSubstitution.getConstructSignatures().length) &&
    ...
    private sourceMembersAreRelatableToTargetMembers(
      ...
      var targetProps = target.getAllMembers(
        PullElementKind.SomeValue,
        GetAllMembersVisiblity.all
      );
      ...
      for (
        var itargetProp = 0;
        itargetProp < targetProps.length;
        itargetProp++
      ) {
        var targetProp = targetProps[itargetProp];
        var sourceProp = this.getMemberSymbol(
          targetProp.name,
          PullElementKind.SomeValue,
          source
        );
        ...
        if (
          sourceProp &&
          sourceProp.anyDeclHasFlag(PullElementFlags.Static) &&
          source.isClass()
        ) {
        ...
        if (!sourceProp) {
          ...
          if (this.cachedObjectInterfaceType()) {
            sourceProp = this.getMemberSymbol(
              targetProp.name,
              PullElementKind.SomeValue,
              this.cachedObjectInterfaceType()
            );
          ...
          if (!sourceProp) {
            ...
            if (
              this.cachedFunctionInterfaceType() &&
              (targetPropType.getCallSignatures().length ||
                targetPropType.getConstructSignatures().length)
            ) {
              sourceProp = this.getMemberSymbol(
                targetProp.name,
                PullElementKind.SomeValue,
            ...
            if (!sourceProp) {
              if (!targetProp.isOptional) {
                if (comparisonInfo) {
                  ...
                  comparisonInfo.flags |=
                    TypeRelationshipFlags.RequiredPropertyIsMissing;
                  comparisonInfo.addMessage(
                    getDiagnosticMessage(
                      DiagnosticCode.Type_0_is_missing_property_1_from_type_2,
                      [
                        source.toString(enclosingSymbol),
                        targetProp.getScopedNameEx().toString(),
                        target.toString(enclosingSymbol),
                      ]
                    )
                  );
                }
    ...
    private infinitelyExpandingSourceTypeIsRelatableToTargetType(
      ...
      if (
        widenedSourceType != this.semanticInfoChain.anyTypeSymbol &&
        ...
        if (sourceTypeNamedTypeReference != targetTypeNamedTypeReference) {
          comparisonCache.setValueAt(
            sourceType.pullSymbolID,
            targetType.pullSymbolID,
            false
          );
          if (comparisonInfo) {
            var enclosingSymbol = this.getEnclosingSymbolForAST(ast);
            comparisonInfo.addMessage(
              getDiagnosticMessage(
                DiagnosticCode.Types_0_and_1_originating_in_inifinitely_expanding_type_reference_do_not_refer_to_same_named_type,
                [
                  sourceType.getScopedNameEx(enclosingSymbol).toString(),
                  targetType.toString(enclosingSymbol),
                ]
              )
            );
          }
        ...
        if (
          ...
          if (comparisonInfo) {
            ...
            comparisonInfo.addMessage(
              getDiagnosticMessage(
                DiagnosticCode.Types_0_and_1_originating_in_inifinitely_expanding_type_reference_have_incompatible_type_arguments,
                [
                  sourceType.toString(enclosingSymbol),
                  targetType.toString(enclosingSymbol),
                ]
              )
            );
        ...
        if (comparisonInfo && !comparisonInfo.onlyCaptureFirstError) {
          comparisonInfoTypeArgumentsCheck = new TypeComparisonInfo(
            comparisonInfo
          );
        }
        for (var i = 0; i < sourceTypeArguments.length; i++) {
          ...
          if (
            ...
            if (comparisonInfo) {
              ...
              if (
                comparisonInfoTypeArgumentsCheck &&
                comparisonInfoTypeArgumentsCheck.message
              ) {
                message = getDiagnosticMessage(
                  DiagnosticCode.Types_0_and_1_originating_in_inifinitely_expanding_type_reference_have_incompatible_type_arguments_NL_2,
                  [
                    sourceType.toString(enclosingSymbol),
                    targetType.toString(enclosingSymbol),
                    comparisonInfoTypeArgumentsCheck.message,
    ...
    private infinitelyExpandingTypesAreIdentical(
      sourceType: PullTypeSymbol,
      targetType: PullTypeSymbol
    ): boolean {
      // Section 3.8.7 - Recursive Types
    ...
    private sourcePropertyIsRelatableToTargetProperty(
      source: PullTypeSymbol,
      target: PullTypeSymbol,
      sourceProp: PullSymbol,
      targetProp: PullSymbol,
      ...
      var targetPropIsPrivate = targetProp.anyDeclHasFlag(
        PullElementFlags.Private
      );
      var sourcePropIsPrivate = sourceProp.anyDeclHasFlag(
        PullElementFlags.Private
      );
      ...
      if (targetPropIsPrivate != sourcePropIsPrivate) {
        if (comparisonInfo) {
          ...
          if (targetPropIsPrivate) {
            ...
            comparisonInfo.addMessage(
              getDiagnosticMessage(
                ...
                [
                  targetProp.getScopedNameEx().toString(),
                  sourceProp.getContainer().toString(enclosingSymbol),
                  targetProp.getContainer().toString(enclosingSymbol),
                ]
              )
            );
          } else {
          ...
          comparisonInfo.flags |=
            TypeRelationshipFlags.InconsistantPropertyAccesibility;
        }
        return false;
      }
      ...
      if (
        comparisonCache.valueAt(
          sourcePropType.pullSymbolID,
          targetPropType.pullSymbolID
        )
      ) {
        return true;
      }
      ...
      if (comparisonInfo && !comparisonInfo.onlyCaptureFirstError) {
        comparisonInfoPropertyTypeCheck = new TypeComparisonInfo(
          comparisonInfo
        );
      }
      ...
      if (
        this.sourceIsRelatableToTargetInEnclosingTypes(
          ...
          ast,
          context,
          comparisonInfoPropertyTypeCheck,
          isComparingInstantiatedSignatures
        )
      ) {
        return true;
    ...
    private sourceCallSignaturesAreRelatableToTargetCallSignatures(
      ...
      if (targetCallSigs.length) {
        ...
        if (comparisonInfo && !comparisonInfo.onlyCaptureFirstError) {
          comparisonInfoSignatuesTypeCheck = new TypeComparisonInfo(
            comparisonInfo
          );
        }
        ...
        if (
          !this.signatureGroupIsRelatableToTarget(
            ...
            ast,
            context,
            comparisonInfoSignatuesTypeCheck,
            isComparingInstantiatedSignatures
          )
        ) {
          if (comparisonInfo) {
            ...
            if (sourceCallSigs.length && targetCallSigs.length) {
              if (
                ...
                message = getDiagnosticMessage(
                  DiagnosticCode.Call_signatures_of_types_0_and_1_are_incompatible_NL_2,
                  [
                    source.toString(enclosingSymbol),
                    target.toString(enclosingSymbol),
                    comparisonInfoSignatuesTypeCheck.message,
                ...
                message = getDiagnosticMessage(
                  DiagnosticCode.Call_signatures_of_types_0_and_1_are_incompatible,
                  [
                    source.toString(enclosingSymbol),
                    target.toString(enclosingSymbol),
                  ]
              ...
              var hasSig = targetCallSigs.length
                ? target.toString(enclosingSymbol)
                : source.toString(enclosingSymbol);
              var lacksSig = !targetCallSigs.length
                ? target.toString(enclosingSymbol)
                : source.toString(enclosingSymbol);
              message = getDiagnosticMessage(
                DiagnosticCode.Type_0_requires_a_call_signature_but_type_1_lacks_one,
                [hasSig, lacksSig]
              );
            }
            comparisonInfo.flags |=
              TypeRelationshipFlags.IncompatibleSignatures;
            comparisonInfo.addMessage(message);
          }
          return false;
        }
    ...
    private sourceConstructSignaturesAreRelatableToTargetConstructSignatures(
      source: PullTypeSymbol,
      target: PullTypeSymbol,
      assignableTo: boolean,
      comparisonCache: IBitMatrix,
          ...
          if (comparisonInfo) {
            ...
            if (sourceConstructSigs.length && targetConstructSigs.length) {
              if (
                ...
                message = getDiagnosticMessage(
                  DiagnosticCode.Construct_signatures_of_types_0_and_1_are_incompatible_NL_2,
                  [
                    source.toString(enclosingSymbol),
                    target.toString(enclosingSymbol),
                    comparisonInfoSignatuesTypeCheck.message,
                ...
                message = getDiagnosticMessage(
                  DiagnosticCode.Construct_signatures_of_types_0_and_1_are_incompatible,
                  [
                    source.toString(enclosingSymbol),
                    target.toString(enclosingSymbol),
                  ]
              ...
              var hasSig = targetConstructSigs.length
                ? target.toString(enclosingSymbol)
                : source.toString(enclosingSymbol);
              var lacksSig = !targetConstructSigs.length
                ? target.toString(enclosingSymbol)
                : source.toString(enclosingSymbol);
              message = getDiagnosticMessage(
                DiagnosticCode.Type_0_requires_a_construct_signature_but_type_1_lacks_one,
                [hasSig, lacksSig]
              );
            }
            comparisonInfo.flags |=
    ...
    private sourceIndexSignaturesAreRelatableToTargetIndexSignatures(
      source: PullTypeSymbol,
      target: PullTypeSymbol,
      assignableTo: boolean,
      comparisonCache: IBitMatrix,
      ...
      if (targetStringSig || targetNumberSig) {
        var sourceIndexSigs = this.getBothKindsOfIndexSignatures(
          source,
          context
        );
        ...
        if (targetStringSig) {
          if (sourceStringSig) {
            comparable = this.signatureIsAssignableToTarget(
              sourceStringSig,
              targetStringSig,
              ast,
              context,
        ...
        if (comparable && targetNumberSig) {
          if (sourceNumberSig) {
            ...
            comparable = this.sourceIsAssignableToTarget(
              sourceStringSig.returnType,
              targetNumberSig.returnType,
              ast,
              context,
              comparisonInfoSignatuesTypeCheck
            );
        ...
        if (!comparable) {
          if (comparisonInfo) {
            ...
            if (
              ...
              message = getDiagnosticMessage(
                DiagnosticCode.Index_signatures_of_types_0_and_1_are_incompatible_NL_2,
                [
                  source.toString(enclosingSymbol),
                  target.toString(enclosingSymbol),
                  comparisonInfoSignatuesTypeCheck.message,
              ...
              message = getDiagnosticMessage(
                DiagnosticCode.Index_signatures_of_types_0_and_1_are_incompatible,
                [
                  source.toString(enclosingSymbol),
                  target.toString(enclosingSymbol),
                ]
    ...
    private signatureGroupIsRelatableToTarget(
      sourceSG: PullSignatureSymbol[],
      targetSG: PullSignatureSymbol[],
      assignableTo: boolean,
      comparisonCache: IBitMatrix,
      ast: AST,
      context: PullTypeResolutionContext,
      ...
      for (var iMSig = 0; iMSig < targetSG.length; iMSig++) {
        ...
        if (
          mSig.isStringConstantOverloadSignature() ||
          (targetExcludeDefinition && mSig.isDefinition())
        ) {
          continue;
        }
        ...
        for (var iNSig = 0; iNSig < sourceSG.length; iNSig++) {
          ...
          if (
            nSig.isStringConstantOverloadSignature() ||
            (sourceExcludeDefinition && nSig.isDefinition())
          ) {
            continue;
          }

          if (
            this.signatureIsRelatableToTarget(
              nSig,
              mSig,
              assignableTo,
              comparisonCache,
    ...
    private signatureIsRelatableToTarget(
      sourceSig: PullSignatureSymbol,
      targetSig: PullSignatureSymbol,
      assignableTo: boolean,
      comparisonCache: IBitMatrix,
      ast: AST,
      context: PullTypeResolutionContext,
      ...
      if (sourceVarArgCount > targetVarArgCount) {
        if (comparisonInfo) {
          comparisonInfo.flags |=
            TypeRelationshipFlags.SourceSignatureHasTooManyParameters;
          comparisonInfo.addMessage(
            getDiagnosticMessage(
              DiagnosticCode.Call_signature_expects_0_or_fewer_parameters,
              [targetVarArgCount.toString()]
            )
          );
        }
        return false;
      ...
      if (sourceSig.isGeneric()) {
        sourceSig = this.instantiateSignatureInContext(
          sourceSig,
          targetSig,
          context
        );
      ...
      comparisonCache.setValueAt(
        sourceSig.pullSymbolID,
        targetSig.pullSymbolID,
        false
      );
      ...
      if (targetReturnType != this.semanticInfoChain.voidTypeSymbol) {
        if (
          ...
          if (comparisonInfo) {
            comparisonInfo.flags |=
              TypeRelationshipFlags.IncompatibleReturnTypes;
      ...
      var len =
        sourceVarArgCount < targetVarArgCount &&
        (sourceSig.hasVarArgs || sourceParameters.length > sourceVarArgCount)
          ? targetVarArgCount
          : sourceVarArgCount;
      ...
      for (var iSource = 0, iTarget = 0; iSource < len; iSource++, iTarget++) {
        if (
          iSource < sourceParameters.length &&
          (!sourceSig.hasVarArgs || iSource < sourceVarArgCount)
        ) {
        ...
        if (
          iTarget < targetParameters.length &&
          !targetSig.hasVarArgs &&
          (!targetVarArgCount || iTarget < targetVarArgCount)
        ) {
        ...
        if (
          ...
          if (comparisonInfo) {
            comparisonInfo.flags |=
              TypeRelationshipFlags.IncompatibleParameterTypes;
          }
    ...
    private resolveOverloads(
      ...
      var comparisonInfo = new TypeComparisonInfo();
      var args = application.argumentList
        ? application.argumentList.args
        : null;
      ...
      var firstAssignableWithProvisionalErrorsSignature: PullSignatureSymbol =
        null;

      for (var i = 0; i < initialCandidates.length; i++) {
        var applicability = this.overloadIsApplicable(
          initialCandidates[i],
          args,
          context,
          comparisonInfo
      ...
      if (
        ...
        if (comparisonInfo.message) {
          diagnostics.push(
            this.semanticInfoChain.diagnosticFromAST(
              target,
              DiagnosticCode.Supplied_parameters_do_not_match_any_signature_of_call_target_NL_0,
              [comparisonInfo.message]
            )
          );
        } else {
          diagnostics.push(
            this.semanticInfoChain.diagnosticFromAST(
              target,
              DiagnosticCode.Supplied_parameters_do_not_match_any_signature_of_call_target,
              null
            )
          );
        }
    ...
    private getCallTargetErrorSpanAST(callEx: ICallExpression): AST {
      return callEx.expression.kind() === SyntaxKind.MemberAccessExpression
        ? (<MemberAccessExpression>callEx.expression).name
        : callEx.expression;
    }

    private overloadHasCorrectArity(
      signature: PullSignatureSymbol,
      args: ISeparatedSyntaxList2
    ): boolean {
      if (args == null) {
      ...
      var numberOfArgs =
        ...
        args.nonSeparatorCount() === args.separatorCount()
    ...
    private overloadIsApplicable(
      signature: PullSignatureSymbol,
      args: ISeparatedSyntaxList2,
      context: PullTypeResolutionContext,
      comparisonInfo: TypeComparisonInfo
    ): OverloadApplicabilityStatus {
      ...
      for (var i = 0; i < args.nonSeparatorCount(); i++) {
        if (!isInVarArg) {
          ...
          if (parameters[i].isVarArg) {
            ...
            paramType =
              parameters[i].type.getElementType() ||
              this.getNewErrorTypeSymbol(parameters[i].type.getName());
            isInVarArg = true;
          } else {
        ...
        var statusOfCurrentArgument = this.overloadIsApplicableForArgument(
          paramType,
          args.nonSeparatorAt(i),
          i,
          context,
          comparisonInfo
        );
        ...
        if (
          statusOfCurrentArgument === OverloadApplicabilityStatus.NotAssignable
        ) {
          return OverloadApplicabilityStatus.NotAssignable;
        } else if (
          statusOfCurrentArgument ===
          OverloadApplicabilityStatus.AssignableButWithProvisionalErrors
        ) {
          overloadApplicability =
            OverloadApplicabilityStatus.AssignableButWithProvisionalErrors;
        } else if (
          overloadApplicability !==
            OverloadApplicabilityStatus.AssignableButWithProvisionalErrors &&
    ...
    private overloadIsApplicableForArgument(
      ...
      if (paramType.isAny()) {
        ...
        return this.overloadIsApplicableForAnyFunctionExpressionArgument(
          ...
          arg,
          null,
          Parameters.fromIdentifier(simpleArrowFunction.identifier),
          null,
          simpleArrowFunction.block,
          simpleArrowFunction.expression,
          argIndex,
          context,
          comparisonInfo
        );
      } else if (
        arg.kind() === SyntaxKind.ParenthesizedArrowFunctionExpression
      ) {
        ...
        return this.overloadIsApplicableForAnyFunctionExpressionArgument(
          ...
          arg,
          arrowFunction.callSignature.typeParameterList,
          Parameters.fromParameterList(
            arrowFunction.callSignature.parameterList
          ),
          getType(arrowFunction),
          arrowFunction.block,
          arrowFunction.expression,
        ...
        return this.overloadIsApplicableForAnyFunctionExpressionArgument(
          paramType,
          arg,
          functionExpression.callSignature.typeParameterList,
          Parameters.fromParameterList(
            functionExpression.callSignature.parameterList
          ),
          getType(functionExpression),
        ...
        return this.overloadIsApplicableForObjectLiteralArgument(
          paramType,
          <ObjectLiteralExpression>arg,
          argIndex,
          context,
          comparisonInfo
        );
        ...
        return this.overloadIsApplicableForOtherArgument(
          paramType,
          arg,
          argIndex,
          context,
    ...
    private overloadIsApplicableForAnyFunctionExpressionArgument(
      ...
      if (
        this.cachedFunctionInterfaceType() &&
        paramType === this.cachedFunctionInterfaceType()
      ) {
      ...
      var argSym = this.resolveAnyFunctionExpression(
        arg,
        typeParameters,
        parameters,
        returnTypeAnnotation,
      ...
      var applicabilityStatus = this.overloadIsApplicableForArgumentHelper(
        paramType,
        argSym.type,
        argIndex,
        comparisonInfo,
    ...
    private overloadIsApplicableForObjectLiteralArgument(
      ...
      if (
        this.cachedObjectInterfaceType() &&
        paramType === this.cachedObjectInterfaceType()
      ) {
        return OverloadApplicabilityStatus.AssignableWithNoProvisionalErrors;
      }

      context.pushContextualType(paramType, true, null);
      var argSym = this.resolveObjectLiteralExpression(
        arg,
        /*isContextuallyTyped*/ true,
        context
      );
    ...
    private overloadIsApplicableForArrayLiteralArgument(
      paramType: PullTypeSymbol,
      arg: ArrayLiteralExpression,
      argIndex: number,
      context: PullTypeResolutionContext,
      comparisonInfo: TypeComparisonInfo
    ): OverloadApplicabilityStatus {
      ...
      context.pushContextualType(paramType, true, null);
      var argSym = this.resolveArrayLiteralExpression(
        arg,
        /*isContextuallyTyped*/ true,
        context
      );
    ...
    private overloadIsApplicableForOtherArgument(
      paramType: PullTypeSymbol,
      arg: AST,
      argIndex: number,
      context: PullTypeResolutionContext,
      ...
      return this.overloadIsApplicableForArgumentHelper(
        paramType,
        argSym.type,
        argIndex,
        comparisonInfo,
    ...
    private overloadIsApplicableForArgumentHelper(
      paramType: PullTypeSymbol,
      argSym: PullSymbol,
      ...
      if (
        this.sourceIsAssignableToTarget(
          ...
          arg,
          context,
          comparisonInfo.message ? tempComparisonInfo : comparisonInfo
        )
      ) {
      ...
      if (!comparisonInfo.message) {
        ...
        comparisonInfo.addMessage(
          getDiagnosticMessage(
            DiagnosticCode.Could_not_apply_type_0_to_argument_1_which_is_of_type_2,
            [
              paramType.toString(enclosingSymbol),
              (argumentIndex + 1).toString(),
              argSym.getTypeName(enclosingSymbol),
            ]
          )
        );
      }
    ...
    private inferArgumentTypesForSignature(
      signature: PullSignatureSymbol,
      ...
      for (var i = 0; i < argCount; i++) {
        ...
        if (
          ...
          i >= signature.nonOptionalParamCount - 1 &&
          parameterType.isArrayNamedTypeReference()
        ) {
        ...
        if (inferenceCandidates.length) {
          for (var j = 0; j < inferenceCandidates.length; j++) {
            ...
            this.relateTypeToTypeParameters(
              argContext.getArgumentTypeSymbolAtIndex(i, context),
              parameterType,
              false,
              argContext,
              context
      ...
      for (var i = 0; i < typeParameters.length; i++) {
        for (var j = 0; j < inferenceResults.results.length; j++) {
          if (
            inferenceResults.results[j].param == typeParameters[i] &&
            inferenceResults.results[j].type
          ) {
      ...
      var inferringAtCallExpression =
        argContext.argumentASTs &&
        argContext.argumentASTs.parent &&
        argContext.argumentASTs.parent.kind() === SyntaxKind.ArgumentList &&
        (argContext.argumentASTs.parent.parent.kind() ===
      ...
      if (inferringAtCallExpression) {
        ...
        if (
          !this.typeParametersAreInScopeAtArgumentList(
            typeParameters,
            argContext.argumentASTs
          )
        ) {
          for (var i = 0; i < resultTypes.length; i++) {
            ...
            if (
              resultTypes[i].wrapsSomeTypeParameter(argContext.candidateCache)
            ) {
              resultTypes[i] = this.semanticInfoChain.emptyTypeSymbol;
            }
          }
    ...
    private typeParametersAreInScopeAtArgumentList(
      ...
      var typeParameterParentDecl = typeParameters[0]
        .getDeclarations()[0]
        .getParentDecl();
      return (
        enclosingDecl.getParentPath().indexOf(typeParameterParentDecl) > -1
      );
    }

    private relateTypeToTypeParametersInEnclosingType(
      expressionType: PullTypeSymbol,
      parameterType: PullTypeSymbol,
      expressionTypeEnclosingType: PullTypeSymbol,
      parameterTypeEnclosingType: PullTypeSymbol,
      shouldFix: boolean,
      argContext: ArgumentInferenceContext,
      context: PullTypeResolutionContext
    ) {
      if (expressionType && parameterType) {
        var expressionTypeGenerativeTypeClassification =
          expressionTypeEnclosingType
            ? expressionType.getGenerativeTypeClassification(
                expressionTypeEnclosingType
              )
            : GenerativeTypeClassification.Unknown;
        var parameterTypeGenerativeTypeClassification =
          parameterTypeEnclosingType
            ? parameterType.getGenerativeTypeClassification(
                parameterTypeEnclosingType
              )
            : GenerativeTypeClassification.Unknown;
        if (
          expressionTypeGenerativeTypeClassification ==
            GenerativeTypeClassification.InfinitelyExpanding ||
          parameterTypeGenerativeTypeClassification ==
            GenerativeTypeClassification.InfinitelyExpanding
        ) {
          this.relateInifinitelyExpandingTypeToTypeParameters(
            expressionType,
            parameterType,
            shouldFix,
            argContext,
    ...
    private relateTypeToTypeParameters(
      expressionType: PullTypeSymbol,
      parameterType: PullTypeSymbol,
      shouldFix: boolean,
      argContext: ArgumentInferenceContext,
      ...
      if (parameterType.isTypeParameter()) {
        argContext.addCandidateForInference(
          <PullTypeParameterSymbol>parameterType,
          expressionType,
          shouldFix
        );
        return;
      ...
      if (
        ...
        (parameterDeclarations[0].isEqual(expressionDeclarations[0]) ||
          (expressionType.isGeneric() &&
            parameterType.isGeneric() &&
            this.sourceIsSubtypeOfTarget(
              this.instantiateTypeToAny(expressionType, context),
              this.instantiateTypeToAny(parameterType, context),
              /*ast*/ null,
              context,
              null
            ))) &&
        ...
        this.relateTypeArgumentsOfTypeToTypeParameters(
          expressionType,
          parameterType,
          shouldFix,
          argContext,
      ...
      if (
        expressionType.isArrayNamedTypeReference() &&
        parameterType.isArrayNamedTypeReference()
      ) {
        this.relateArrayTypeToTypeParameters(
          expressionType,
          parameterType,
          shouldFix,
          argContext,
      ...
      this.relateObjectTypeToTypeParameters(
        expressionType,
        parameterType,
        shouldFix,
        argContext,
    ...
    private relateTypeArgumentsOfTypeToTypeParameters(
      expressionType: PullTypeSymbol,
      parameterType: PullTypeSymbol,
      shouldFix: boolean,
      argContext: ArgumentInferenceContext,
      ...
      var typeParameters: PullTypeSymbol[] =
        parameterType.getTypeArgumentsOrTypeParameters();
    ...
    private relateInifinitelyExpandingTypeToTypeParameters(
      expressionType: PullTypeSymbol,
      parameterType: PullTypeSymbol,
      shouldFix: boolean,
      argContext: ArgumentInferenceContext,
      ...
      var expressionTypeNamedTypeReference =
        PullHelpers.getRootType(expressionType);
      var parameterTypeNamedTypeReference =
        PullHelpers.getRootType(parameterType);
      ...
      if (
        ...
        expressionTypeTypeArguments.length === parameterTypeParameters.length
      ) {
    ...
    private relateFunctionSignatureToTypeParameters(
      expressionSignature: PullSignatureSymbol,
      ...
      var len =
        parameterParams.length < expressionParams.length
          ? parameterParams.length
          : expressionParams.length;

      for (var i = 0; i < len; i++) {
        this.relateTypeToTypeParametersInEnclosingType(
          expressionParams[i].type,
          parameterParams[i].type,
          expressionSignature.functionType,
          parameterSignature.functionType,
          /*shouldFix:*/ true,
          argContext,
          context
        );
    ...
    private relateObjectTypeToTypeParameters(
      objectType: PullTypeSymbol,
      parameterType: PullTypeSymbol,
      shouldFix: boolean,
      argContext: ArgumentInferenceContext,
      context: PullTypeResolutionContext
      ...
      if (objectTypeArguments) {
        if (objectTypeArguments.length === parameterTypeParameters.length) {
          for (var i = 0; i < objectTypeArguments.length; i++) {
            ...
            argContext.addCandidateForInference(
              <PullTypeParameterSymbol>parameterTypeParameters[i],
      ...
      for (var i = 0; i < parameterTypeMembers.length; i++) {
        objectMember = this.getMemberSymbol(
          parameterTypeMembers[i].name,
          PullElementKind.SomeValue,
          objectType
        );
        if (objectMember) {
      ...
      if (
        parameterSignatures.length == 1 &&
        objectSignatures.length == 1 &&
        !objectSignatures[0].isGeneric() &&
        parameterSignatures[0].nonOptionalParamCount >=
          objectSignatures[0].nonOptionalParamCount
      ) {
        this.relateFunctionSignatureToTypeParameters(
          objectSignatures[0],
          parameterSignatures[0],
          argContext,
          context
        );
      }
      ...
      var parameterIndexSignatures = this.getBothKindsOfIndexSignatures(
        parameterType,
        context
      );
      var objectIndexSignatures = this.getBothKindsOfIndexSignatures(
        objectType,
        context
      );
      ...
      if (
        parameterIndexSignatures.stringSignature &&
        objectIndexSignatures.stringSignature
      ) {
        this.relateFunctionSignatureToTypeParameters(
          objectIndexSignatures.stringSignature,
          parameterIndexSignatures.stringSignature,
      ...
      if (
        parameterIndexSignatures.numericSignature &&
        objectIndexSignatures.numericSignature
      ) {
        this.relateFunctionSignatureToTypeParameters(
          objectIndexSignatures.numericSignature,
          parameterIndexSignatures.numericSignature,
    ...
    private relateArrayTypeToTypeParameters(
      argArrayType: PullTypeSymbol,
    ...
    public instantiateTypeToAny(
      typeToSpecialize: PullTypeSymbol,
      context: PullTypeResolutionContext
    ): PullTypeSymbol {
    ...
    public static typeCheck(
      ...
      if (resolver.canTypeCheckAST(sourceUnit, context)) {
        ...
        resolver.validateVariableDeclarationGroups(
          semanticInfoChain.getDeclForAST(sourceUnit),
          context
        );
    ...
    private validateVariableDeclarationGroups(
      enclosingDecl: PullDecl,
      context: PullTypeResolutionContext
    ) {
      ...
      if (
        enclosingDecl.kind &
        (PullElementKind.Container |
          PullElementKind.DynamicModule |
          PullElementKind.Script)
      ) {
        ...
        for (var i = 0, n = childDecls.length; i < n; i++) {
          ...
          if (childDecl.kind === PullElementKind.TypeAlias) {
            importDeclarationNames =
              importDeclarationNames || createIntrinsicsObject<boolean>();
      ...
      for (var i = 0, i_max = declGroups.length; i < i_max; i++) {
        ...
        if (
          enclosingDecl.kind === PullElementKind.Script &&
          declGroups[i].length
        ) {
          var name = declGroups[i][0].name;
          var candidateSymbol = this.semanticInfoChain.findTopLevelSymbol(
            name,
            PullElementKind.Variable,
            enclosingDecl
          );
          if (candidateSymbol && candidateSymbol.isResolved) {
            if (
              !candidateSymbol.anyDeclHasFlag(PullElementFlags.ImplicitVariable)
            ) {
          ...
          var importSymbol = this.semanticInfoChain.findTopLevelSymbol(
            name,
            PullElementKind.TypeAlias,
            null
          );
        ...
        for (var j = 0, j_max = declGroups[i].length; j < j_max; j++) {
          ...
          if (
            ...
            !this.typesAreIdentical(symbolType, firstSymbolType)
          ) {
            context.postDiagnostic(
              this.semanticInfoChain.diagnosticFromAST(
                boundDeclAST,
                DiagnosticCode.Subsequent_variable_declarations_must_have_the_same_type_Variable_0_must_be_of_type_1_but_here_has_type_2,
                [
                  symbol.getScopedName(),
                  firstSymbolType.toString(),
                  symbolType.toString(),
                ]
              )
            );
    ...
    private typeCheckFunctionOverloads(
      ...
      if (!signature) {
        var functionSignatureInfo = PullHelpers.getSignatureForFuncDecl(
          this.semanticInfoChain.getDeclForAST(funcDecl)
        );
      ...
      if (!signature.isDefinition()) {
        ...
        for (var i = 0; i < allSignatures.length; i++) {
          ...
          if (
            this.signaturesAreIdentical(
              allSignatures[i],
              signature,
              /*includingReturnType*/ false
            )
          ) {
            if (
              !this.typesAreIdentical(
                allSignatures[i].returnType,
                signature.returnType
              )
            ) {
              context.postDiagnostic(
                this.semanticInfoChain.diagnosticFromAST(
                  funcDecl,
                  DiagnosticCode.Overloads_cannot_differ_only_by_return_type
                )
              );
              ...
              context.postDiagnostic(
                this.semanticInfoChain.diagnosticFromAST(
                  funcDecl,
                  DiagnosticCode.Duplicate_constructor_overload_signature
                )
              );
            } else if (
              functionDeclaration.kind === PullElementKind.ConstructSignature
            ) {
              context.postDiagnostic(
                this.semanticInfoChain.diagnosticFromAST(
                  funcDecl,
                  DiagnosticCode.Duplicate_overload_construct_signature
                )
              );
            } else if (
              functionDeclaration.kind === PullElementKind.CallSignature
            ) {
              context.postDiagnostic(
                this.semanticInfoChain.diagnosticFromAST(
                  funcDecl,
                  DiagnosticCode.Duplicate_overload_call_signature
                )
              );
            } else {
              context.postDiagnostic(
                this.semanticInfoChain.diagnosticFromAST(
                  funcDecl,
                  DiagnosticCode.Duplicate_overload_signature_for_0,
      ...
      var isConstantOverloadSignature =
        signature.isStringConstantOverloadSignature();
      if (isConstantOverloadSignature) {
        if (signature.isDefinition()) {
          ...
          context.postDiagnostic(
            this.semanticInfoChain.diagnosticFromAST(
              funcDecl,
              DiagnosticCode.Overload_signature_implementation_cannot_use_specialized_type
            )
          );
        } else {
          ...
          for (var i = 0; i < allSignatures.length; i++) {
            ...
            if (
              this.signatureIsSubtypeOfTarget(
                signature,
                allSignatures[i],
                /*ast*/ null,
                context
          ...
          if (!foundSubtypeSignature) {
            ...
            context.postDiagnostic(
              this.semanticInfoChain.diagnosticFromAST(
                funcDecl,
                DiagnosticCode.Specialized_overload_signature_is_not_subtype_of_any_non_specialized_signature
              )
            );
          }
        }
        ...
        if (
          !this.signatureIsAssignableToTarget(
            definitionSignature,
            signature,
            funcDecl,
            context,
          ...
          if (comparisonInfo.message) {
            context.postDiagnostic(
              this.semanticInfoChain.diagnosticFromAST(
                funcDecl,
                DiagnosticCode.Overload_signature_is_not_compatible_with_function_definition_NL_0,
                [comparisonInfo.message]
              )
            );
          } else {
            context.postDiagnostic(
              this.semanticInfoChain.diagnosticFromAST(
                funcDecl,
                DiagnosticCode.Overload_signature_is_not_compatible_with_function_definition
              )
            );
          }
        }
      ...
      if (
        funcDecl.kind() !== SyntaxKind.ConstructorDeclaration &&
        functionDeclaration.kind !== PullElementKind.ConstructSignature &&
        signatureForVisibilityCheck &&
        signature != signatureForVisibilityCheck
      ) {
        var errorCode: string;
        // verify it satisfies all the properties of first signature
        if (
          signatureForVisibilityCheck.anyDeclHasFlag(
            PullElementFlags.Private
          ) != signature.anyDeclHasFlag(PullElementFlags.Private)
        ) {
          errorCode =
            DiagnosticCode.Overload_signatures_must_all_be_public_or_private;
        } else if (
          signatureForVisibilityCheck.anyDeclHasFlag(
            PullElementFlags.Exported
          ) != signature.anyDeclHasFlag(PullElementFlags.Exported)
        ) {
          errorCode =
            DiagnosticCode.Overload_signatures_must_all_be_exported_or_not_exported;
        } else if (
          signatureForVisibilityCheck.anyDeclHasFlag(
            PullElementFlags.Ambient
          ) != signature.anyDeclHasFlag(PullElementFlags.Ambient)
        ) {
          errorCode =
            DiagnosticCode.Overload_signatures_must_all_be_ambient_or_non_ambient;
        } else if (
          signatureForVisibilityCheck.anyDeclHasFlag(
            PullElementFlags.Optional
          ) != signature.anyDeclHasFlag(PullElementFlags.Optional)
        ) {
          errorCode =
            DiagnosticCode.Overload_signatures_must_all_be_optional_or_required;
        }

        if (errorCode) {
          context.postDiagnostic(
            this.semanticInfoChain.diagnosticFromAST(funcDecl, errorCode)
          );
        }
      }
    }
    ...
    private checkSymbolPrivacy(
      declSymbol: PullSymbol,
      symbol: PullSymbol,
      privacyErrorReporter: (symbol: PullSymbol) => void
    ) {
      ...
      if (symbol.isType()) {
        ...
        if (typeSymbol.isArrayNamedTypeReference()) {
          this.checkSymbolPrivacy(
            declSymbol,
            typeSymbol.getElementType(),
            privacyErrorReporter
          );
          return;
        }
        ...
        if (!isNamedType) {
          ...
          this.checkTypePrivacyOfSignatures(
            declSymbol,
            typeSymbol.getIndexSignatures(),
            privacyErrorReporter
          );
        } else if (typeSymbol.kind == PullElementKind.TypeParameter) {
          this.checkSymbolPrivacy(
            declSymbol,
            (<PullTypeParameterSymbol>typeSymbol).getConstraint(),
            privacyErrorReporter
          );
        }
      ...
      if (declSymbol.isExternallyVisible()) {
        ...
        if (symbolIsVisible && symbol.kind != PullElementKind.TypeParameter) {
          ...
          if (
            symbolPath[symbolPath.length - 1].kind ===
              PullElementKind.DynamicModule &&
            declSymbolPath[declSymbolPath.length - 1].kind ==
              PullElementKind.DynamicModule &&
            declSymbolPath[declSymbolPath.length - 1] !=
              symbolPath[symbolPath.length - 1]
          ) {
            ...
            for (var i = symbolPath.length - 1; i >= 0; i--) {
              var aliasSymbols =
                symbolPath[i].getExternalAliasedSymbols(declSymbolScope);
              if (aliasSymbols) {
                // Visible type.
    ...
    private checkTypePrivacyOfSignatures(
      declSymbol: PullSymbol,
    ...
    private typeParameterOfTypeDeclarationPrivacyErrorReporter(
      classOrInterface: AST,
      indexOfTypeParameter: number,
      ...
      var typeParameterAST =
        typeParameters.typeParameters.nonSeparatorAt(indexOfTypeParameter);
      ...
      if (typeSymbol.isContainer() && !typeSymbol.isEnum()) {
        ...
        if (classOrInterface.kind() === SyntaxKind.ClassDeclaration) {
          // Class
          messageCode =
            DiagnosticCode.TypeParameter_0_of_exported_class_is_using_inaccessible_module_1;
        } else {
          // Interface
          messageCode =
            DiagnosticCode.TypeParameter_0_of_exported_interface_is_using_inaccessible_module_1;
        }
      } else {
        if (classOrInterface.kind() === SyntaxKind.ClassDeclaration) {
          // Class
          messageCode =
            DiagnosticCode.TypeParameter_0_of_exported_class_has_or_is_using_private_type_1;
        } else {
          // Interface
          messageCode =
            DiagnosticCode.TypeParameter_0_of_exported_interface_has_or_is_using_private_type_1;
        }
      }

      var messageArguments = [
        typeParameter.getScopedName(
          enclosingSymbol,
          /*skipTypeParametersInName*/ false,
          true /*useConstraintInName*/
        ),
        typeSymbolName,
      ];
      context.postDiagnostic(
    ...
    private baseListPrivacyErrorReporter(
      classOrInterface: AST,
      declSymbol: PullTypeSymbol,
      baseAst: AST,
      ...
      if (typeSymbol.isContainer() && !typeSymbol.isEnum()) {
        ...
        if (classOrInterface.kind() === SyntaxKind.ClassDeclaration) {
          ...
          if (isExtendedType) {
            messageCode =
              DiagnosticCode.Exported_class_0_extends_class_from_inaccessible_module_1;
          } else {
            messageCode =
              DiagnosticCode.Exported_class_0_implements_interface_from_inaccessible_module_1;
          }
        } else {
          // Interface
          messageCode =
            DiagnosticCode.Exported_interface_0_extends_interface_from_inaccessible_module_1;
        }
      } else {
        if (classOrInterface.kind() === SyntaxKind.ClassDeclaration) {
          // Class
          if (isExtendedType) {
            messageCode =
              DiagnosticCode.Exported_class_0_extends_private_class_1;
          } else {
            messageCode =
              DiagnosticCode.Exported_class_0_implements_private_interface_1;
          }
        } else {
          // Interface
          messageCode =
            DiagnosticCode.Exported_interface_0_extends_private_interface_1;
        }
      }

      var messageArguments = [
        declSymbol.getScopedName(enclosingSymbol),
        typeSymbolName,
      ];
      context.postDiagnostic(
        this.semanticInfoChain.diagnosticFromAST(
    ...
    private variablePrivacyErrorReporter(
      declAST: AST,
      declSymbol: PullSymbol,
      symbol: PullSymbol,
      context: PullTypeResolutionContext
      ...
      if (
        declParent &&
        (declParent.kind === PullElementKind.Class ||
          declParent.kind === PullElementKind.ConstructorMethod)
      ) {
      ...
      if (typeSymbol.isContainer() && !typeSymbol.isEnum()) {
        ...
        if (declSymbol.anyDeclHasFlag(PullElementFlags.Static)) {
          ...
          messageCode =
            DiagnosticCode.Exported_variable_0_is_using_inaccessible_module_1;
        }
      } else {
        if (declSymbol.anyDeclHasFlag(PullElementFlags.Static)) {
          messageCode =
    ...
    private checkFunctionTypePrivacy(
      ...
      if (
        funcDeclAST.kind() === SyntaxKind.FunctionExpression ||
        funcDeclAST.kind() === SyntaxKind.FunctionPropertyAssignment ||
        (funcDeclAST.kind() === SyntaxKind.GetAccessor &&
          funcDeclAST.parent.parent.kind() ===
            SyntaxKind.ObjectLiteralExpression) ||
        (funcDeclAST.kind() === SyntaxKind.SetAccessor &&
          funcDeclAST.parent.parent.kind() ===
            SyntaxKind.ObjectLiteralExpression)
      ) {
        return;
      ...
      var isIndexSignature =
        functionDecl.kind === PullElementKind.IndexSignature;

      if (isGetter || isSetter) {
        var accessorSymbol = <PullAccessorSymbol>functionSymbol;
        functionSignature = (
          isGetter ? accessorSymbol.getGetter() : accessorSymbol.getSetter()
        ...
        if (!functionSymbol) {
          ...
          if (
            functionSymbol &&
            functionSymbol.isType() &&
            !(<PullTypeSymbol>functionSymbol).isNamedTypeSymbol()
          ) {
            // Call Signature from the non named type
            return;
          }
        } else if (
          functionSymbol.kind == PullElementKind.Method &&
          !isStatic &&
      ...
      if (
        ...
        for (
          ...
          var typeParameterAST = <TypeParameter>(
            typeParameters.typeParameters.nonSeparatorAt(i)
          );
          var typeParameter = this.resolveTypeParameterDeclaration(
            typeParameterAST,
            context
          );
          this.checkSymbolPrivacy(
    ...
    private functionTypeArgumentArgumentTypePrivacyErrorReporter(
      ...
      if (
        declParent &&
        (declParent.kind === PullElementKind.Class || isStatic)
      ) {
      ...
      if (typeSymbol.isContainer() && !typeSymbol.isEnum()) {
        ...
        if (decl.kind === PullElementKind.ConstructSignature) {
          messageCode =
            DiagnosticCode.TypeParameter_0_of_constructor_signature_from_exported_interface_is_using_inaccessible_module_1;
        } else if (decl.kind === PullElementKind.CallSignature) {
          messageCode =
            DiagnosticCode.TypeParameter_0_of_call_signature_from_exported_interface_is_using_inaccessible_module_1;
        } else if (isMethod) {
          if (isStatic) {
            messageCode =
              DiagnosticCode.TypeParameter_0_of_public_static_method_from_exported_class_is_using_inaccessible_module_1;
          } else if (isMethodOfClass) {
            messageCode =
              DiagnosticCode.TypeParameter_0_of_public_method_from_exported_class_is_using_inaccessible_module_1;
          } else {
            messageCode =
              DiagnosticCode.TypeParameter_0_of_method_from_exported_interface_is_using_inaccessible_module_1;
          }
        } else {
          messageCode =
            DiagnosticCode.TypeParameter_0_of_exported_function_is_using_inaccessible_module_1;
        }
      } else {
        if (decl.kind === PullElementKind.ConstructSignature) {
          messageCode =
            DiagnosticCode.TypeParameter_0_of_constructor_signature_from_exported_interface_has_or_is_using_private_type_1;
        } else if (decl.kind === PullElementKind.CallSignature) {
          messageCode =
            DiagnosticCode.TypeParameter_0_of_call_signature_from_exported_interface_has_or_is_using_private_type_1;
        } else if (isMethod) {
          if (isStatic) {
            messageCode =
              DiagnosticCode.TypeParameter_0_of_public_static_method_from_exported_class_has_or_is_using_private_type_1;
          } else if (isMethodOfClass) {
            messageCode =
              DiagnosticCode.TypeParameter_0_of_public_method_from_exported_class_has_or_is_using_private_type_1;
          } else {
            messageCode =
              DiagnosticCode.TypeParameter_0_of_method_from_exported_interface_has_or_is_using_private_type_1;
          }
        } else {
          messageCode =
            DiagnosticCode.TypeParameter_0_of_exported_function_has_or_is_using_private_type_1;
        }
      }
    ...
    private functionArgumentTypePrivacyErrorReporter(
      ...
      if (typeSymbol.isContainer() && !typeSymbol.isEnum()) {
        ...
        if (declAST.kind() === SyntaxKind.ConstructorDeclaration) {
          messageCode =
            DiagnosticCode.Parameter_0_of_constructor_from_exported_class_is_using_inaccessible_module_1;
        } else if (isSetter) {
          if (isStatic) {
            messageCode =
              DiagnosticCode.Parameter_0_of_public_static_property_setter_from_exported_class_is_using_inaccessible_module_1;
          } else {
            messageCode =
              DiagnosticCode.Parameter_0_of_public_property_setter_from_exported_class_is_using_inaccessible_module_1;
          }
        } else if (decl.kind === PullElementKind.ConstructSignature) {
          messageCode =
            DiagnosticCode.Parameter_0_of_constructor_signature_from_exported_interface_is_using_inaccessible_module_1;
        } else if (decl.kind === PullElementKind.CallSignature) {
          messageCode =
            DiagnosticCode.Parameter_0_of_call_signature_from_exported_interface_is_using_inaccessible_module_1;
        } else if (isMethod) {
          if (isStatic) {
            messageCode =
              DiagnosticCode.Parameter_0_of_public_static_method_from_exported_class_is_using_inaccessible_module_1;
          } else if (isMethodOfClass) {
            messageCode =
              DiagnosticCode.Parameter_0_of_public_method_from_exported_class_is_using_inaccessible_module_1;
          } else {
            messageCode =
              DiagnosticCode.Parameter_0_of_method_from_exported_interface_is_using_inaccessible_module_1;
          }
        } else if (!isGetter) {
          messageCode =
            DiagnosticCode.Parameter_0_of_exported_function_is_using_inaccessible_module_1;
        }
      } else {
        if (declAST.kind() === SyntaxKind.ConstructorDeclaration) {
          messageCode =
            DiagnosticCode.Parameter_0_of_constructor_from_exported_class_has_or_is_using_private_type_1;
        } else if (isSetter) {
          if (isStatic) {
            messageCode =
              DiagnosticCode.Parameter_0_of_public_static_property_setter_from_exported_class_has_or_is_using_private_type_1;
          } else {
            messageCode =
              DiagnosticCode.Parameter_0_of_public_property_setter_from_exported_class_has_or_is_using_private_type_1;
          }
        } else if (decl.kind === PullElementKind.ConstructSignature) {
          messageCode =
            DiagnosticCode.Parameter_0_of_constructor_signature_from_exported_interface_has_or_is_using_private_type_1;
        } else if (decl.kind === PullElementKind.CallSignature) {
          messageCode =
            DiagnosticCode.Parameter_0_of_call_signature_from_exported_interface_has_or_is_using_private_type_1;
        } else if (isMethod) {
          if (isStatic) {
            messageCode =
              DiagnosticCode.Parameter_0_of_public_static_method_from_exported_class_has_or_is_using_private_type_1;
          } else if (isMethodOfClass) {
            messageCode =
              DiagnosticCode.Parameter_0_of_public_method_from_exported_class_has_or_is_using_private_type_1;
          } else {
            messageCode =
              DiagnosticCode.Parameter_0_of_method_from_exported_interface_has_or_is_using_private_type_1;
          }
        } else if (!isGetter && decl.kind !== PullElementKind.IndexSignature) {
          messageCode =
            DiagnosticCode.Parameter_0_of_exported_function_has_or_is_using_private_type_1;
        }
      }
      ...
      if (messageCode) {
        ...
        var messageArgs = [
          paramSymbol.getScopedName(enclosingSymbol),
          typeSymbolName,
        ];
        context.postDiagnostic(
          this.semanticInfoChain.diagnosticFromAST(
    ...
    private functionReturnTypePrivacyErrorReporter(
      ...
      if (typeSymbol.isContainer() && !typeSymbol.isEnum()) {
        ...
        if (isGetter) {
          if (isStatic) {
            messageCode =
              DiagnosticCode.Return_type_of_public_static_property_getter_from_exported_class_is_using_inaccessible_module_0;
          } else {
            messageCode =
              DiagnosticCode.Return_type_of_public_property_getter_from_exported_class_is_using_inaccessible_module_0;
          }
        } else if (decl.kind === PullElementKind.ConstructSignature) {
          messageCode =
            DiagnosticCode.Return_type_of_constructor_signature_from_exported_interface_is_using_inaccessible_module_0;
        } else if (decl.kind === PullElementKind.CallSignature) {
          messageCode =
            DiagnosticCode.Return_type_of_call_signature_from_exported_interface_is_using_inaccessible_module_0;
        } else if (decl.kind === PullElementKind.IndexSignature) {
          messageCode =
            DiagnosticCode.Return_type_of_index_signature_from_exported_interface_is_using_inaccessible_module_0;
        } else if (isMethod) {
          if (isStatic) {
            messageCode =
              DiagnosticCode.Return_type_of_public_static_method_from_exported_class_is_using_inaccessible_module_0;
          } else if (isMethodOfClass) {
            messageCode =
              DiagnosticCode.Return_type_of_public_method_from_exported_class_is_using_inaccessible_module_0;
          } else {
            messageCode =
              DiagnosticCode.Return_type_of_method_from_exported_interface_is_using_inaccessible_module_0;
          }
        } else if (
          !isSetter &&
          declAST.kind() !== SyntaxKind.ConstructorDeclaration
        ) {
          messageCode =
            DiagnosticCode.Return_type_of_exported_function_is_using_inaccessible_module_0;
        }
      } else {
        if (isGetter) {
          if (isStatic) {
            messageCode =
              DiagnosticCode.Return_type_of_public_static_property_getter_from_exported_class_has_or_is_using_private_type_0;
          } else {
            messageCode =
              DiagnosticCode.Return_type_of_public_property_getter_from_exported_class_has_or_is_using_private_type_0;
          }
        } else if (decl.kind === PullElementKind.ConstructSignature) {
          messageCode =
            DiagnosticCode.Return_type_of_constructor_signature_from_exported_interface_has_or_is_using_private_type_0;
        } else if (decl.kind === PullElementKind.CallSignature) {
          messageCode =
            DiagnosticCode.Return_type_of_call_signature_from_exported_interface_has_or_is_using_private_type_0;
        } else if (decl.kind === PullElementKind.IndexSignature) {
          messageCode =
            DiagnosticCode.Return_type_of_index_signature_from_exported_interface_has_or_is_using_private_type_0;
        } else if (isMethod) {
          if (isStatic) {
            messageCode =
              DiagnosticCode.Return_type_of_public_static_method_from_exported_class_has_or_is_using_private_type_0;
          } else if (isMethodOfClass) {
            messageCode =
              DiagnosticCode.Return_type_of_public_method_from_exported_class_has_or_is_using_private_type_0;
          } else {
            messageCode =
              DiagnosticCode.Return_type_of_method_from_exported_interface_has_or_is_using_private_type_0;
          }
        } else if (
          !isSetter &&
          declAST.kind() !== SyntaxKind.ConstructorDeclaration
          ...
          messageCode =
            DiagnosticCode.Return_type_of_exported_function_has_or_is_using_private_type_0;
        }
      }
      ...
      if (messageCode) {
        ...
        if (returnTypeAnnotation) {
          ...
          var returnExpressionSymbol = this.resolveTypeReference(
            returnTypeAnnotation,
            context
          );

          if (
            PullHelpers.typeSymbolsAreIdentical(
              returnExpressionSymbol,
              funcReturnType
            )
          ) {
        ...
        if (block) {
          var reportErrorOnReturnExpressions = (
            ast: AST,
            walker: IAstWalker
          ) => {
            var go = true;
            switch (ast.kind()) {
              ...
              case SyntaxKind.ReturnStatement:
                var returnStatement: ReturnStatement = <ReturnStatement>ast;
                var returnExpressionSymbol = this.resolveAST(
          ...
          getAstWalkerFactory().walk(block, (ast, walker) => {
            reportErrorOnReturnExpressions(ast, walker);
          });
        }
    ...
    private superCallMustBeFirstStatementInConstructor(
      constructorDecl: PullDecl
    ): boolean {
    ...
    private typeCheckMembersAgainstIndexer(
      containerType: PullTypeSymbol,
      containerTypeDecl: PullDecl,
      context: PullTypeResolutionContext
    ) {
      ...
      if (stringSignature || numberSignature) {
        ...
        for (var i = 0; i < members.length; i++) {
          ...
          if (
            (member.name ||
              (member.kind === PullElementKind.Property &&
                member.name === '')) &&
            ...
            var relevantSignature = this.determineRelevantIndexerForMember(
              memberSymbol,
              numberSignature,
              stringSignature
            );
    ...
    private determineRelevantIndexerForMember(
      member: PullSymbol,
      ...
      if (
        ...
        if (comparisonInfo.message) {
          context.postDiagnostic(
            this.semanticInfoChain.diagnosticFromAST(
              astForError,
              DiagnosticCode.All_numerically_named_properties_must_be_subtypes_of_numeric_indexer_type_0_NL_1,
              [
          ...
          context.postDiagnostic(
            this.semanticInfoChain.diagnosticFromAST(
              astForError,
              DiagnosticCode.All_numerically_named_properties_must_be_subtypes_of_numeric_indexer_type_0,
              [indexSignature.returnType.toString(enclosingSymbol)]
            )
          );
        }
        ...
        if (comparisonInfo.message) {
          context.postDiagnostic(
            this.semanticInfoChain.diagnosticFromAST(
              astForError,
              DiagnosticCode.All_named_properties_must_be_subtypes_of_string_indexer_type_0_NL_1,
              [
                indexSignature.returnType.toString(enclosingSymbol),
                comparisonInfo.message,
              ]
          ...
          context.postDiagnostic(
            this.semanticInfoChain.diagnosticFromAST(
              astForError,
              DiagnosticCode.All_named_properties_must_be_subtypes_of_string_indexer_type_0,
              [indexSignature.returnType.toString(enclosingSymbol)]
            )
          );
        }
    ...
    private typeCheckIfTypeMemberPropertyOkToOverride(
      typeSymbol: PullTypeSymbol,
      extendedType: PullTypeSymbol,
      typeMember: PullSymbol,
      extendedTypeMember: PullSymbol,
      enclosingDecl: PullDecl,
      comparisonInfo: TypeComparisonInfo
    ) {
      ...
      if (typeMemberKind === PullElementKind.Property) {
        if (typeMember.isAccessor()) {
          errorCode =
            DiagnosticCode.Class_0_defines_instance_member_accessor_1_but_extended_class_2_defines_it_as_instance_member_function;
        } else {
          errorCode =
            DiagnosticCode.Class_0_defines_instance_member_property_1_but_extended_class_2_defines_it_as_instance_member_function;
        }
      } else if (typeMemberKind === PullElementKind.Method) {
        if (extendedTypeMember.isAccessor()) {
          errorCode =
            DiagnosticCode.Class_0_defines_instance_member_function_1_but_extended_class_2_defines_it_as_instance_member_accessor;
        } else {
          errorCode =
            DiagnosticCode.Class_0_defines_instance_member_function_1_but_extended_class_2_defines_it_as_instance_member_property;
        }
      }

      var message = getDiagnosticMessage(errorCode, [
        typeSymbol.toString(),
    ...
    private typeCheckIfTypeExtendsType(
      ...
      for (var i = 0; i < typeMembers.length; i++) {
        ...
        var extendedTypeProp = extendedType.findMember(
          propName,
          /*lookInParent*/ true
        );
        if (extendedTypeProp) {
          this.resolveDeclaredSymbol(extendedTypeProp, context);
          foundError1 = !this.typeCheckIfTypeMemberPropertyOkToOverride(
            typeSymbol,
            extendedType,
            typeMembers[i],
            extendedTypeProp,
          ...
          if (!foundError1) {
            foundError2 = !this.sourcePropertyIsSubtypeOfTargetProperty(
              typeSymbol,
              extendedType,
              typeMembers[i],
              extendedTypeProp,
      ...
      if (!foundError && typeSymbol.hasOwnCallSignatures()) {
        foundError = !this.sourceCallSignaturesAreSubtypeOfTargetCallSignatures(
          typeSymbol,
          extendedType,
          classOrInterface,
          context,
      ...
      if (!foundError && typeSymbol.hasOwnIndexSignatures()) {
        foundError =
          !this.sourceIndexSignaturesAreSubtypeOfTargetIndexSignatures(
            typeSymbol,
            extendedType,
            classOrInterface,
            context,
      ...
      if (!foundError && typeSymbol.isClass()) {
        ...
        if (typeConstructorTypeMembers.length) {
          var extendedConstructorType =
            extendedType.getConstructorMethod().type;
          var comparisonInfoForPropTypeCheck = new TypeComparisonInfo(
            comparisonInfo
          );
          ...
          for (var i = 0; i < typeConstructorTypeMembers.length; i++) {
            ...
            var extendedConstructorTypeProp =
              extendedConstructorType.findMember(
                propName,
                /*lookInParent*/ true
              );
            if (extendedConstructorTypeProp) {
              if (!extendedConstructorTypeProp.isResolved) {
                this.resolveDeclaredSymbol(
                  extendedConstructorTypeProp,
                  context
                );
              }

              // check if type of property is subtype of extended type's property type
              var typeConstructorTypePropType =
                typeConstructorTypeMembers[i].type;
              var extendedConstructorTypePropType =
                extendedConstructorTypeProp.type;
              if (
                !this.sourceIsSubtypeOfTarget(
                  typeConstructorTypePropType,
                  extendedConstructorTypePropType,
                  classOrInterface,
                  context,
                  comparisonInfoForPropTypeCheck
                )
              ) {
                var propMessage: string;
                var enclosingSymbol =
                  this.getEnclosingSymbolForAST(classOrInterface);
                if (comparisonInfoForPropTypeCheck.message) {
                  propMessage = getDiagnosticMessage(
                    ...
                    [
                      ...
                      typeSymbol.toString(enclosingSymbol),
                      extendedType.toString(enclosingSymbol),
      ...
      if (foundError) {
        ...
        if (typeSymbol.isClass()) {
          ...
          if (extendedType.isClass()) {
            ...
            errorCode =
              DiagnosticCode.Interface_0_cannot_extend_interface_1_NL_2;
          }
        }

        context.postDiagnostic(
          this.semanticInfoChain.diagnosticFromAST(name, errorCode, [
    ...
    private typeCheckIfClassImplementsType(
      ...
      var comparisonInfo = new TypeComparisonInfo();
      var foundError = !this.sourceMembersAreSubtypeOfTargetMembers(
        classSymbol,
        implementedType,
        classDecl,
        context,
      ...
      if (foundError) {
        ...
        context.postDiagnostic(
          this.semanticInfoChain.diagnosticFromAST(
            ...
            [
              classSymbol.getScopedName(enclosingSymbol),
              implementedType.getScopedName(enclosingSymbol),
              comparisonInfo.message,
            ]
          )
        );
    ...
    private hasClassTypeSymbolConflictAsValue(
      ...
      var typeSymbolAlias =
        this.semanticInfoChain.getAliasSymbolForAST(valueDeclAST);
      var valueSymbol = this.computeNameExpression(
        valueDeclAST,
        context,
        /*reportDiagnostics:*/ false
      );
      var valueSymbolAlias =
        this.semanticInfoChain.getAliasSymbolForAST(valueDeclAST);
      ...
      if (
        !valueSymbol.anyDeclHasFlag(PullElementFlags.ClassConstructorVariable)
      ) {
        return true;
      }

      var associatedContainerType = valueSymbol.type
        ? valueSymbol.type.getAssociatedContainerType()
        : null;
    ...
    private typeCheckBase(
      ...
      if (!typeSymbol.isValidBaseKind(baseType, isExtendedType)) {
          ...
          if (isExtendedType) {
            if (typeDeclIsClass) {
              ...
              context.postDiagnostic(
                this.semanticInfoChain.diagnosticFromAST(
                  baseDeclAST,
                  DiagnosticCode.An_interface_may_only_extend_another_class_or_interface
                )
              );
            }
          } else {
            context.postDiagnostic(
              this.semanticInfoChain.diagnosticFromAST(
                baseDeclAST,
                DiagnosticCode.A_class_may_only_implement_another_class_or_interface
              )
            );
          }
        }
        ...
        if (
          ...
          context.postDiagnostic(
            this.semanticInfoChain.diagnosticFromAST(
              baseDeclAST,
              DiagnosticCode.Type_reference_0_in_extends_clause_does_not_reference_constructor_function_for_1,
              [
                (<Identifier>baseDeclAST).text(),
                baseType.toString(
                  enclosingDecl ? enclosingDecl.getSymbol() : null
                ),
              ]
      ...
      if (baseType.hasBase(typeSymbol)) {
        ...
        context.postDiagnostic(
          this.semanticInfoChain.diagnosticFromAST(
            name,
            typeDeclIsClass
              ? DiagnosticCode.Class_0_is_recursively_referenced_as_a_base_type_of_itself
              : DiagnosticCode.Interface_0_is_recursively_referenced_as_a_base_type_of_itself,
            [typeSymbol.getScopedName()]
          )
        );
        return;
      ...
      if (isExtendedType) {
        ...
        this.typeCheckIfTypeExtendsType(
          classOrInterface,
          name,
          typeSymbol,
          baseType,
        ...
        this.typeCheckIfClassImplementsType(
          <ClassDeclaration>classOrInterface,
          typeSymbol,
          baseType,
          enclosingDecl,
      ...
      this.checkSymbolPrivacy(typeSymbol, baseType, (errorSymbol: PullSymbol) =>
        this.baseListPrivacyErrorReporter(
          classOrInterface,
          typeSymbol,
          baseDeclAST,
          isExtendedType,
    ...
    private typeCheckBases(
      ...
      if (typeSymbol.isClass()) {
        if (implementsClause) {
          for (
            var i = 0;
            i < implementsClause.typeNames.nonSeparatorCount();
            i++
          ) {
            this.typeCheckBase(
              classOrInterface,
              name,
              typeSymbol,
              implementsClause.typeNames.nonSeparatorAt(i),
        ...
        extendsClause &&
        !typeSymbol.hasBaseTypeConflict() &&
        typeSymbol.getExtendedTypes().length > 1
      ) {
        ...
        var firstInterfaceASTWithExtendsClause = ArrayUtilities.firstOrDefault(
          typeSymbol.getDeclarations(),
          (decl) => (<InterfaceDeclaration>decl.ast()).heritageClauses !== null
        ).ast();
        if (classOrInterface === firstInterfaceASTWithExtendsClause) {
          ...
          this.typeCheckCallBacks.push((context) => {
            this.checkTypeCompatibilityBetweenBases(
              (<InterfaceDeclaration>classOrInterface).identifier,
              typeSymbol,
              context
            );
          });
    ...
    private checkTypeCompatibilityBetweenBases(
      ...
      if (typeSymbol.hasOwnIndexSignatures()) {
        ...
        for (var i = 0; i < ownIndexSignatures.length; i++) {
          if (
            ownIndexSignatures[i].parameters[0].type ===
            this.semanticInfoChain.numberTypeSymbol
          ) {
      ...
      for (var i = 0; i < baseTypes.length; i++) {
        ...
        if (
          this.checkNamedPropertyTypeIdentityBetweenBases(
            name,
            typeSymbol,
            baseTypes[i],
            inheritedMembersMap,
          ...
          this.checkIndexSignatureIdentityBetweenBases(
            name,
            typeSymbol,
            baseTypes[i],
            inheritedIndexSignatures,
            typeHasOwnNumberIndexer,
            typeHasOwnStringIndexer,
            context
          )
        ) {
          return;
    ...
    private checkNamedPropertyTypeIdentityBetweenBases(
      ...
      // October 16, 2013: Section 7.1:
      // Inherited properties with the same name must be identical (section 3.8.2).
      var baseMembers = baseTypeSymbol.getAllMembers(
        PullElementKind.Property | PullElementKind.Method,
        GetAllMembersVisiblity.all
      );
      for (var i = 0; i < baseMembers.length; i++) {
        ...
        if (inheritedMembersMap[memberName]) {
          ...
          if (
            prevMember.baseOrigin !== baseTypeSymbol &&
            !this.typesAreIdentical(member.type, prevMember.memberSymbol.type)
          ) {
            var innerDiagnostic = getDiagnosticMessage(
              DiagnosticCode.Types_of_property_0_of_types_1_and_2_are_not_identical,
              [
                memberName,
                prevMember.baseOrigin.getScopedName(),
                baseTypeSymbol.getScopedName(),
              ]
            );
            context.postDiagnostic(
              this.semanticInfoChain.diagnosticFromAST(
                ...
                [
                  interfaceSymbol.getDisplayName(),
                  prevMember.baseOrigin.getScopedName(),
                  baseTypeSymbol.getScopedName(),
                  innerDiagnostic,
                ]
          ...
          inheritedMembersMap[memberName] = new MemberWithBaseOrigin(
            member,
            baseTypeSymbol
          );
        }
    ...
    private checkIndexSignatureIdentityBetweenBases(
      ...
      if (
        derivedTypeHasOwnNumberSignature &&
        derivedTypeHasOwnStringSignature
      ) {
        return false;
      }
      ...
      for (var i = 0; i < indexSignaturesFromThisBaseType.length; i++) {
        ...
        var parameterTypeIsString =
          currentInheritedSignature.parameters[0].type ===
          this.semanticInfoChain.stringTypeSymbol;
        var parameterTypeIsNumber = !parameterTypeIsString;
        if (
          (parameterTypeIsString && derivedTypeHasOwnStringSignature) ||
        ...
        if (parameterTypeIsString) {
          if (allInheritedSignatures.stringSignatureWithBaseOrigin) {
            if (
              ...
              !this.typesAreIdentical(
                allInheritedSignatures.stringSignatureWithBaseOrigin.signature
                  .returnType,
                currentInheritedSignature.returnType
              )
            ) {
              var innerDiagnostic = getDiagnosticMessage(
                DiagnosticCode.Types_of_string_indexer_of_types_0_and_1_are_not_identical,
                [
                  allInheritedSignatures.stringSignatureWithBaseOrigin.baseOrigin.getScopedName(),
                  baseTypeSymbol.getScopedName(),
                ]
              );
              context.postDiagnostic(
            ...
            allInheritedSignatures.stringSignatureWithBaseOrigin =
              new SignatureWithBaseOrigin(
                currentInheritedSignature,
                baseTypeSymbol
              );
          }
          ...
          if (allInheritedSignatures.numberSignatureWithBaseOrigin) {
            if (
              allInheritedSignatures.numberSignatureWithBaseOrigin
                .baseOrigin !== baseTypeSymbol &&
              !this.typesAreIdentical(
                allInheritedSignatures.numberSignatureWithBaseOrigin.signature
                  .returnType,
                currentInheritedSignature.returnType
              )
            ) {
              var innerDiagnostic = getDiagnosticMessage(
                DiagnosticCode.Types_of_number_indexer_of_types_0_and_1_are_not_identical,
                [
                  allInheritedSignatures.numberSignatureWithBaseOrigin.baseOrigin.getScopedName(),
                  baseTypeSymbol.getScopedName(),
                ]
              );
              context.postDiagnostic(
    ...
    private checkInheritedMembersAgainstInheritedIndexSignatures(
      ...
      if (
        !inheritedIndexSignatures.stringSignatureWithBaseOrigin &&
        !inheritedIndexSignatures.numberSignatureWithBaseOrigin
      ) {
        return false;
      }
      ...
      var numberSignature =
        inheritedIndexSignatures.numberSignatureWithBaseOrigin &&
        inheritedIndexSignatures.numberSignatureWithBaseOrigin.signature;
      for (var memberName in inheritedMembers) {
        ...
        var relevantSignatureIsNumberSignature =
          relevantSignature.parameters[0].type ===
          this.semanticInfoChain.numberTypeSymbol;
        var signatureBaseOrigin = relevantSignatureIsNumberSignature
        ...
        var memberIsSubtype = this.sourceIsSubtypeOfTarget(
          memberWithBaseOrigin.memberSymbol.type,
          relevantSignature.returnType,
          interfaceName,
          context,
          comparisonInfo
        ...
        if (!memberIsSubtype) {
          ...
          if (relevantSignatureIsNumberSignature) {
            var innerDiagnostic = getDiagnosticMessage(
              DiagnosticCode.Type_of_property_0_in_type_1_is_not_a_subtype_of_number_indexer_type_in_type_2_NL_3,
              [
                '' + memberName,
                memberWithBaseOrigin.baseOrigin.getScopedName(enclosingSymbol),
            ...
            context.postDiagnostic(
              this.semanticInfoChain.diagnosticFromAST(
                ...
                [
                  ...
                  memberWithBaseOrigin.baseOrigin.getScopedName(
                    enclosingSymbol
                  ),
                  inheritedIndexSignatures.numberSignatureWithBaseOrigin.baseOrigin.getScopedName(
                    enclosingSymbol
            ...
            var innerDiagnostic = getDiagnosticMessage(
              DiagnosticCode.Type_of_property_0_in_type_1_is_not_a_subtype_of_string_indexer_type_in_type_2_NL_3,
              [
                '' + memberName,
                memberWithBaseOrigin.baseOrigin.getScopedName(enclosingSymbol),
                inheritedIndexSignatures.stringSignatureWithBaseOrigin.baseOrigin.getScopedName(
                  enclosingSymbol
                ),
                comparisonInfo.message,
              ]
    ...
    private checkThatInheritedNumberSignatureIsSubtypeOfInheritedStringSignature(
      ...
      if (
        ...
        if (!signatureIsSubtype) {
          var enclosingSymbol = this.getEnclosingSymbolForAST(interfaceName);
          var innerDiagnostic = getDiagnosticMessage(
            DiagnosticCode.Type_of_number_indexer_in_type_0_is_not_a_subtype_of_string_indexer_type_in_type_1_NL_2,
            [
              inheritedIndexSignatures.numberSignatureWithBaseOrigin.baseOrigin.getScopedName(
                enclosingSymbol
              ),
    ...
    private isReference(ast: AST, astSymbol: PullSymbol): boolean {
      ...
      if (
        ast.kind() !== SyntaxKind.IdentifierName &&
        ast.kind() !== SyntaxKind.MemberAccessExpression &&
        ast.kind() !== SyntaxKind.ElementAccessExpression
      ) {
        return false;
      }
      ...
      if (ast.kind() === SyntaxKind.IdentifierName) {
        if (
          astSymbol.kind === PullElementKind.Variable &&
          astSymbol.anyDeclHasFlag(PullElementFlags.Enum)
        ) {
          return false;
        }
        ...
        if (
          astSymbol.kind === PullElementKind.Variable &&
          astSymbol.anyDeclHasFlag(PullElementFlags.SomeInitializedModule)
        ) {
          return false;
        }
      ...
      if (
        ast.kind() === SyntaxKind.MemberAccessExpression &&
        astSymbol.kind === PullElementKind.EnumMember
      ) {
        return false;
      }
    ...
    private checkForPrivateMemberAccess(
      ...
      if (resolvedName) {
        if (resolvedName.anyDeclHasFlag(PullElementFlags.Private)) {
          ...
          if (
            memberContainer &&
            memberContainer.kind === PullElementKind.ConstructorType
          ) {
          ...
          if (memberContainer && memberContainer.isClass()) {
            ...
            if (!containingClass || containingClass !== memberClass) {
              context.postDiagnostic(
                this.semanticInfoChain.diagnosticFromAST(
                  name,
                  DiagnosticCode._0_1_is_inaccessible,
                  [
                    memberContainer.toString(
                      /*scopeSymbol*/ null,
    ...
    public instantiateType(
      type: PullTypeSymbol,
      typeParameterArgumentMap: PullTypeSymbol[],
      instantiateFunctionTypeParameters = false
    ): PullTypeSymbol {
      ...
      if (
        ...
        (<PullTypeParameterSymbol>type).isFunctionTypeParameter()
      ) {
        return type;
      }
    ...
    public instantiateSignature(
      ...
      instantiatedSignature.returnType = this.instantiateType(
        signature.returnType || this.semanticInfoChain.anyTypeSymbol,
        typeParameterArgumentMap,
        instantiateFunctionTypeParameters
      );
      ...
      if (instantiateFunctionTypeParameters) {
        instantiatedSignature.functionType = this.instantiateType(
  ...
  export class TypeComparisonInfo {
    ...
    public flags: TypeRelationshipFlags =
      TypeRelationshipFlags.SuccessfulComparison;
    public message = '';
  ...
  export function getPropertyAssignmentNameTextFromIdentifier(
    identifier: AST
  ): { actualText: string; memberName: string } {
    if (identifier.kind() === SyntaxKind.IdentifierName) {
      return {
        actualText: (<Identifier>identifier).text(),
        memberName: (<Identifier>identifier).valueText(),
      };
    } else if (identifier.kind() === SyntaxKind.StringLiteral) {
      return {
        actualText: (<StringLiteral>identifier).text(),
        memberName: (<StringLiteral>identifier).valueText(),
      };
    } else if (identifier.kind() === SyntaxKind.NumericLiteral) {
      return {
        actualText: (<NumericLiteral>identifier).text(),
        memberName: (<NumericLiteral>identifier).valueText(),
      };
    } else {

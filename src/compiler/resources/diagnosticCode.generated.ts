...
module TypeScript {
  export var DiagnosticCode = {
    ...
    Parameter_property_declarations_can_only_be_used_in_constructors:
    ...
    The_right_hand_side_of_an_instanceof_expression_must_be_of_type_any_or_a_subtype_of_the_Function_interface_type:
    ...
    Numeric_indexer_type_0_must_be_a_subtype_of_string_indexer_type_1:
      "Numeric indexer type '{0}' must be a subtype of string indexer type '{1}'.",
    Numeric_indexer_type_0_must_be_a_subtype_of_string_indexer_type_1_NL_2:
    ...
    All_numerically_named_properties_must_be_subtypes_of_numeric_indexer_type_0_NL_1:
      "All numerically named properties must be subtypes of numeric indexer type '{0}':{NL}{1}",
    All_named_properties_must_be_subtypes_of_string_indexer_type_0:
      "All named properties must be subtypes of string indexer type '{0}'.",
    All_named_properties_must_be_subtypes_of_string_indexer_type_0_NL_1:
    ...
    Types_of_property_0_of_types_1_and_2_are_not_identical:
    ...
    Type_of_number_indexer_in_type_0_is_not_a_subtype_of_string_indexer_type_in_type_1_NL_2:
    ...
    Print_the_compiler_s_version_0:
      "Print the compiler's base\\research version: {0}\\{1}",
    ...
    SEC_Dynamic_call_with_un_typed_argument:
    ...
    SEC_Initializer_may_rely_on_uninitialized_top_level_names:

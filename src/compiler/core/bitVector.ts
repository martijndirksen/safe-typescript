...
export interface IBitVector {
  ...
  valueAt(index: number): boolean | undefined;
...
export module BitVector {
  ...
  class BitVectorImpl implements IBitVector {
    ...
    private computeTriStateArrayIndex(index: number): number {
      ...
      var encodedValuesPerNumber =
        Constants.MaxBitsPerEncodedNumber /
    ...
    private computeBiStateArrayIndex(index: number): number {
      ...
      var encodedValuesPerNumber =
        Constants.MaxBitsPerEncodedNumber /
        Constants.BitsPerEncodedBiStateValue;
    ...
    private computeTriStateEncodedValueIndex(index: number): number {
      ...
      return (
        (index % encodedValuesPerNumber) * Constants.BitsPerEncodedTriStateValue
      );
    }
    ...
    private computeBiStateEncodedValueIndex(index: number): number {
      ...
      return (
        (index % encodedValuesPerNumber) * Constants.BitsPerEncodedBiStateValue
      );
    }

    public valueAt(index: number): boolean | undefined {

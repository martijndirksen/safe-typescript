module SymbolDisplay {
  ...
  export class Format {
    ...
    constructor(
      typeQualificationStyle: TypeQualificationStyle = TypeQualificationStyle.NameOnly,
  ...
  export var errorMessageFormat: Format = new Format(
   ...
   */
  export var minimallyQualifiedFormat: Format = new Format(
    ...
    ParameterOptions.IncludeName |
      ParameterOptions.IncludeType |
      ParameterOptions.IncludeModifiers |
      ParameterOptions.IncludeDefaultValue,
    AccessorStyle.NameOnly,

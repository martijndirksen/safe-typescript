...
export class ExternalModuleReferenceSyntax
  extends SyntaxNode
  implements IModuleReferenceSyntax
{
  constructor(
...
export class ModuleNameModuleReferenceSyntax
  extends SyntaxNode
  implements IModuleReferenceSyntax
{
  constructor(
  ...
  public update(moduleName: INameSyntax): ModuleNameModuleReferenceSyntax {
    ...
    return new ModuleNameModuleReferenceSyntax(
      moduleName,
      /*parsedInStrictMode:*/ this.parsedInStrictMode()
    );
  }
...
export class ImportDeclarationSyntax
  extends SyntaxNode
  implements IModuleElementSyntax
{
  constructor(
  ...
  public withModifier(modifier: ISyntaxToken): ImportDeclarationSyntax {
    return this.withModifiers(listFn([modifier] as CheckedArray<ISyntaxToken>));
  }

  public withImportKeyword(
    importKeyword: ISyntaxToken
  ): ImportDeclarationSyntax {
    return this.update(
      this.modifiers,
...
export class ClassDeclarationSyntax
  extends SyntaxNode
  implements IModuleElementSyntax
{
  constructor(
  ...
  public withHeritageClause(
    heritageClause: HeritageClauseSyntax
  ): ClassDeclarationSyntax {
    return this.withHeritageClauses(
      listFn([heritageClause] as CheckedArray<HeritageClauseSyntax>)
    );
  }

  public withOpenBraceToken(
    openBraceToken: ISyntaxToken
  ): ClassDeclarationSyntax {
    return this.update(
      this.modifiers,
...
export class InterfaceDeclarationSyntax
  extends SyntaxNode
  implements IModuleElementSyntax
{
  constructor(
...
export class HeritageClauseSyntax extends SyntaxNode {
  ...
  public withExtendsOrImplementsKeyword(
    extendsOrImplementsKeyword: ISyntaxToken
  ): HeritageClauseSyntax {
  ...
  public withTypeName(typeName: INameSyntax): HeritageClauseSyntax {
    return this.withTypeNames(separatedList([typeName]));
  }
...
export class ModuleDeclarationSyntax
  extends SyntaxNode
  implements IModuleElementSyntax
{
  constructor(
...
export class VariableStatementSyntax
  extends SyntaxNode
  implements IStatementSyntax
{
  constructor(
...
export class VariableDeclarationSyntax extends SyntaxNode {
  ...
  public withVariableDeclarators(
    variableDeclarators: ISeparatedSyntaxList
  ): VariableDeclarationSyntax {
    return this.update(this.varKeyword, variableDeclarators);
  }

  public withVariableDeclarator(
    variableDeclarator: VariableDeclaratorSyntax
  ): VariableDeclarationSyntax {
    return this.withVariableDeclarators(separatedList([variableDeclarator]));
  }
...
export class PrefixUnaryExpressionSyntax
  extends SyntaxNode
  implements IUnaryExpressionSyntax
{
  private _kind: SyntaxKind;
...
export class ArrayLiteralExpressionSyntax
  extends SyntaxNode
  implements IPrimaryExpressionSyntax
{
  constructor(
  ...
  public withExpression(
    ...
    return this.withExpressions(separatedList([expression]));
  }
...
export class OmittedExpressionSyntax
  extends SyntaxNode
  implements IExpressionSyntax
{
...
export class ParenthesizedExpressionSyntax
  extends SyntaxNode
  implements IPrimaryExpressionSyntax
{
  constructor(
...
export class SimpleArrowFunctionExpressionSyntax
  extends SyntaxNode
  implements IArrowFunctionExpressionSyntax
{
  constructor(
    public identifier: ISyntaxToken,
  ...
  public withTrailingTrivia(
    ...
    return <SimpleArrowFunctionExpressionSyntax>(
      super.withTrailingTrivia(trivia)
    );
  }
...
export class ParenthesizedArrowFunctionExpressionSyntax
  extends SyntaxNode
  implements IArrowFunctionExpressionSyntax
{
  constructor(
  ...
  public withLeadingTrivia(
    ...
    return <ParenthesizedArrowFunctionExpressionSyntax>(
      super.withLeadingTrivia(trivia)
    );
  }
...
export class TypeArgumentListSyntax extends SyntaxNode {
  ...
  public withTypeArgument(typeArgument: ITypeSyntax): TypeArgumentListSyntax {
    return this.withTypeArguments(separatedList([typeArgument]));
  }

  public withGreaterThanToken(
    greaterThanToken: ISyntaxToken
  ): TypeArgumentListSyntax {
    return this.update(
      this.lessThanToken,
...
export class ObjectTypeSyntax extends SyntaxNode implements ITypeSyntax {
  ...
  public withTypeMember(typeMember: ITypeMemberSyntax): ObjectTypeSyntax {
    return this.withTypeMembers(separatedList([typeMember]));
  }
...
export class GenericTypeSyntax extends SyntaxNode implements ITypeSyntax {
  ...
  public static create1(name: INameSyntax): GenericTypeSyntax {
    return new GenericTypeSyntax(
      name,
      TypeArgumentListSyntax.create1(),
      /*parsedInStrictMode:*/ false
    );
  }
...
export class BlockSyntax extends SyntaxNode implements IStatementSyntax {
  ...
  public withStatement(statement: IStatementSyntax): BlockSyntax {
    return this.withStatements(
      listFn([statement] as CheckedArray<IStatementSyntax>)
    );
  }
...
export class MemberAccessExpressionSyntax
  extends SyntaxNode
  implements IMemberExpressionSyntax
{
  constructor(
    public expression: IExpressionSyntax,
    public dotToken: ISyntaxToken,
...
export class PostfixUnaryExpressionSyntax
  extends SyntaxNode
  implements IPostfixExpressionSyntax
{
  private _kind: SyntaxKind;
...
export class ElementAccessExpressionSyntax
  extends SyntaxNode
  implements IMemberExpressionSyntax
{
  constructor(
...
export class InvocationExpressionSyntax
  extends SyntaxNode
  implements IMemberExpressionSyntax
{
  constructor(
...
export class ArgumentListSyntax extends SyntaxNode {
  ...
  public withArg(arg: IExpressionSyntax): ArgumentListSyntax {
    return this.withArgs(separatedList([arg]));
  }
...
export class ConditionalExpressionSyntax
  extends SyntaxNode
  implements IExpressionSyntax
{
  constructor(
...
export class ConstructSignatureSyntax
  extends SyntaxNode
  implements ITypeMemberSyntax
{
  constructor(
    public newKeyword: ISyntaxToken,
    public callSignature: CallSignatureSyntax,
...
export class MethodSignatureSyntax
  extends SyntaxNode
  implements ITypeMemberSyntax
{
  constructor(
  ...
  public update(
    ...
    return new MethodSignatureSyntax(
      propertyName,
      questionToken,
      callSignature,
      /*parsedInStrictMode:*/ this.parsedInStrictMode()
...
export class IndexSignatureSyntax
  extends SyntaxNode
  implements ITypeMemberSyntax
{
  constructor(
...
export class PropertySignatureSyntax
  extends SyntaxNode
  implements ITypeMemberSyntax
{
  constructor(
...
export class CallSignatureSyntax
  extends SyntaxNode
  implements ITypeMemberSyntax
{
  constructor(
...
export class ParameterListSyntax extends SyntaxNode {
  ...
  public withParameter(parameter: ParameterSyntax): ParameterListSyntax {
    return this.withParameters(separatedList([parameter]));
  }
...
export class TypeParameterListSyntax extends SyntaxNode {
  ...
  public withTypeParameter(
    typeParameter: TypeParameterSyntax
  ): TypeParameterListSyntax {
    return this.withTypeParameters(separatedList([typeParameter]));
  }
...
export class ConstructorDeclarationSyntax
  extends SyntaxNode
  implements IClassElementSyntax
{
  constructor(
    public modifiers: ISyntaxList,
...
export class MemberFunctionDeclarationSyntax
  extends SyntaxNode
  implements IMemberDeclarationSyntax
{
  constructor(
    public modifiers: ISyntaxList,
    public propertyName: ISyntaxToken,
...
export class GetAccessorSyntax
  extends SyntaxNode
  implements IMemberDeclarationSyntax, IPropertyAssignmentSyntax
{
  constructor(
    public modifiers: ISyntaxList,
...
export class SetAccessorSyntax
  extends SyntaxNode
  implements IMemberDeclarationSyntax, IPropertyAssignmentSyntax
{
  constructor(
...
export class MemberVariableDeclarationSyntax
  extends SyntaxNode
  implements IMemberDeclarationSyntax
{
  constructor(
...
export class IndexMemberDeclarationSyntax
  extends SyntaxNode
  implements IClassElementSyntax
{
  constructor(
...
export class ThrowStatementSyntax
  extends SyntaxNode
  implements IStatementSyntax
{
  constructor(
...
export class ReturnStatementSyntax
  extends SyntaxNode
  implements IStatementSyntax
{
  constructor(
...
export class SwitchStatementSyntax
  extends SyntaxNode
  implements IStatementSyntax
{
  constructor(
  ...
  public withSwitchClause(
    switchClause: ISwitchClauseSyntax
  ): SwitchStatementSyntax {
    return this.withSwitchClauses(
      listFn([switchClause] as CheckedArray<ISwitchClauseSyntax>)
    );
  }
...
export class CaseSwitchClauseSyntax
  extends SyntaxNode
  implements ISwitchClauseSyntax
{
  constructor(
...
export class DefaultSwitchClauseSyntax
  extends SyntaxNode
  implements ISwitchClauseSyntax
{
  constructor(
...
export class BreakStatementSyntax
  extends SyntaxNode
  implements IStatementSyntax
{
  constructor(
...
export class ContinueStatementSyntax
  extends SyntaxNode
  implements IStatementSyntax
{
  constructor(
...
export class ForStatementSyntax
  extends SyntaxNode
  implements IIterationStatementSyntax
{
  constructor(
  ...
  public withFirstSemicolonToken(
    firstSemicolonToken: ISyntaxToken
  ): ForStatementSyntax {
    return this.update(
      this.forKeyword,
  ...
  public withSecondSemicolonToken(
    secondSemicolonToken: ISyntaxToken
  ): ForStatementSyntax {
    return this.update(
      this.forKeyword,
...
export class ForInStatementSyntax
  extends SyntaxNode
  implements IIterationStatementSyntax
{
  constructor(
...
export class WhileStatementSyntax
  extends SyntaxNode
  implements IIterationStatementSyntax
{
  constructor(
...
export class WithStatementSyntax
  extends SyntaxNode
  implements IStatementSyntax
{
  constructor(
  ...
  implements IModuleElementSyntax
{
  ...
  public withEnumElement(
    enumElement: EnumElementSyntax
  ): EnumDeclarationSyntax {
    return this.withEnumElements(separatedList([enumElement]));
  }
...
export class CastExpressionSyntax
  extends SyntaxNode
  implements IUnaryExpressionSyntax
{
  constructor(
...
export class ObjectLiteralExpressionSyntax
  extends SyntaxNode
  implements IPrimaryExpressionSyntax
{
  constructor(
  ...
  public withPropertyAssignments(
    propertyAssignments: ISeparatedSyntaxList
  ): ObjectLiteralExpressionSyntax {
    return this.update(
      this.openBraceToken,
  ...
  public withPropertyAssignment(
    propertyAssignment: IPropertyAssignmentSyntax
  ): ObjectLiteralExpressionSyntax {
    return this.withPropertyAssignments(separatedList([propertyAssignment]));
  }
...
export class SimplePropertyAssignmentSyntax
  extends SyntaxNode
  implements IPropertyAssignmentSyntax
{
  constructor(
    public propertyName: ISyntaxToken,
    public colonToken: ISyntaxToken,
...
export class FunctionExpressionSyntax
  extends SyntaxNode
  implements IPrimaryExpressionSyntax
{
  constructor(
...
export class EmptyStatementSyntax
  extends SyntaxNode
  implements IStatementSyntax
{
  constructor(
...
export class LabeledStatementSyntax
  extends SyntaxNode
  implements IStatementSyntax
{
  constructor(
...
export class DoStatementSyntax
  extends SyntaxNode
  implements IIterationStatementSyntax
{
  constructor(
...
export class TypeOfExpressionSyntax
  extends SyntaxNode
  implements IUnaryExpressionSyntax
{
  constructor(
...
export class DeleteExpressionSyntax
  extends SyntaxNode
  implements IUnaryExpressionSyntax
{
  constructor(
...
export class VoidExpressionSyntax
  extends SyntaxNode
  implements IUnaryExpressionSyntax
{
  constructor(
...
export class DebuggerStatementSyntax
  extends SyntaxNode
  implements IStatementSyntax
{
  constructor(

module TypeScript {
  ...
  export class HeritageClauseSyntax extends SyntaxNode {
    ...
    public withTypeNames(
      typeNames: ISeparatedSyntaxList
    ): HeritageClauseSyntax {
      return this.update(
        this._kind,
        this.extendsOrImplementsKeyword,
        typeNames
      );
    }
  ...
  export class IfStatementSyntax
    extends SyntaxNode
    implements IStatementSyntax
  {
    constructor(
    ...
    implements IIterationStatementSyntax
  {
    ...
    public isTypeScriptSpecific(): boolean {
      ...
      if (
        ...
        this.initializer.isTypeScriptSpecific()
      ) {
        return true;
      }
      ...
      if (
        ...
        this.incrementor.isTypeScriptSpecific()
      ) {
        return true;
      }
      if (this.statement.isTypeScriptSpecific()) {
  ...
  export class TryStatementSyntax
    extends SyntaxNode
    implements IStatementSyntax
  {
    constructor(
    ...
    public isTypeScriptSpecific(): boolean {
      ...
      if (
        ...
        this.catchClause.isTypeScriptSpecific()
      ) {
        return true;
      }
      if (

...
function concatTrivia(
  list1: ISyntaxTriviaList,
  list2: ISyntaxTriviaList
): ISyntaxTriviaList {
  if (list1.count() === 0) {
    return list2;
  }
...
export function triviaList(
  trivia: ISyntaxTrivia[] | null | undefined
): ISyntaxTriviaList {
...
export var spaceTriviaList: ISyntaxTriviaList = triviaList([spaceTrivia]);

      ...
      if (i < n) {
        ...
        switch (ch) {
          ...
          case CharacterCodes.x:
            characterArray.push(
              hexValue(text, /*start:*/ i + 1, /*length:*/ 2)
            );
            i += 2;
            continue;
          ...
          case CharacterCodes.u:
            characterArray.push(
              hexValue(text, /*start:*/ i + 1, /*length:*/ 4)
            );
            i += 4;
            continue;
          ...
          case CharacterCodes.carriageReturn:
            ...
            if (
              ...
              text.charCodeAt(nextIndex) == CharacterCodes.lineFeed
            ) {
              // Skip the entire \r\n sequence.
              i++;
            }
...
class EmptyToken implements ISyntaxToken {
  ...
  public isIncrementallyUnusable() {
    return true;
  }
  ...
  public hasLeadingComment() {
    return false;
  }
  public hasLeadingNewLine() {
    return false;
  }
  public hasLeadingSkippedText() {
    return false;
  }
  ...
  public hasTrailingComment() {
    return false;
  }
  public hasTrailingNewLine() {
    return false;
  }
  public hasTrailingSkippedText() {
    return false;
  }
  public hasSkippedToken() {
    return false;
  }
...
class RealizedToken implements ISyntaxToken {
  ...
  public clone(): ISyntaxToken {
    return new RealizedToken(
      this.tokenKind,
      /*this.tokenKeywordKind,*/ this._leadingTrivia,
      this._text,
      this._value,
      this._valueText,
...
export function token(kind: SyntaxKind, info: ITokenInfo = null): ISyntaxToken {
  ...
  return new RealizedToken(
    kind,
    triviaList(info === null ? null : info.leadingTrivia),
    text,
    value1(kind, text),
    valueText1(kind, text),
    triviaList(info === null ? null : info.trailingTrivia)
  );
}

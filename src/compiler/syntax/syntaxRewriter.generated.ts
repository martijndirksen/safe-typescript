import { ISeparatedSyntaxList, separatedList } from "./separatedSyntaxList";
import { INameSyntax, IModuleReferenceSyntax, IExpressionSyntax, IUnaryExpressionSyntax, ITypeSyntax, IMemberExpressionSyntax, IStatementSyntax } from "./syntaxElement";
import { ISyntaxList } from "./syntaxList";
import { SyntaxNode } from "./syntaxNode";
import { ISyntaxNodeOrToken } from "./syntaxNodeOrToken";
import { SourceUnitSyntax, ExternalModuleReferenceSyntax, ModuleNameModuleReferenceSyntax, ImportDeclarationSyntax, ExportAssignmentSyntax, ClassDeclarationSyntax, TypeParameterListSyntax, InterfaceDeclarationSyntax, ObjectTypeSyntax, HeritageClauseSyntax, ModuleDeclarationSyntax, FunctionDeclarationSyntax, CallSignatureSyntax, BlockSyntax, VariableStatementSyntax, VariableDeclarationSyntax, VariableDeclaratorSyntax, TypeAnnotationSyntax, EqualsValueClauseSyntax, PrefixUnaryExpressionSyntax, ArrayLiteralExpressionSyntax, OmittedExpressionSyntax, ParenthesizedExpressionSyntax, SimpleArrowFunctionExpressionSyntax, ParenthesizedArrowFunctionExpressionSyntax, QualifiedNameSyntax, TypeArgumentListSyntax, ConstructorTypeSyntax, ParameterListSyntax, FunctionTypeSyntax, ArrayTypeSyntax, GenericTypeSyntax, TypeQuerySyntax, ParameterSyntax, MemberAccessExpressionSyntax, PostfixUnaryExpressionSyntax, ElementAccessExpressionSyntax, InvocationExpressionSyntax, ArgumentListSyntax, BinaryExpressionSyntax, ConditionalExpressionSyntax, ConstructSignatureSyntax, MethodSignatureSyntax, IndexSignatureSyntax, PropertySignatureSyntax, TypeParameterSyntax, ConstraintSyntax, ElseClauseSyntax, IfStatementSyntax, ExpressionStatementSyntax, ConstructorDeclarationSyntax, MemberFunctionDeclarationSyntax, GetAccessorSyntax, SetAccessorSyntax, MemberVariableDeclarationSyntax, IndexMemberDeclarationSyntax, ThrowStatementSyntax, ReturnStatementSyntax, ObjectCreationExpressionSyntax, SwitchStatementSyntax, CaseSwitchClauseSyntax, DefaultSwitchClauseSyntax, BreakStatementSyntax, ContinueStatementSyntax, ForStatementSyntax, ForInStatementSyntax, WhileStatementSyntax, WithStatementSyntax, EnumDeclarationSyntax, EnumElementSyntax, CastExpressionSyntax, ObjectLiteralExpressionSyntax, SimplePropertyAssignmentSyntax, FunctionPropertyAssignmentSyntax, FunctionExpressionSyntax, EmptyStatementSyntax, TryStatementSyntax, CatchClauseSyntax, FinallyClauseSyntax, LabeledStatementSyntax, DoStatementSyntax, TypeOfExpressionSyntax, DeleteExpressionSyntax, VoidExpressionSyntax, DebuggerStatementSyntax } from "./syntaxNodes.generated";
...
import { ISyntaxVisitor } from "./syntaxVisitor.generated";
  ...
  export class SyntaxRewriter implements ISyntaxVisitor {
    ...
    public visitNodeOrToken(node: ISyntaxNodeOrToken): ISyntaxNodeOrToken {
      return node.isToken()
        ? <ISyntaxNodeOrToken>this.visitToken(<ISyntaxToken>node)
        : this.visitNode(<SyntaxNode>node);
    }
    ...
    public visitSeparatedList(
      ...
      for (var i = 0, n = list.childCount(); i < n; i++) {
        var item = list.childAt(i);
        var newItem = item.isToken()
          ? <ISyntaxNodeOrToken>this.visitToken(<ISyntaxToken>item)
    ...
    public visitModuleNameModuleReference(
      ...
      return node.update(<INameSyntax>this.visitNodeOrToken(node.moduleName));
    }
    ...
    public visitClassDeclaration(node: ClassDeclarationSyntax): any {
      return node.update(
        ...
        node.typeParameterList === null
          ? null
          : <TypeParameterListSyntax>this.visitNode(node.typeParameterList),
    ...
    public visitTypeParameter(node: TypeParameterSyntax): any {
      return node.update(
        ...
        node.constraint === null
          ? null
          : <ConstraintSyntax>this.visitNode(node.constraint)
      );
    }
    ...
    public visitForStatement(node: ForStatementSyntax): any {
      return node.update(
        ...
        node.initializer === null
          ? null
          : <IExpressionSyntax>this.visitNodeOrToken(node.initializer),
        ...
        node.incrementor === null
          ? null
          : <IExpressionSyntax>this.visitNodeOrToken(node.incrementor),
        this.visitToken(node.closeParenToken),
        <IStatementSyntax>this.visitNodeOrToken(node.statement)
      );
    }

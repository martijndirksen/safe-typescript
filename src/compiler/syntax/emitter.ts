  ...
  class EmitterImpl extends SyntaxRewriter {
    ...
    public visitSourceUnit(node: SourceUnitSyntax): SourceUnitSyntax {
      return node.withModuleElements(
        Syntax.list(this.convertModuleElements(node.moduleElements))
      );
    }
    ...
    private handleExportedModuleElement(
      ...
      if (moduleElement.kind() === SyntaxKind.VariableStatement) {
        ...
        if (
          this.containsToken(childModule.modifiers, SyntaxKind.ExportKeyword)
        ) {
          elements.push(
            this.exportModuleElement(
              parentModule,
    ...
    private convertModuleDeclaration(
      ...
      var functionExpression = FunctionExpressionSyntax.create1()
        ...
        .withBlock(
          this.factory.block(
            Syntax.token(SyntaxKind.OpenBraceToken).withTrailingTrivia(
              this.newLine
            ),
            Syntax.list(moduleElements),
            Syntax.token(SyntaxKind.CloseBraceToken).withLeadingTrivia(
              moduleIndentation
            )
          )
        );
    ...
    private static methodSignatureDefaultParameters(
      ...
      return EmitterImpl.callSignatureDefaultParameters(
    ...
    private generateDefaultValueAssignmentStatement(
      ...
      var condition = this.factory.binaryExpression(
        ...
        Syntax.token(SyntaxKind.EqualsEqualsEqualsToken).withTrailingTrivia(
          this.space
        ),
          ...
          ExpressionStatementSyntax.create1(
            this.factory.invocationExpression(
              ...
              ArgumentListSyntax.create1().withArguments(
                Syntax.separatedList([
                  Syntax.token(SyntaxKind.ThisKeyword),
                  Syntax.token(SyntaxKind.CommaToken).withTrailingTrivia(
                    this.space
                  ),
            ...
            .withLeadingTrivia(
              this.indentationTrivia(statementIndentationColumn)
            )
            .withTrailingTrivia(this.newLine)
        );
      }
    ...
    private convertConstructorDeclaration(
      ...
      var normalStatements: IStatementSyntax[] = ArrayUtilities.select<
        any,
        any
      >(
      ...
      var superStatements: IStatementSyntax[] = ArrayUtilities.select<any, any>(
        ArrayUtilities.where(allStatements, (s) =>
          Syntax.isSuperInvocationExpressionStatement(s)
        ),
        (s) => s.accept(this)
      );
    ...
    private convertMemberAccessor(
      ...
      if (!parameterList.hasTrailingTrivia()) {
        parameterList = parameterList.withTrailingTrivia(
          Syntax.spaceTriviaList
        );
      }
      ...
      return this.factory
        ...
        .withLeadingTrivia(
          this.indentationTriviaForStartOfNode(memberAccessor)
        );
    }
    ...
    private convertMemberAccessorDeclaration(
      ...
      var argumentList = [
        ...
        Syntax.stringLiteralExpression(
      ...
      return ExpressionStatementSyntax.create1(
        this.factory.invocationExpression(
          MemberAccessExpressionSyntax.create1(
            ...
            Syntax.identifierName('defineProperty')
          ),
          ArgumentListSyntax.create1().withArguments(
            Syntax.separatedList(argumentList)
          )
        )
      )
    ...
    private convertClassElements(
      ...
      while (classElements.length > 0) {
        ...
        if (classElement.kind() === SyntaxKind.MemberFunctionDeclaration) {
          ...
          classElement.kind() === SyntaxKind.MemberVariableDeclaration
        ) {
    ...
    public visitClassDeclaration(
      ...
      statements.push(
        this.factory
          .returnStatement(
            Syntax.token(SyntaxKind.ReturnKeyword).withTrailingTrivia(
              this.space
            ),
            identifier,
            Syntax.token(SyntaxKind.SemicolonToken)
    ...
    public visitVariableDeclarator(
      ...
      var result: VariableDeclaratorSyntax = super.visitVariableDeclarator(
        node
      );
        ...
        this.factory.variableDeclaration(
          ...
          Syntax.separatedList([
            this.factory.variableDeclarator(
              ...
              null,
              this.factory.equalsValueClause(
                Syntax.token(SyntaxKind.EqualsToken).withTrailingTrivia(
                  this.space
                ),
                Syntax.token(SyntaxKind.ThisKeyword)
              )

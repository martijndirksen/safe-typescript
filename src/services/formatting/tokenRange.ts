...
export class TokenRangeAccess implements ITokenAccess {
  ...
  public toString(): string {
    return (
      '[tokenRangeStart=' +
      SyntaxKind[this.tokens[0]] +
      ',' +
      'tokenRangeEnd=' +
      SyntaxKind[this.tokens[this.tokens.length - 1]] +
      ']'
    );
  }
}
...
export class TokenAllAccess implements ITokenAccess {
  public GetTokens(): SyntaxKind[] {
    ...
    for (
      var token = SyntaxKind.FirstToken;
...
export class TokenRange {
  ...
  static AnyIncludingMultilineComments = TokenRange.FromTokens(
    TokenRange.Any.GetTokens().concat([SyntaxKind.MultiLineCommentTrivia])
  );
  static Keywords = TokenRange.FromRange(
    SyntaxKind.FirstKeyword,
    SyntaxKind.LastKeyword
  );
  static Operators = TokenRange.FromRange(
    SyntaxKind.SemicolonToken,
    SyntaxKind.SlashEqualsToken
  );
  static BinaryOperators = TokenRange.FromRange(
    SyntaxKind.LessThanToken,
    SyntaxKind.SlashEqualsToken
  );
  static BinaryKeywordOperators = TokenRange.FromTokens([
    SyntaxKind.InKeyword,
    SyntaxKind.InstanceOfKeyword,
  ]);
  static ReservedKeywords = TokenRange.FromRange(
    SyntaxKind.FirstFutureReservedStrictKeyword,
    SyntaxKind.LastFutureReservedStrictKeyword
  );
  static UnaryPrefixOperators = TokenRange.FromTokens([
    SyntaxKind.PlusPlusToken,
    SyntaxKind.MinusMinusToken,
    SyntaxKind.TildeToken,
    SyntaxKind.ExclamationToken,
  ]);
  static UnaryPrefixExpressions = TokenRange.FromTokens([
  ...
  static UnaryPreincrementExpressions = TokenRange.FromTokens([
    SyntaxKind.IdentifierName,
    SyntaxKind.OpenParenToken,
    SyntaxKind.ThisKeyword,
    SyntaxKind.NewKeyword,
  ]);
  static UnaryPostincrementExpressions = TokenRange.FromTokens([
    SyntaxKind.IdentifierName,
    SyntaxKind.CloseParenToken,
    SyntaxKind.CloseBracketToken,
    SyntaxKind.NewKeyword,
  ]);
  static UnaryPredecrementExpressions = TokenRange.FromTokens([
    SyntaxKind.IdentifierName,
    SyntaxKind.OpenParenToken,
    SyntaxKind.ThisKeyword,
    SyntaxKind.NewKeyword,
  ]);
  static UnaryPostdecrementExpressions = TokenRange.FromTokens([
    SyntaxKind.IdentifierName,
    SyntaxKind.CloseParenToken,
    SyntaxKind.CloseBracketToken,
    SyntaxKind.NewKeyword,
  ]);
  static Comments = TokenRange.FromTokens([
    SyntaxKind.SingleLineCommentTrivia,
    SyntaxKind.MultiLineCommentTrivia,
  ]);
  static TypeNames = TokenRange.FromTokens([
    SyntaxKind.IdentifierName,

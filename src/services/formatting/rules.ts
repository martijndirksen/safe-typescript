...
export class Rules {
  public getRuleName(rule: Rule) {
    ...
    throw new Error(getDiagnosticMessage(DiagnosticCode.Unknown_rule, null));
  }
  ...
  constructor() {
    ...
    // Special case for (}, else) and (}, while) since else & while tokens are not part of the tree which makes SpaceAfterCloseBrace rule not applied
    this.SpaceBetweenCloseBraceAndElse = new Rule(
      RuleDescriptor.create1(
    ...
    this.SpaceBetweenCloseBraceAndWhile = new Rule(
      RuleDescriptor.create1(
        SyntaxKind.CloseBraceToken,
    ...
    this.SpaceBeforeOpenBraceInFunction = new Rule(
      ...
      RuleOperation.create2(
        new RuleOperationContext(
          Rules.IsFunctionDeclContext,
          Rules.IsNotFormatOnEnter,
          Rules.IsSameLineTokenOrBeforeMultilineBlockContext
        ),
        RuleAction.Space
      ),
    ...
    this.SpaceBeforeOpenBraceInTypeScriptDeclWithBlock = new Rule(
      RuleDescriptor.create2(
    ...
    this.SpaceBeforeOpenBraceInControl = new Rule(
      RuleDescriptor.create2(
    ...
    this.NoSpaceBetweenEmptyBraceBrackets = new Rule(
      RuleDescriptor.create1(
        SyntaxKind.OpenBraceToken,
        SyntaxKind.CloseBraceToken
      ),
    ...
    //      1 - -2  --X-->  1--2
    //      a + ++b --X-->  a+++b
    this.SpaceAfterPostincrementWhenFollowedByAdd = new Rule(
      RuleDescriptor.create1(SyntaxKind.PlusPlusToken, SyntaxKind.PlusToken),
      RuleOperation.create2(
        new RuleOperationContext(
          Rules.IsSameLineTokenContext,
          Rules.IsBinaryOpContext
        ),
        RuleAction.Space
      )
    );
    this.SpaceAfterAddWhenFollowedByUnaryPlus = new Rule(
      RuleDescriptor.create1(SyntaxKind.PlusToken, SyntaxKind.PlusToken),
      RuleOperation.create2(
        new RuleOperationContext(
          Rules.IsSameLineTokenContext,
          Rules.IsBinaryOpContext
    ...
    this.SpaceAfterAddWhenFollowedByPreincrement = new Rule(
      RuleDescriptor.create1(SyntaxKind.PlusToken, SyntaxKind.PlusPlusToken),
      RuleOperation.create2(
        new RuleOperationContext(
          Rules.IsSameLineTokenContext,
          Rules.IsBinaryOpContext
    ...
    this.SpaceAfterPostdecrementWhenFollowedBySubtract = new Rule(
      RuleDescriptor.create1(SyntaxKind.MinusMinusToken, SyntaxKind.MinusToken),
      RuleOperation.create2(
        new RuleOperationContext(
          Rules.IsSameLineTokenContext,
          Rules.IsBinaryOpContext
    ...
    this.SpaceAfterSubtractWhenFollowedByUnaryMinus = new Rule(
      RuleDescriptor.create1(SyntaxKind.MinusToken, SyntaxKind.MinusToken),
      RuleOperation.create2(
        new RuleOperationContext(
          Rules.IsSameLineTokenContext,
          Rules.IsBinaryOpContext
    ...
    this.SpaceAfterSubtractWhenFollowedByPredecrement = new Rule(
      RuleDescriptor.create1(SyntaxKind.MinusToken, SyntaxKind.MinusMinusToken),
      RuleOperation.create2(
        new RuleOperationContext(
          Rules.IsSameLineTokenContext,
          Rules.IsBinaryOpContext
    ...
    this.NoSpaceBeforeOpenParenInFuncCall = new Rule(
      ...
      RuleOperation.create2(
        new RuleOperationContext(
          Rules.IsSameLineTokenContext,
          Rules.IsFunctionCallOrNewContext
        ),
        RuleAction.Delete
      )
    );
    ...
    this.SpaceAfterVoidOperator = new Rule(
      ...
      RuleOperation.create2(
        new RuleOperationContext(
          Rules.IsSameLineTokenContext,
          Rules.IsVoidOpContext
        ),
        RuleAction.Space
      )
    );

    this.NoSpaceBetweenReturnAndSemicolon = new Rule(
      RuleDescriptor.create1(
        SyntaxKind.ReturnKeyword,
        SyntaxKind.SemicolonToken
      ),
    ...
    // Treat constructor as an identifier in a function declaration, and remove spaces between constructor and following left parentheses
    this.NoSpaceAfterConstructor = new Rule(
      RuleDescriptor.create1(
    ...
    // Treat string literals in module names as identifiers, and add a space between the literal and the opening Brace braces, e.g.: module "m2" {
    this.SpaceAfterModuleName = new Rule(
      RuleDescriptor.create1(
        SyntaxKind.StringLiteral,
        SyntaxKind.OpenBraceToken
      ),
      RuleOperation.create2(
        new RuleOperationContext(Rules.IsModuleDeclContext),
        RuleAction.Space
      )
    );
    ...
    // Optional parameters and var args
    this.NoSpaceAfterEllipsis = new Rule(
      RuleDescriptor.create1(
    ...
    this.NoSpaceBeforeOpenAngularBracket = new Rule(
      ...
      RuleOperation.create2(
        new RuleOperationContext(
          Rules.IsSameLineTokenContext,
          Rules.IsTypeArgumentOrParameterContext
        ),
        RuleAction.Delete
      )
    );
    this.NoSpaceBetweenCloseParenAndAngularBracket = new Rule(
      RuleDescriptor.create1(
        SyntaxKind.CloseParenToken,
    ...
    // Remove spaces in empty interface literals. e.g.: x: {}
    this.NoSpaceBetweenEmptyInterfaceBraceBrackets = new Rule(
      RuleDescriptor.create1(
        SyntaxKind.OpenBraceToken,
        SyntaxKind.CloseBraceToken
      ),
    ...
    // Open Brace braces after function
    //TypeScript: Function can have return types, which can be made of tons of different token kinds
    this.NewLineBeforeOpenBraceInFunction = new Rule(
      RuleDescriptor.create2(
        this.FunctionOpenBraceLeftTokenRange,
        SyntaxKind.OpenBraceToken
      ),
      RuleOperation.create2(
        new RuleOperationContext(
          Rules.IsFunctionDeclContext,
          Rules.IsBeforeMultilineBlockContext
        ),
        RuleAction.NewLine
      ),
      RuleFlags.CanDeleteNewLines
    ...
    // Open Brace braces after TypeScript module/class/interface
    this.NewLineBeforeOpenBraceInTypeScriptDeclWithBlock = new Rule(
      RuleDescriptor.create2(
        this.TypeScriptOpenBraceLeftTokenRange,
        SyntaxKind.OpenBraceToken
      ),
    ...
    // Open Brace braces after control block
    this.NewLineBeforeOpenBraceInControl = new Rule(
      RuleDescriptor.create2(
        this.ControlOpenBraceLeftTokenRange,
        SyntaxKind.OpenBraceToken
      ),
    ...
    this.NoSpaceBetweenParens = new Rule(
      RuleDescriptor.create1(
        SyntaxKind.OpenParenToken,
        SyntaxKind.CloseParenToken
      ),
    ...
    // Insert space after function keyword for anonymous functions
    this.SpaceAfterAnonymousFunctionKeyword = new Rule(
      RuleDescriptor.create1(
    ...
    this.NoSpaceAfterAnonymousFunctionKeyword = new Rule(
      RuleDescriptor.create1(
        SyntaxKind.FunctionKeyword,
        SyntaxKind.OpenParenToken
      ),
  ...
  static IsSameLineTokenOrBeforeMultilineBlockContext(
    ...
    return (
      ...
      Rules.IsBeforeMultilineBlockContext(context)
    );
  }
  ...
  static IsBeforeMultilineBlockContext(context: FormattingContext): boolean {
    return (
      Rules.IsBeforeBlockContext(context) &&
  ...
  static NodeIsTypeScriptDeclWithBlockContext(
  ...
  static IsObjectTypeContext(context: FormattingContext): boolean {
    return (
      context.contextNode.kind() === SyntaxKind.ObjectType &&
      context.contextNode.parent().kind() !== SyntaxKind.InterfaceDeclaration
    );
  }

  static IsTypeArgumentOrParameter(
    ...
    return (
      ...
      (parentKind === SyntaxKind.TypeParameterList ||
        parentKind === SyntaxKind.TypeArgumentList)
    );
  }

  static IsTypeArgumentOrParameterContext(context: FormattingContext): boolean {
    return (
      Rules.IsTypeArgumentOrParameter(

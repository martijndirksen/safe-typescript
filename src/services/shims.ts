...
import { Classifier, IClassifierHost, EndOfLineState } from './classifier';
import {
  CoreServices,
  ICoreServicesHost,
  debugObjectHost,
} from './coreServices';
import { ILanguageServicesDiagnostics } from './diagnosticServices';
import {
  ILanguageService,
  ILanguageServiceHost,
  logInternalError,
  DiagnosticCategory as LanguageDiagnosticCategory,
  EditorOptions,
  FormatCodeOptions,
  NavigateToItem,
...
//
export interface ILanguageServiceShimHost extends ILogger {
...
class ScriptSnapshotShimAdapter implements IScriptSnapshot {
  ...
  public getTextChangeRangeSinceVersion(
    scriptVersion: number
  ): TextChangeRange | null {
    var encoded =
      this.scriptSnapshotShim.getTextChangeRangeSinceVersion(scriptVersion);
    if (encoded == null) {
      return null;
    }
    ...
    return new TextChangeRange(
      new TextSpan(decoded.span.start, decoded.span.length),
      decoded.newLength
    );
  }
}

export class LanguageServiceShimHostAdapter implements ILanguageServiceHost {
  ...
  public getCompilationSettings(): CompilationSettings | null {
    var settingsJson = this.shimHost.getCompilationSettings();
    if (settingsJson == null || settingsJson == '') {
      return null;
    }
    var settings: CompilationSettings = JSON.parse(<any>settingsJson);
    return settings;
  }
  ...
  public getScriptSnapshot(fileName: string): IScriptSnapshot {
    return new ScriptSnapshotShimAdapter(
      this.shimHost.getScriptSnapshot(fileName)
    );
  }
...
export function simpleForwardCall(
  logger: ILogger,
...
export function forwardJSONCall(
  logger: ILogger,
  actionDescription: string,
  action: () => any
): string {
  try {
    ...
    error.description = actionDescription;
    return JSON.stringify({ error });
  }
}

export class LanguageServiceShim
  extends ShimBase
  implements ILanguageServiceShim
{
  private logger: ILogger;

  constructor(
    factory: IShimFactory,
  ...
  public refresh(throwOnError: boolean): void {
    this.forwardJSONCall('refresh(' + throwOnError + ')', () => {
  ...
  private static realizeDiagnosticCategory(
    category: DiagnosticCategory
  ): string {
    switch (category) {
      case DiagnosticCategory.Error:
        return LanguageDiagnosticCategory.error;
      case DiagnosticCategory.Warning:
        return LanguageDiagnosticCategory.warning;
      case DiagnosticCategory.Message:
        return LanguageDiagnosticCategory.message;
      default:
        return LanguageDiagnosticCategory.none;
    }
  }

  private static realizeDiagnostic(diagnostic: Diagnostic): {
    message: string;
    start: number;
    length: number;
    category: string;
    ...
    return {
      ...
      category: LanguageServiceShim.realizeDiagnosticCategory(
        diagnostic.info().category
      ),
    };
  }
  ...
  public getTypeAtPosition(fileName: string, position: number): string {
    return this.forwardJSONCall(
      ...
      () => {
        var typeInfo = this.languageService.getTypeAtPosition(
          fileName,
          position
        );
        return typeInfo;
  ...
  public getNameOrDottedNameSpan(
    ...
    return this.forwardJSONCall(
      'getNameOrDottedNameSpan("' +
        ...
        ')',
      () => {
        var spanInfo = this.languageService.getNameOrDottedNameSpan(
          fileName,
          startPos,
          endPos
        );
  ...
  public getBreakpointStatementAtPosition(
    ...
    return this.forwardJSONCall(
      ...
      () => {
        var spanInfo = this.languageService.getBreakpointStatementAtPosition(
          fileName,
          position
        );
        return spanInfo;
  ...
  public getSignatureAtPosition(fileName: string, position: number): string {
    return this.forwardJSONCall(
      ...
      () => {
        var signatureInfo = this.languageService.getSignatureAtPosition(
          fileName,
          position
        );
  ...
  public getBraceMatchingAtPosition(
    ...
    return this.forwardJSONCall(
      ...
      () => {
        var textRanges = this.languageService.getBraceMatchingAtPosition(
          fileName,
          position
        );
        return textRanges;
  ...
  public getIndentationAtPosition(
    ...
    return this.forwardJSONCall(
      ...
      () => {
        ...
        var columnOffset = this.languageService.getIndentationAtPosition(
          fileName,
          position,
          localOptions
        );
  ...
  public getCompletionsAtPosition(
    ...
    return this.forwardJSONCall(
      'getCompletionsAtPosition("' +
        ...
        ')',
      () => {
        var completion = this.languageService.getCompletionsAtPosition(
          fileName,
          position,
          isMemberCompletion
        );
  ...
  public getCompletionEntryDetails(
    ...
    return this.forwardJSONCall(
      'getCompletionEntryDetails("' +
        ...
        ')',
      () => {
        var details = this.languageService.getCompletionEntryDetails(
          fileName,
          position,
          entryName
        );
  ...
  public getFormattingEditsForRange(
    ...
    return this.forwardJSONCall(
      ...
      () => {
        ...
        var edits = this.languageService.getFormattingEditsForRange(
          fileName,
          minChar,
          limChar,
          localOptions
  ...
  public getFormattingEditsForDocument(
    ...
    return this.forwardJSONCall(
      ...
      () => {
        var localOptions: FormatCodeOptions = JSON.parse(options);
        var edits = this.languageService.getFormattingEditsForDocument(
          fileName,
          minChar,
          limChar,
          localOptions
  ...
  public getFormattingEditsOnPaste(
    ...
    return this.forwardJSONCall(
      ...
      () => {
        var localOptions: FormatCodeOptions = JSON.parse(options);
        var edits = this.languageService.getFormattingEditsOnPaste(
          fileName,
          minChar,
          limChar,
          localOptions
  ...
  public getFormattingEditsAfterKeystroke(
    ...
    return this.forwardJSONCall(
      ...
      () => {
        var localOptions: FormatCodeOptions = JSON.parse(options);
        var edits = this.languageService.getFormattingEditsAfterKeystroke(
          fileName,
          position,
          key,
          localOptions
...
export class ClassifierShim extends ShimBase {
  ...
  public getClassificationsForLine(
    ...
    var classification = this.classifier.getClassificationsForLine(
      text,
      lexState
    );
...
export class CoreServicesShim extends ShimBase {
  ...
  public getPreProcessedFileInfo(
    ...
    return this.forwardJSONCall(
      ...
      () => {
        var result = this.services.getPreProcessedFileInfo(
          fileName,
          sourceText
        );
        return result;
  ...
  public dumpMemory(dummy: any): string {
    return this.forwardJSONCall('dumpMemory()', () => {
  ...
  public getMemoryInfo(dummy: any): string {
    return this.forwardJSONCall('getMemoryInfo()', () => {

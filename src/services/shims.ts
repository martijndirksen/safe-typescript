...
module TypeScript.Services {
  ...
  class ScriptSnapshotShimAdapter implements TypeScript.IScriptSnapshot {
    ...
    public getTextChangeRangeSinceVersion(
      ...
      return new TypeScript.TextChangeRange(
        new TypeScript.TextSpan(decoded.span.start, decoded.span.length),
        decoded.newLength
      );
    }
  }
  ...
  export class LanguageServiceShimHostAdapter
    implements TypeScript.Services.ILanguageServiceHost
  {
    ...
    public getCompilationSettings(): TypeScript.CompilationSettings {
      ...
      var settings: TypeScript.CompilationSettings = JSON.parse(
        <any>settingsJson
      );
      return settings;
    }
    ...
    implements ILanguageServiceShim
  {
    ...
    public forwardJSONCall(
      ...
      return TypeScript.Services.forwardJSONCall(
        this.logger,
        actionDescription,
        action
      );
    ...
    private static realizeDiagnostic(diagnostic: TypeScript.Diagnostic): {
      message: string;
      start: number;
      length: number;
      category: string;
    ...
    public getIndentationAtPosition(
      ...
      return this.forwardJSONCall(
        ...
        () => {
          var localOptions: TypeScript.Services.EditorOptions =
            JSON.parse(options);
    ...
    public getReferencesAtPosition(fileName: string, position: number): string {
      return this.forwardJSONCall(
        ...
        () => {
          return this.languageService.getReferencesAtPosition(
            fileName,
            position
          );
        }
    ...
    public getFormattingEditsForRange(
      ...
      return this.forwardJSONCall(
        'getFormattingEditsForRange("' +
          ...
          ')',
        () => {
          var localOptions: TypeScript.Services.FormatCodeOptions =
            JSON.parse(options);
    ...
    private _navigateToItemsToString(
      items: TypeScript.Services.NavigateToItem[]
    ): any {
      var result: {
        name: string;
        kind: string;
  ...
  export class ClassifierShim extends ShimBase {
    ...
    constructor(
      factory: IShimFactory,
      public host: TypeScript.Services.IClassifierHost
    ) {
      super(factory);
  ...
  export class CoreServicesShim extends ShimBase {
    ...
    constructor(
      factory: IShimFactory,
      public host: TypeScript.Services.ICoreServicesHost
    ) {
      super(factory);

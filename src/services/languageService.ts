...
import { IReferenceResolverHost } from '../compiler/referenceResolver';
...
import { EmitOutput } from '../compiler/typescript';
import { ILanguageServicesDiagnostics } from './diagnosticServices';

//
// Public interface of the host of a language service instance.
//
export interface ILanguageServiceHost extends ILogger, IReferenceResolverHost {
  getCompilationSettings(): CompilationSettings | null;
...
export function logInternalError(logger: ILogger, err: Error) {
  logger.log(
...
export class FormatCodeOptions extends EditorOptions {
  ...
  public static clone(objectToClone: FormatCodeOptions): FormatCodeOptions {
    var formatCodeOptions = <FormatCodeOptions>(
      EditorOptions.clone(objectToClone)
    );
    formatCodeOptions.InsertSpaceAfterCommaDelimiter =
      objectToClone.InsertSpaceAfterCommaDelimiter;
    formatCodeOptions.InsertSpaceAfterSemicolonInForStatements =
      objectToClone.InsertSpaceAfterSemicolonInForStatements;
    formatCodeOptions.InsertSpaceBeforeAndAfterBinaryOperators =
      objectToClone.InsertSpaceBeforeAndAfterBinaryOperators;
    formatCodeOptions.InsertSpaceAfterKeywordsInControlFlowStatements =
      objectToClone.InsertSpaceAfterKeywordsInControlFlowStatements;
    formatCodeOptions.InsertSpaceAfterFunctionKeywordForAnonymousFunctions =
      objectToClone.InsertSpaceAfterFunctionKeywordForAnonymousFunctions;
    formatCodeOptions.InsertSpaceAfterOpeningAndBeforeClosingNonemptyParenthesis =
      objectToClone.InsertSpaceAfterOpeningAndBeforeClosingNonemptyParenthesis;
    formatCodeOptions.PlaceOpenBraceOnNewLineForFunctions =
      objectToClone.PlaceOpenBraceOnNewLineForFunctions;
    formatCodeOptions.PlaceOpenBraceOnNewLineForControlBlocks =
